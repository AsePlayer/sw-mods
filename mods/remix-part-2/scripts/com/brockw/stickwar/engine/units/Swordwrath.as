package com.brockw.stickwar.engine.units
{
     ...
     public class Swordwrath extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.swordwrathType == "EnchantedRebelSword" && !this.setupComplete)
               {
                    criticHit = true;
                    maxHealth = 100;
                    health = 100;
               ...
               if(this.swordwrathType == "Clement" && !this.setupComplete)
               {
                    maxHealth = 800;
                    health = 800;
                    maxHealth = maxHealth;
               ...
               if(this.swordwrathType == "EnchantedRebelSword")
               {
                    Swordwrath.setItem(_swordwrath(mc),"Elvish Sword","","");
               }
               else if(this.swordwrathType == "Clement")
               {
                    Swordwrath.setItem(_swordwrath(mc),"Ice Sword","Ice","");
               }
               else
               {
                    Swordwrath.setItem(_swordwrath(mc),team.loadout.getItem(this.type,MarketItem.T_WEAPON),team.loadout.getItem(this.type,MarketItem.T_ARMOR),"");
               }
          }
