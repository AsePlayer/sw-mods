package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          public var criticHit:Boolean;
          
          public var lazyUnit:Boolean;
          
          public var rabbiesUnit:Boolean;
                    ...
                    if(_loc1_.checkForHitPoint(_loc3_,_loc1_))
                    {
                         ...
                         if(this.criticHit)
                         {
                              if(this.randomNumber == 4)
                              {
                                   ...
                                   _loc1_.damage(0,this.damageToDeal,this);
                                   _loc1_.damage(0,this.damageToDeal,this);
                                   this.team.game.soundManager.playSoundRandom("StatueHit",5,px,py);
                                   this.team.game.soundManager.playSoundRandom("StatueHit",5,px,py);
                              }
                         }
                         if(this.rabbiesUnit)
                         {
                              if(this.randomNumber == 8)
                              {
                                   ...
                                   _loc1_.damage(0,this.damageToDeal,this);
                                   _loc1_.damage(0,this.damageToDeal,this);
                                   this.team.game.soundManager.playSoundRandom("AcidSpraySound",0,px,py);
                                   this.team.game.soundManager.playSoundRandom("AcidSpraySound",0,px,py);
                              }
                         }
