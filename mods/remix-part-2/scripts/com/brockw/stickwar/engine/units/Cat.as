package com.brockw.stickwar.engine.units
{
     ...
     public class Cat extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          {
               updateCommon(param1);
               if(this.catType == "AlphaPex" && !this.setupComplete)
               {
                    freezeUnit = true;
                    maxHealth = 2000;
                    health = 2000;
                    ...
                    _scale = 2;
                    this.packDamagePerUnit = 70;
                    this.packStacks = 6;
                    this.upgradedMaxVelocity = 16.5;
                    this.normalMaxVelocity = 15;
