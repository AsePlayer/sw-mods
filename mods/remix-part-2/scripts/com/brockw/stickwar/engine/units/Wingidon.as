package com.brockw.stickwar.engine.units
{
     ...
     public class Wingidon extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               super.update(param1);
               updateCommon(param1);
               if(this.wingidonType == "Glidingsor" && !this.setupComplete)
               {
                    maxHealth = 120;
                    health = 120;
                    maxHealth = maxHealth;
                    ...
                    _maximumRange = 725;
                    _maxVelocity = 11;
                    flyingHeight = 250 * 1.6;
                    this.projectileVelocity = 55;
               ...
               if(this.wingidonType == "Glidingsor")
               {
                    Wingidon.setItem(mc,team.loadout.getItem(this.type,MarketItem.T_WEAPON),"Pilot\'s Helmet","Vulture Sleeve");
               }
               else
               {
