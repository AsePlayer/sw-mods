package com.brockw.stickwar.engine.Ai
{
     ...
     public class UnitAi
     {
          ...
          public var swordTargeter:Boolean = false;
          ...
          public function getClosestUnitTarget() : Unit
          {
               ...
               var closestSword:Swordwrath = null;
               var closestSpear:Spearton = null;
               ...
               if(this.swordTargeter)
               {
                    for each(_loc4_ in this.unit.team.enemyTeam.units)
                    {
                         if(_loc4_.type == Unit.U_SWORDWRATH && !_loc4_.isDead)
                         {
                              if(!closestSword)
                              {
                                   closestSword = _loc4_;
                              }
                              if(Math.abs(_loc4_.px - this.unit.px) < Math.abs(closestSword.px - this.unit.px))
                              {
                                   closestSword = _loc4_;
                              }
                         }
               ...
               if(this.speartonTargeter)
               {
                    for each(_loc4_ in this.unit.team.enemyTeam.units)
                    {
                         if(_loc4_.type == Unit.U_SPEARTON && !_loc4_.isDead)
                         {
                              ...
                              if(Math.abs(_loc4_.px - this.unit.px) < Math.abs(closestSpear.px - this.unit.px))
                              {
                                   closestSpear = _loc4_;
                              }
                         }
