package com.brockw.stickwar.market
{
     ...
     public class ItemMap
     {
          ...
          public static function unitNameToType(param1:String) : int
          {
               ...
               if(param1 == "Explosion Element")
               {
                    return Unit.U_STEAM_EXPLOSION;
               }
               return -1;
          }
          ...
          public static function unitTypeToName(param1:int) : String
          {
               ...
               if(param1 == Unit.U_STEAM_EXPLOSION)
               {
          ...
          public static function unitTypeToXML(param1:int, param2:stickwar2) : XMLList
          {
               if(param1 == Unit.U_MINER)
               {
          ...
          public function loadItems(param1:stickwar2) : void
          {
