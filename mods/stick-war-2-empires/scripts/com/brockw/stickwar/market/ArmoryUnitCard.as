package com.brockw.stickwar.market
{
     ...
     public class ArmoryUnitCard extends armoryCardMc
     {
          ...
          public function ArmoryUnitCard(param1:stickwar2, param2:int, param3:int, param4:MovieClip, param5:Class, param6:MovieClip)
          {
               super();
               this.main = param1;
          ...
          {
               this.main.loadout1.setItem(param1,param2,param3);
          ...
          public function update() : void
          {
               ...
               this.itemMap[MarketItem.T_WEAPON] = this.main.loadout1.getItem(this.unitType,MarketItem.T_WEAPON);
               this.itemMap[MarketItem.T_ARMOR] = this.main.loadout1.getItem(this.unitType,MarketItem.T_ARMOR);
               this.itemMap[MarketItem.T_MISC] = this.main.loadout1.getItem(this.unitType,MarketItem.T_MISC);
          ...
          public function select() : void
          {
               ...
               var _loc1_:String = String(this.main.loadout1.getItem(this.unitType,this._currentItemType));
          ...
          public function get main() : stickwar2
          {
               return this._main;
          }
          
          public function set main(param1:stickwar2) : void
          {
               this._main = param1;
          }
