package com.brockw.stickwar.market
{
     ...
     public class MarketItem extends MovieClip
     {
          ...
          public function MarketItem(param1:Array)
          {
               super();
          ...
          public function update(param1:stickwar2) : void
          {
               ...
               else if(param1.loadout1.getItem(ItemMap.unitNameToType(this.unit),this.type) == name)
               {
                    this.marketMc.useDisplay.visible = false;
          ...
          public function readFromSFSObject(param1:Array) : void
          {
