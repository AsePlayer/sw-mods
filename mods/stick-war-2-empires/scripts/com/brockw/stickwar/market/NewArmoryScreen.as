package com.brockw.stickwar.market
{
     ...
     public class NewArmoryScreen extends Screen
     {
          ...
          public function NewArmoryScreen(param1:stickwar2)
          {
               this.unitButtons = [];
               super();
               this.main = param1;
          ...
          public function editName(param2:String) : void
          {
               this.name = param2;
          }
          
          public function backButton(param1:Event) : void
          {
               this.main.showScreen(this.name);
          }
          ...
          public function switchRace(param1:int) : void
          {
               ...
               if(param1 == Team.T_GOOD)
               {
                    ...
                    this.unitButtons = [new com.brockw.stickwar.market.UnitButton(Unit.U_MINER,this.orderUnits.minerMc,-10,-20),new com.brockw.stickwar.market.UnitButton(Unit.U_ARCHER,this.orderUnits.archerMc,-10,-10),new com.brockw.stickwar.market.UnitButton(Unit.U_SPEARTON,this.orderUnits.speartonMc,-8,-30),new com.brockw.stickwar.market.UnitButton(Unit.U_MAGIKILL,this.orderUnits.magikillMc,-10,-30),new com.brockw.stickwar.market.UnitButton(Unit.U_MONK,this.orderUnits.clericMc,-25,-25),new com.brockw.stickwar.market.UnitButton(Unit.U_SWORDWRATH,this.orderUnits.swordwrathMc,-20,-10),new com.brockw.stickwar.market.UnitButton(Unit.U_ENSLAVED_GIANT,this.orderUnits.giantMc,-50,-80),new com.brockw.stickwar.market.UnitButton(Unit.U_FLYING_CROSSBOWMAN,this.orderUnits.flapadonMc,-35,15),new com.brockw.stickwar.market.UnitButton(Unit.U_NINJA,this.orderUnits.ninjaMc,-22,15)];
               ...
               else if(param1 == Team.T_CHAOS)
               {
                    ...
                    this.unitButtons = [new com.brockw.stickwar.market.UnitButton(Unit.U_CHAOS_MINER,this.chaosUnits.minerMc,-13,-15),new com.brockw.stickwar.market.UnitButton(Unit.U_DEAD,this.chaosUnits.deadMc,5,-8),new com.brockw.stickwar.market.UnitButton(Unit.U_BOMBER,this.chaosUnits.bomberMc,-25,30),new com.brockw.stickwar.market.UnitButton(Unit.U_WINGIDON,this.chaosUnits.winidonMc,-30,20),new com.brockw.stickwar.market.UnitButton(Unit.U_SKELATOR,this.chaosUnits.skelatorMc,-18,-25),new com.brockw.stickwar.market.UnitButton(Unit.U_MEDUSA,this.chaosUnits.medusaMc,-5,-35),new com.brockw.stickwar.market.UnitButton(Unit.U_GIANT,this.chaosUnits.giantMc,-75,-80),new com.brockw.stickwar.market.UnitButton(Unit.U_CAT,this.chaosUnits.catMc,-20,50),new com.brockw.stickwar.market.UnitButton(Unit.U_KNIGHT,this.chaosUnits.knightMc,-5,-20)];
                    _loc2_ = 0;
               ...
               else
               {
                    ...
                    this.unitButtons = [new com.brockw.stickwar.market.UnitButton(Unit.U_MINER_ELEMENT,this.elementalUnits.minerMc,-15,20),new com.brockw.stickwar.market.UnitButton(Unit.U_FIRE_ELEMENT,this.elementalUnits.fireMc,-15,-13 + 5),new com.brockw.stickwar.market.UnitButton(Unit.U_WATER_ELEMENT,this.elementalUnits.waterMc,-11,-10 + 5),new com.brockw.stickwar.market.UnitButton(Unit.U_EARTH_ELEMENT,this.elementalUnits.earthMc,-10,-15 + 5),new com.brockw.stickwar.market.UnitButton(Unit.U_AIR_ELEMENT,this.elementalUnits.airMc,-5,8 + 5),new com.brockw.stickwar.market.UnitButton(Unit.U_TREE_ELEMENT,this.elementalUnits.treeMc,-40,-85),new com.brockw.stickwar.market.UnitButton(Unit.U_HURRICANE_ELEMENT,this.elementalUnits.hurricaneMc,-50,65),new com.brockw.stickwar.market.UnitButton(Unit.U_SCORPION_ELEMENT,this.elementalUnits.scorpionMc,-18,55),new com.brockw.stickwar.market.UnitButton(Unit.U_CHROME_ELEMENT,this.elementalUnits.chromeMc,-5,-35),new com.brockw.stickwar.market.UnitButton(Unit.U_LAVA_ELEMENT,this.elementalUnits.lavaMc,-22,-20),new com.brockw.stickwar.market.UnitButton(Unit.U_FIRESTORM_ELEMENT,this.elementalUnits.firestormMc,30,-25)];
                    this.selectedUnit = this.unitButtons[3];
               }
          }
          ...
          {
               this._mc.empiresPoints.text = "press backspace to exist";
               if(!this.isUnlocking())
               {
          ...
          {
               this.main.campaign.loadout1 = this.main.loadout1.toString();
          }
          
          public function setUnitProfileGeneric(param1:MovieClip, param2:MovieClip, param3:int) : void
          {
               Util.animateMovieClip(param2,0);
               var _loc4_:String = String(this.main.loadout1.getItem(param3,com.brockw.stickwar.market.MarketItem.T_WEAPON));
               var _loc5_:String = String(this.main.loadout1.getItem(param3,com.brockw.stickwar.market.MarketItem.T_ARMOR));
               var _loc6_:String = String(this.main.loadout1.getItem(param3,com.brockw.stickwar.market.MarketItem.T_MISC));
          ...
          public function updateWeaponButtons() : void
          {
               ...
               if(this.currentItemType == com.brockw.stickwar.market.MarketItem.T_WEAPON)
               {
                    this.mc.weaponButton.gotoAndStop(3);
               }
               else if(this.currentItemType == com.brockw.stickwar.market.MarketItem.T_ARMOR)
               {
               ...
               if(this.mc.weaponButton.hitTestPoint(stage.mouseX,stage.mouseY,true) && this.mc.weaponButton.buttonMode)
               {
                    if(this.isMouseDown)
                    {
                         this.currentItemType = com.brockw.stickwar.market.MarketItem.T_WEAPON;
                         this.main.soundManager.playSoundFullVolume("clickButton");
                         this.updateUnitCard();
                    }
               }
               else if(this.mc.armorButton.hitTestPoint(stage.mouseX,stage.mouseY,true) && this.mc.armorButton.buttonMode)
               {
                    if(this.isMouseDown)
                    {
                         this.currentItemType = com.brockw.stickwar.market.MarketItem.T_ARMOR;
                         this.main.soundManager.playSoundFullVolume("clickButton");
                         this.updateUnitCard();
                    }
               }
               else if(this.mc.miscButton.hitTestPoint(stage.mouseX,stage.mouseY,true) && this.mc.miscButton.buttonMode)
               {
                    if(this.isMouseDown)
                    {
                         this.currentItemType = com.brockw.stickwar.market.MarketItem.T_MISC;
                         this.main.soundManager.playSoundFullVolume("clickButton");
                         this.updateUnitCard();
                    }
               }
          ...
          public function updateUnitCard() : *
          {
               ...
               var _loc1_:* = this.main.itemMap.getItems(this.selectedUnit.id,com.brockw.stickwar.market.MarketItem.T_WEAPON);
               var _loc2_:* = this.main.itemMap.getItems(this.selectedUnit.id,com.brockw.stickwar.market.MarketItem.T_ARMOR);
               var _loc3_:* = this.main.itemMap.getItems(this.selectedUnit.id,com.brockw.stickwar.market.MarketItem.T_MISC);
          ...
          {
               return new com.brockw.stickwar.market.ArmoryUnitCard(this.main,param1,param2,ItemMap.getUnitMcFromType(param2),param3,param4);
          }
          ...
          public function openEditCard(param1:com.brockw.stickwar.market.MarketItem) : void
          {
               ...
               this.mc.editCard.displayName.text = "" + param1.displayName;
               if(param1.type == com.brockw.stickwar.market.MarketItem.T_ARMOR)
               {
                    this.mc.editCard.itemType.text = "Armour";
               }
               else if(param1.type == com.brockw.stickwar.market.MarketItem.T_WEAPON)
               {
                    this.mc.editCard.itemType.text = "Weapon";
               }
               else if(param1.type == com.brockw.stickwar.market.MarketItem.T_MISC)
               {
