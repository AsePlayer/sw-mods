package com.brockw.stickwar
{
     ...
     public class Main extends BaseMain
     {
          ...
          public static var QUEUE_DODGE_WAIT_TIME:Number = 120000;
          ...
          public function init() : void
          {
               ...
               currentReplayLink = "";
               this.timeDodgedQueue = Number(getTimer()) - 0;
               ...
               this.inQueue = false;
               this.pendingMembership = true;
               this.lobby = null;
               this.gameRoom = null;
               showScreen("customMatch");
          ...
          private function loadWords() : void
          {
               ...
               {
                    if((_loc5_ = this.badWords[_loc4_].replace(/[^a-z]/gi,"")) == this.badWords[_loc4_])
                    {
                         _loc3_ += _loc3_ == "" ? "" : "|";
                         _loc3_ += "" + _loc5_ + "";
                    }
          ...
          public function extensionResponse(param1:SFSEvent) : void
          {
               ...
               switch(param1.params.cmd)
               {
                    ...
                    case "buddyGameInvitation":
                         ...
                         _loc4_ = int(_loc3_.getInt("inviter"));
