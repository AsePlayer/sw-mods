package com.brockw.stickwar.singleplayer
{
     ...
     public class SingleplayerRaceSelect extends Screen
     {
          ...
          public function SingleplayerRaceSelect(param1:stickwar2)
          {
               this.main = param1;
               this.main.isMember = true;
          ...
          private function mouseDown(param1:MouseEvent) : void
          {
               ...
               {
                    this.main.raceSelected = Math.floor(Math.random() * 3);
                    this.main.soundManager.playSoundFullVolume("SelectRaceSound");
                    this.hasClicked = true;
               }
          ...
          private function update(param1:Event) : void
          {
               ...
               {
                    this.raceSelectMc.membershipRequired.y += (684 - Number(this.raceSelectMc.membershipRequired.y)) * 0.1;
               }
               else
               {
                    this.raceSelectMc.membershipRequired.y += (740 - Number(this.raceSelectMc.membershipRequired.y)) * 0.1;
               }
          }
