package com.brockw.stickwar.campaign
{
     ...
     public class Campaign
     {
          ...
          public var OldRetry:int = 0;
          
          public var loadout1:String;
          
          public var loadout2:String;
          ...
          private function initUpgradeTree() : void
          {
               ...
               this.upgradeMap[_loc1_.name] = _loc1_;
               _loc1_ = new CampaignUpgrade("Statue Health",["Castle Archer III"],["Castle Archer IV"],Tech.STATUE_HEALTH);
               this.upgradeMap[_loc1_.name] = _loc1_;
          ...
          public function save() : void
          {
               ...
               _loc1_.data.loadout1 = this.loadout1;
               _loc1_.data.loadout2 = this.loadout2;
          ...
          {
               var _loc1_:SharedObject = SharedObject.getLocal("stickempiresSave");
               return _loc1_.data.currentLevel > 0 || this.loadout1 != null;
          }
          ...
          public function load() : void
          {
               ...
               if(this.loadout1)
               {
                    this.loadout1.fromString(_loc1_.data.loadout1);
                    this.loadout2 = _loc1_.data.loadout2;
               }
               var _loc2_:Array = new Array();
