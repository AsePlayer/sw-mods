package com.brockw.stickwar.engine.multiplayer
{
     ...
     public class LoginScreen extends Screen
     {
          ...
          public function LoginScreen(param1:Main)
          {
               ...
               this.preRegisterForm = new com.brockw.stickwar.engine.multiplayer.PreRegisterForm(param1);
               this.preRegisterForm.visible = false;
               addChild(this.preRegisterForm);
               this.forgotPasswordForm = new com.brockw.stickwar.engine.multiplayer.ForgotPasswordForm(param1);
          ...
          public function receiveNewsItem(param1:SFSObject) : void
          {
               ...
               if(!(_loc7_ in this.newsPanels))
               {
                    ...
                    this.newsPanels[_loc7_].x += (Number(this.newsPanels[_loc7_].index) * 200 - Number(this.newsPanels[_loc7_].x)) * 1;
               }
          ...
          {
               if(this.loginMc.newsContainer.x > -(Number(this.loginMc.newsContainer.width) - 200))
               {
                    --this.newsIndex;
               }
               this.getNewsItem(-1 * Number(this.newsIndex) + 1);
          }
          ...
          private function update(param1:Event) : void
          {
               ...
               {
                    _loc3_.update();
                    if(_loc2_ == -1 * Number(this.newsIndex))
                    {
                         _loc3_.visible = true;
                    }
                    else
               ...
               if(Number(this.loginMc.newsContainer.x) - Number(this.originalPanelX) > 0)
               {
                    this.loginMc.newsContainer.x += (this.originalPanelX + Number(this.newsIndex) * 200 - Number(this.loginMc.newsContainer.x)) * 1;
               }
               else
               {
                    this.loginMc.newsContainer.x += (this.originalPanelX + Number(this.newsIndex) * 200 - Number(this.loginMc.newsContainer.x)) * 1;
               }
               if(Number(this.loginMc.newsContainer.x) - Number(this.originalPanelX) <= -(Number(this.loginMc.newsContainer.width) - 200))
               {
