package com.brockw.stickwar.engine.Team.Elementals
{
     ...
     public class TeamElemental extends Team
     {
          ...
          protected function combineTwo(param1:int, param2:int) : Boolean
          {
               ...
               if(_loc4_ != null && _loc5_ != null && (Boolean(this.unitsAvailable) && !(giveUnitToCombine(_loc4_,_loc5_) in this.unitsAvailable)))
               {
          ...
          {
               if(param1.keyBoardState.isPressed(param4) && (Boolean(this.unitsAvailable) && !(giveUnitToCombine(param2,param3) in this.unitsAvailable)))
               {
          ...
          protected function combineAllInputSwitch(param1:UserInterface, param2:int, param3:int, param4:int, param5:int, param6:int) : void
          {
               ...
               {
                    if(!(Unit.U_CHROME_ELEMENT in this.unitsAvailable))
                    {
                         return;
                    }
          ...
          public function combine(param1:Unit, param2:Unit) : void
          {
               ...
               if(Boolean(this.unitsAvailable) && !(_loc3_ in unitsAvailable))
               {
                    ...
                    if(this == game.team)
                    {
                         game.gameScreen.userInterface.helpMessage.showMessage("Unit is still Locked.");
                    }
                    return;
               }
          ...
          public function combineAll(param1:Unit, param2:Unit, param3:Unit, param4:Unit) : void
          {
               ...
               if(game.team.unitsAvailable[Unit.U_CHROME_ELEMENT] == 0)
               {
                    ...
                    if(this == game.team)
                    {
                         game.gameScreen.userInterface.helpMessage.showMessage("Unit is locked behind bars!");
                    }
                    return;
               }
          ...
          private function tryElementalCombineMove(param1:int) : Boolean
          {
               ...
               if(Boolean(this.unitsAvailable) && !(param1 in this.unitsAvailable))
               {
                    return;
               }
               if(param1 in this.unitsAvailable)
               {
               ...
               for(_loc6_ in buttonInfoMap)
               {
                    ...
                    else
                    {
                         ...
                         if(_loc4_ == false && _loc8_.hitTestPoint(_loc2_,_loc3_,false))
                         {
                              ...
                              {
                                   if(Boolean(this.unitsAvailable) && !(_loc6_ in this.unitsAvailable))
                                   {
                                        game.gameScreen.userInterface.helpMessage.showMessage("You need to unlock the Unit first.");
                                        game.soundManager.playSoundFullVolume("UnitMakeFail");
                                   }
                                   else if(!this.canAfford(_loc6_))
                                   {
          ...
          public function updateButtonOverXMLElementalUnit(param1:StickWar, param2:XMLList, param3:int, param4:Number, param5:Number) : void
          {
               ...
               {
                    var name:String = String(param2.name);
                    if(param3 == Unit.U_AIR_ELEMENT || param3 == Unit.U_EARTH_ELEMENT || param3 == Unit.U_WATER_ELEMENT || param3 == Unit.U_FIRE_ELEMENT)
                    {
                         param1.tipBox.displayTip(name,param2.info,param2.cooldown,param4,param5,param2.population);
                    }
                    else if(param3 == Unit.U_LAVA_ELEMENT)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["fire","earth"],param2.mana);
                    }
                    else if(param3 == Unit.U_TREE_ELEMENT)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["water","earth"],param2.mana);
                    }
                    else if(param3 == Unit.U_HURRICANE_ELEMENT)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["water","air"],param2.mana);
                    }
                    else if(param3 == Unit.U_FIRESTORM_ELEMENT)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["fire","air"],param2.mana);
                    }
                    else if(param3 == Unit.U_CHROME_ELEMENT)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["fire","earth","air","water"],param2.mana);
                    }
                    else if(param3 == Unit.U_STEAM_EXPLOSION)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["fire","water"],param2.mana);
                    }
                    else if(param3 == Unit.U_SANDSTORM)
                    {
                         param1.tipBox.displayElementalTip(name,param2.info,0,["earth","air"],param2.mana);
                    }
               }
               hit = true;
          }
          
          public function giveUnitToCombine(param3:int, param4:int, chrome:Boolean = false) : int
          {
               if(chrome)
               {
                    return Unit.U_CHROME_ELEMENT;
               }
               if(param3 == Unit.U_EARTH_ELEMENT && param4 == Unit.U_FIRE_ELEMENT || param3 == Unit.U_FIRE_ELEMENT && param4 == Unit.U_EARTH_ELEMENT)
               {
                    return Unit.U_LAVA_ELEMENT;
               }
               if(param3 == Unit.U_EARTH_ELEMENT && param4 == Unit.U_WATER_ELEMENT || param3 == Unit.U_WATER_ELEMENT && param4 == Unit.U_EARTH_ELEMENT)
               {
                    return Unit.U_TREE_ELEMENT;
               }
               if(param3 == Unit.U_AIR_ELEMENT && param4 == Unit.U_WATER_ELEMENT || param3 == Unit.U_WATER_ELEMENT && param4 == Unit.U_AIR_ELEMENT)
               {
                    return Unit.U_HURRICANE_ELEMENT;
               }
               if(param3 == Unit.U_AIR_ELEMENT && param4 == Unit.U_FIRE_ELEMENT || param3 == Unit.U_FIRE_ELEMENT && param4 == Unit.U_AIR_ELEMENT)
               {
