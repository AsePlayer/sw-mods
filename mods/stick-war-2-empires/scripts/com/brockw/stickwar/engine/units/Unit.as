package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          public static const I_STATUE:int = 4;
          
          public static const I_ENEMY:int = 8;
          
          public static const I_FRIENDS:int = 16;
          
          public static const I_IS_BUILDING:int = 32;
          ...
          public var isStoneable:Boolean;
          ...
          protected function updateElementalCombine() : void
          {
               ...
               {
                    if(Boolean(this.combineMc) && this.mc.contains(this.combineMc))
                    {
          ...
          override public function drawOnHud(param1:MovieClip, param2:StickWar) : void
          {
               ...
               else if(this.isTowerSpawned)
               {
                    MovieClip(param1).graphics.lineStyle(2,38911,1);
               }
               else if(selected)
               {
          ...
          protected function initSync() : void
          {
               ...
               {
                    _loc2_ = String(FrameLabel(this.mc.currentLabels[_loc1_]).name);
          ...
          public function updateStatus() : void
          {
               ...
               if(this.fireDamageFrames > 0)
               {
                    ...
                    this.damage(D_NO_BLOOD | D_NO_SOUND | D_FIRE,this.fireDamagePerFrame,null);
                    if(this.fireDamageFrames == 0)
                    {
          ...
          protected function updateCommon(param1:StickWar) : void
          {
               ...
               if(this.isProtected())
               {
                    this.protectFilter.strength = 2 + Math.sin(this.team.game.frame / 30 * 3.141592654);
          ...
          public function updateSelected() : void
          {
               ...
               {
                    this.drawSelected(65280,this.isBusy() ? 3 : 1,this.isBusy() ? 255 : 65280);
               }
               else if(selected && this.isInteractable && this.isAlive())
               {
                    this.drawSelected(16777215,this.isBusy() ? 3 : 1,this.isBusy() ? 255 : 16777215);
               }
               else
               {
                    this.removedSelected();
          ...
          protected function removedSelected() : void
          {
               ...
               this.shadowSprite.graphics.lineStyle(this.isBusy() ? 3 : 1,this.isBusy() ? 255 : 0,this.isBusy() ? 1 : 0);
               if(this.isAlive())
               {
          ...
          public function setFire(param1:int, param2:Number) : void
          {
               ...
               if(this.fireDamagePerFrame < param2 || this.fireDamageFrames < param1)
               {
                    ...
                    if(Boolean(this.fireEffectMc) && this.mc.contains(this.fireEffectMc))
                    {
                         this.mc.removeChild(this.fireEffectMc);
                    }
          ...
          protected function checkCollision(param1:com.brockw.stickwar.engine.units.Unit) : void
          {
               ...
               if(Boolean(param1._isGarrisoned) || Boolean(this._isGarrisoned))
               {
                    return;
               }
               ...
               {
                    param1 = Unit(param1);
                    if((!param1.mayWalkThrough || param1.type == com.brockw.stickwar.engine.units.Unit.U_TREE_ELEMENT && type == com.brockw.stickwar.engine.units.Unit.U_TREE_ELEMENT) && param1.stunTimeLeft == 0 && Boolean(param1.isCollision(this,this.dx,this.dy)))
                    {
                         _loc2_ = 0.15;
          ...
          public function checkForHitPoint(param1:Point, param2:com.brockw.stickwar.engine.units.Unit) : Boolean
          {
               ...
               var _loc3_:int = int(Util.sgn(param2.px - px));
          ...
          override public function damage(param1:int, param2:Number, param3:Entity, param4:Number = 1) : void
          {
               ...
               if(this.isTargetable() && !this.isDualing)
               {
                    ...
                    if(this._health <= 0)
                    {
                         ...
                         if(Boolean(param1 & D_FIRE) && this.isFirable)
                         {
                              this.isOnFire = true;
                         }
