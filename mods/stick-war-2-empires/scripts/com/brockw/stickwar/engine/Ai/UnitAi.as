package com.brockw.stickwar.engine.Ai
{
     ...
     public class UnitAi
     {
          ...
          public function getClosestSpellableTarget() : Unit
          {
               this.temp = this.currentTarget;
               ...
               this.targetedSpell = this.currentTarget;
               this.currentTarget = temp;
               return this.targetedSpell;
          }
          
          public function getBestPossessTarget() : Unit
          {
               this.temp = this.currentTarget;
               var _loc3_:* = undefined;
               var _loc4_:* = null;
               ...
               this.isTargeted = false;
               var _loc2_:int = 0;
               var _loc69_:int = -1000;
               var _loc70_:* = null;
               while(_loc2_ < this.unit.team.enemyTeam.units.length)
               {
                    _loc3_ = _loc2_;
                    _loc4_ = this.unit.team.enemyTeam.units[_loc3_];
                    if(true)
                    {
                         if(this.unit.team.enemyTeam.units[_loc3_].isGarrisoned == false)
                         {
                              if(this.currentTarget != null)
                              {
                                   _loc69_ = this.currentTarget.health;
                                   _loc4_ = this.unit.team.enemyTeam.units[_loc3_];
                              }
                              if(this.unit.team.enemyTeam.type == 0)
                              {
                                   if(_loc4_.type == Unit.U_ENSLAVED_GIANT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                             {
                                                  this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                                  _loc69_ = int(_loc4_.health);
                                             }
                                        }
                                        else if(this.currentTarget != null)
                                        {
                                             if(this.currentTarget.type == _loc4_.type)
                                             {
                                                  if(_loc69_ < _loc4_.health)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                                       _loc69_ = int(_loc4_.health);
                                                  }
                                   ...
                                   else if(_loc4_.type == Unit.U_MAGIKILL)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_SPEARTON)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_MONK)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_NINJA)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON || this.currentTarget.type != Unit.U_MONK)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_FLYING_CROSSBOWMAN)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON || this.currentTarget.type != Unit.U_MONK || this.currentTarget.type != Unit.U_NINJA)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_ARCHER)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON || this.currentTarget.type != Unit.U_MONK || this.currentTarget.type != Unit.U_NINJA || this.currentTarget.type != Unit.U_FLYING_CROSSBOWMAN)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_SWORDWRATH)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON || this.currentTarget.type != Unit.U_MONK || this.currentTarget.type != Unit.U_NINJA || this.currentTarget.type != Unit.U_FLYING_CROSSBOWMAN || this.currentTarget.type != Unit.U_ARCHER)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_MINER)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_ENSLAVED_GIANT || this.currentTarget != Unit.U_MAGIKILL || this.currentTarget.type != Unit.U_SPEARTON || this.currentTarget.type != Unit.U_MONK || this.currentTarget.type != Unit.U_NINJA || this.currentTarget.type != Unit.U_FLYING_CROSSBOWMAN || this.currentTarget.type != Unit.U_ARCHER || this.currentTarget.type != Unit.U_SWORDWRATH)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              if(this.unit.team.enemyTeam.type == 2)
                              {
                                   if(_loc4_.type == Unit.U_CHROME_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                   ...
                                   else if(_loc4_.type == Unit.U_HURRICANE_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_LAVA_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_TREE_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_FIRESTORM_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT || this.currentTarget.type != Unit.U_TREE_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_WATER_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT || this.currentTarget.type != Unit.U_TREE_ELEMENT || this.currentTarget.type != Unit.U_FIRESTORM_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_AIR_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT || this.currentTarget.type != Unit.U_TREE_ELEMENT || this.currentTarget.type != Unit.U_FIRESTORM_ELEMENT || this.currentTarget.type != Unit.U_WATER_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_FIRE_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT || this.currentTarget.type != Unit.U_TREE_ELEMENT || this.currentTarget.type != Unit.U_FIRESTORM_ELEMENT || this.currentTarget.type != Unit.U_WATER_ELEMENT || this.currentTarget.type != Unit.U_AIR_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_EARTH_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT || this.currentTarget.type != Unit.U_HURRICANE_ELEMENT || this.currentTarget.type != Unit.U_LAVA_ELEMENT || this.currentTarget.type != Unit.U_TREE_ELEMENT || this.currentTarget.type != Unit.U_FIRESTORM_ELEMENT || this.currentTarget.type != Unit.U_WATER_ELEMENT || this.currentTarget.type != Unit.U_AIR_ELEMENT || this.currentTarget.type != unit.U_FIRE_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_MINER_ELEMENT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_CHROME_ELEMENT && this.currentTarget.type != Unit.U_HURRICANE_ELEMENT && this.currentTarget.type != Unit.U_LAVA_ELEMENT && this.currentTarget.type != Unit.U_TREE_ELEMENT && this.currentTarget.type != Unit.U_FIRESTORM_ELEMENT && this.currentTarget.type != Unit.U_WATER_ELEMENT && this.currentTarget.type != Unit.U_AIR_ELEMENT && this.currentTarget.type != Unit.U_FIRE_ELEMENT && this.currentTarget.type != Unit.U_EARTH_ELEMENT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              if(this.unit.team.enemyTeam.type == 1)
                              {
                                   if(_loc4_.type == Unit.U_GIANT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                   ...
                                   else if(_loc4_.type == Unit.U_MEDUSA)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_SKELATOR)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_CHAOS_TOWER)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_KNIGHT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_WINGIDON)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER || this.currentTarget.type != Unit.U_KNIGHT)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_DEAD)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER || this.currentTarget.type != Unit.U_KNIGHT || this.currentTarget.type != Unit.U_WINGIDON)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_CHAOS_MINER)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER || this.currentTarget.type != Unit.U_KNIGHT || this.currentTarget.type != Unit.U_WINGIDON || this.currentTarget.type != Unit.U_DEAD)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                             {
                                                  this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_BOMBER)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER || this.currentTarget.type != Unit.U_KNIGHT || this.currentTarget.type != Unit.U_WINGIDON || this.currentTarget.type != Unit.U_DEAD || this.currentTarget.type != Unit.U_CHAOS_MINER)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                                   ...
                                   else if(_loc4_.type == Unit.U_CAT)
                                   {
                                        if(this.currentTarget == null)
                                        {
                                             if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                        ...
                                        else if(this.currentTarget != null)
                                        {
                                             ...
                                             else if(this.currentTarget.type != Unit.U_GIANT || this.currentTarget.type != Unit.U_MEDUSA || this.currentTarget.type != Unit.U_SKELATOR || this.currentTarget.type != Unit.U_CHAOS_TOWER || this.currentTarget.type != Unit.U_KNIGHT || this.currentTarget.type != Unit.U_WINGIDON || this.currentTarget.type != Unit.U_DEAD || this.currentTarget.type != Unit.U_CHAOS_MINER || this.currentTarget.type != Unit.U_BOMBER)
                                             {
                                                  if(_loc4_.health / _loc4_.maxHealth > 0.1)
                                                  {
                                                       this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
               ...
               if(this.currentTarget != null)
               {
                    if(this.currentTarget.type == Unit.U_STATUE || this.currentTarget.type == Unit.U_WALL || this.currentTarget.type == Unit.U_SCORPION_ELEMENT)
                    {
                         this.currentTarget = null;
                    }
               }
          ...
          public function getBestTeleportTarget() : Unit
          {
               this.temp = this.currentTarget;
               var _loc3_:* = undefined;
               var _loc4_:* = null;
               ...
               while(_loc2_ < this.unit.team.enemyTeam.units.length)
               {
                    ...
                    if(true)
                    {
                         if(this.unit.team.enemyTeam.units[_loc3_].isGarrisoned == false)
                         {
                              if(this.currentTarget != null && this.currentTarget.type == _loc4_.type)
                              {
                                   _loc69_ = this.currentTarget.health;
                              }
                              _loc70_ = int(_loc4_.health);
                              if(_loc4_.type == Unit.U_CHROME_ELEMENT || _loc4_.type == Unit.U_MEDUSA || _loc4_.type == Unit.U_MAGIKILL || _loc4_.type == Unit.U_FIRESTORM_ELEMENT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_MONK || _loc4_.type == Unit.U_SKELATOR || _loc4_.type == Unit.U_TREE_ELEMENT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_NINJA || _loc4_.type == Unit.U_DEAD || _loc4_.type == Unit.U_FIRE_ELEMENT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_KNIGHT || _loc4_.type == Unit.U_ARCHER || _loc4_.type == Unit.U_LAVA_ELEMENT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_SPEARTON || _loc4_.type == Unit.U_GIANT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_SWORDWRATH || _loc4_.type == Unit.U_CAT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_FLYING_CROSSBOWMAN || _loc4_.type == Unit.U_WINGIDON || _loc4_.type == Unit.U_HURRICANE_ELEMENT || _loc4_.type == Unit.U_WATER_ELEMENT || _loc4_.type == Unit.U_AIR_ELEMENT)
                              {
                                   _loc69_ = -10000;
                              }
                              else if(_loc4_.type == Unit.U_CHAOS_MINER || _loc4_.type == Unit.U_ENSLAVED_GIANT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_MINER || _loc4_.type == Unit.U_BOMBER || _loc4_.type == Unit.U_EARTH_ELEMENT)
                              {
                                   if(_loc69_ > _loc4_.health)
                                   {
                                        this.currentTarget = this.unit.team.enemyTeam.units[_loc3_];
                              ...
                              else if(_loc4_.type == Unit.U_STATUE || _loc4_.type == Unit.U_WALL || _loc4_.type == Unit.U_SCORPION_ELEMENT || _loc4_.type == Unit.U_CHAOS_TOWER)
                              {
                                   _loc69_ = -1000;
                              }
                         }
          ...
          public function isFreezeable(param1:Unit) : Boolean
          {
               ...
               {
                    _loc2_ = Magikill(param1);
                    if(_loc2_.scale == 2.011)
                    {
                         return false;
                    }
                    return true;
               }
               return param1.type != Unit.U_GIANT && param1.type != Unit.U_ENSLAVED_GIANT && param1.type != Unit.U_CHROME_ELEMENT && param1.type != Unit.U_MEDUSA;
          }
