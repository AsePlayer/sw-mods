package com.brockw.stickwar.engine.units
{
     ...
     public class Monk extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          public var healTarget:com.brockw.stickwar.engine.units.Unit;
          ...
          override public function update(game:StickWar) : void
          {
               ...
               else if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    health = Number(game.xml.xml.Order.Units.monk.health) / 2.5 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
