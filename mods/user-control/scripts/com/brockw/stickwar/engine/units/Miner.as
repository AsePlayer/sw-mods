     ...
     public class Miner extends Unit
     {
          ...
          override public function update(game:StickWar) : void
          {
               if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    health = Number(game.xml.xml.Order.Units.miner.health) / 2.5 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               if(team.isEnemy)
               {
                    ...
                    {
                         setItem(mc,"Ancient Pickaxe","","Wagon");
                    }
                    else if(team.game.main.campaign.difficultyLevel == 2)
                    {
                         setItem(mc,"Hammer","","Trolley");
                    }
