     ...
     public class Ninja extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(game:StickWar) : void
          {
               ...
               else if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    health = Number(game.xml.xml.Order.Units.ninja.health) / 2.5 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               if(team.isEnemy)
               {
                    ...
                    {
                         setItem(mc,"Knifed Pole","Blue Mask","Ninja Claws");
                    }
                    else if(team.game.main.campaign.difficultyLevel == 2)
                    {
                         setItem(mc,"Spike Staff","Tribal Ninja","Katana");
                    }
