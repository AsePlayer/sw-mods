class SwordMan extends Man
{
     ...
     function SwordMan(x, y, squad, simUnits, game)
     {
          ...
          this.isMinion = false;
          this.isGiantMinion = false;
          this.isCheif = false;
          this.isSickleWrath = false;
          this.isWrathnar = false;
          this.isGlacialSword = false;
          this.isLavaSword = false;
          this.isSavageSword = false;
          this.isXenophon = false;
          this.isCherrySickle = false;
          this.isDragonflypc = false;
     }
     function update()
     {
          super.update();
          ...
          else if(this.isGiantMinion)
          {
               this.clip.weapon = 5;
          }
          else if(this.isCheif)
          {
               this.clip.weapon = 6;
               this.clip.helmet = 2;
          }
          ...
          else if(this.isSavageSword)
          {
               this.clip.weapon = 10;
          }
          else if(this.isXenophon)
          {
               this.clip.weapon = 11;
          }
          else if(this.isCherrySickle)
          {
               this.clip.weapon = 12;
          }
          else if(this.isDragonflypc)
          {
               this.clip.weapon = 12;
          }
          else
          {
               ...
               this.clip.helmet = this.squad.getTechnology().getSwordmanSpeed();
          }
          if(this.inShock)
          {
               this.isSwinging = false;
     ...
     function setAsGiantMinion()
     {
          this.baseScale *= 0.45;
          this.health *= 12;
          this.MAX_HEALTH *= 12;
          this.SWORDMAN_RANGE *= 2.5;
          this.MAX_ACCELERATION = 0.6;
          this.isGiantMinion = true;
     }
     function setAsCheif()
     {
          this.baseScale *= 0.6;
     ...
     function setAsWrathnar()
     {
          ...
          this.SWORDMAN_RANGE *= 1.25;
     }
     function setAsGlacialSword()
     {
          this.health *= 1.75;
          this.MAX_HEALTH *= 1.75;
          this.isGlacialSword = true;
     }
     ...
     function setAsSavageSword()
     {
          this.health *= 1.5;
          this.MAX_HEALTH *= 1.5;
          this.isSavageSword = true;
          this.MAX_VELOCITY *= 2;
          this.MAX_ACCELERATION *= 2;
     }
     function setAsXenophon()
     {
          this.baseScale *= 0.85;
          this.health *= 9;
          this.MAX_HEALTH *= 9;
          this.SWORDMAN_RANGE *= 1.25;
          this.isXenophon = true;
     }
     function setAsCherrySickle()
     {
          this.baseScale *= 0.93;
          this.health *= 3;
          this.MAX_HEALTH *= 3;
          this.isCherrySickle = true;
     }
     function setAsDragonFlyPC()
     {
          this.baseScale *= 0.5;
          this.health *= 30;
          this.MAX_HEALTH *= 30;
          this.SWORDMAN_RANGE *= 2.5;
          this.isDragonflypc = true;
     }
}
