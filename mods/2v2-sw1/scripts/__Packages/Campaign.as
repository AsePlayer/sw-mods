class Campaign
{
     ...
     function loadLevel()
     {
          ...
          {
               this.technology.gold = 800;
               this.technology.statue = 2;
               this.technology.setIsNotSpartan(false);
               this.loadLevel1();
          }
          else if(this.level == 2)
          {
               ...
               this.technology.setIsNotSpartan(true);
               this.loadLevel2();
          }
          else if(this.level == 3)
          {
               this.technology.setIsNotSpartan(false);
               this.technology.statue = 10;
               this.loadLevel3();
          }
          else if(this.level == 4)
          {
               this.technology.gold = 800;
               this.technology.statue = 1;
               this.loadLevel4();
          }
          else if(this.level == 5)
          {
               this.technology.gold = 750;
               this.technology.statue = 12;
               this.loadLevel5();
          }
          else if(this.level == 6)
          {
               this.technology.statue = 13;
               this.loadLevel6();
          }
     ...
     function loadLevel1()
     {
          ...
          var _loc5_ = new Game(1,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,7,6,5);
          _root.game = _loc5_;
     ...
     function loadLevel2()
     {
          ...
          _loc3_.setIsNotSpartan(false);
          if(this.difficultyLevel == 3)
          {
               _loc3_.setSwordmanSword(3);
          }
          var _loc4_ = new AiLevel2();
          var _loc5_ = new Game(2,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,6,7,6);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          _root.gotoAndPlay("game");
     }
     function loadLevel3()
     {
          ...
          var _loc5_ = new Game(3,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,3,8,4);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          _root.gotoAndPlay("game");
     }
