class Campaign
{
     ...
     function loadLevel1()
     {
          ...
          else
          {
               ...
               _loc3_.setSwordmanSword(1);
               _loc3_.setSpartanShield(2);
          }
          var _loc4_ = new AiLevel1();
          var _loc5_ = new Game(1,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,7,9,8);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          _loc5_.getSquad1().addSwordMan();
          _loc5_.getSquad1().addMiner();
          _loc5_.getSquad1().addMiner();
          _root.gotoAndPlay("game");
     }
