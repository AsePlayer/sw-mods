package com.brockw.stickwar.engine.units
{
     ...
     public class Ninja extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.ninjaType == "HankShadowrath" && !this.setupComplete)
               {
                    this.ai.archerTargeter = true;
                    this.stealthSpellGlow.color = 5;
                    maxHealth = 300;
                    health = 300;
                    maxHealth = maxHealth;
               ...
               if(this.ninjaType == "HankShadowrath")
               {
                    Ninja.setItem(_ninja(mc),"Knifed Pole","Visor Ninja","Katana");
               }
               else
               {
