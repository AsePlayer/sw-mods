package com.brockw.stickwar.engine.units
{
     ...
     public class Bomber extends Unit
     {
          ...
          {
               updateCommon(param1);
               if(this.bomberType == "StatueBomber" && !this.setupComplete)
               {
               ...
               if(this.bomberType == "StatueBomber")
               {
          ...
          {
               if(this.bomberType == "StatueBomber" && !this.detonated)
               {
                    ...
                    this.clusterLad.bomberType = "Default";
                    this.clusterLad = team.game.unitFactory.getUnit(Unit.U_BOMBER);
                    team.spawn(this.clusterLad,team.game);
                    this.clusterLad.px = px - 75;
                    this.clusterLad.py = py;
