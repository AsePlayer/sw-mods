package com.brockw.stickwar.campaign.controllers
{
     ...
     public class CampaignTutorial extends CampaignController
     {
          ...
          private function skipTutorialClick(param1:Event) : void
          {
               ...
               _loc2_.team.unitsAvailable[Unit.U_SWORDWRATH] = 1;
               _loc2_.team.unitsAvailable[Unit.U_MINER] = 1;
               _loc2_.team.spawnUnitGroup([Unit.U_MINER,Unit.U_MINER,Unit.U_SWORDWRATH]);
               if(this._gameScreen.game.main.campaign.difficultyLevel == Campaign.D_NORMAL)
               {
                    _loc2_.team.enemyTeam.spawnUnitGroup([Unit.U_MINER,Unit.U_MINER,Unit.U_MINER]);
               }
               else
               {
                    _loc2_.team.enemyTeam.spawnUnitGroup([Unit.U_MINER,Unit.U_MINER,Unit.U_MINER,Unit.U_MINER,Unit.U_SPEARTON]);
               }
          ...
          override public function update(param1:GameScreen) : void
          {
               ...
               {
                    _loc11_ = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && this.s1.selected == true && this.s2.selected == true)
                    {
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && this.s1.px < 2500 && this.s2.px < 2500)
                    {
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && Boolean(Unit(param1.team.buildings["ArcheryBuilding"]).selected))
                    {
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && Boolean(this.spearton1.isDead))
                    {
