package com.brockw.stickwar.engine.units
{
     ...
     public class Spearton extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.speartonType == "Test" && !this.setupComplete)
               {
                    noStone = true;
                    Spearton.setItem(_mc,"Golden Spear","Golden Helmet","Golden Shield");
                    maxHealth = 900;
                    health = 900;
                    maxHealth = maxHealth;
               ...
               {
                    burnUnit = true;
                    Spearton.setItem(_mc,"Lava Spear","Lava Helmet","Lava Shield");
                    maxHealth = 900;
                    health = 900;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
          ...
          {
               if(this.inBlock || this.speartonType == "Test")
               {
