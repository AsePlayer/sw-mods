package com.brockw.stickwar.engine.units
{
     ...
     public class Swordwrath extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               {
                    Swordwrath.setItem(_mc,"Xenophon","Lava","");
                    maxHealth = 900;
                    health = 900;
                    maxHealth = maxHealth;
               ...
               {
                    isVampUnit = true;
                    Swordwrath.setItem(_mc,"Blood Blade","","");
                    maxHealth = 180;
                    health = 180;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    isVampUnit = true;
                    Swordwrath.setItem(_mc,"Blood Blade","Lava","");
                    maxHealth = 3500;
                    health = 3500;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    stunUnit = true;
                    Swordwrath.setItem(_mc,"Sickle","Sicklehat","");
                    maxHealth = 1000;
                    health = 1000;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    Swordwrath.setItem(_mc,"Leaf Sickle","","");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    freezeUnit = true;
                    Swordwrath.setItem(_mc,"Ice Sickle","","");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    stunUnit = true;
                    Swordwrath.setItem(_mc,"Savage Sickle","","");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.swordwrathType == "Lavasickle" && !this.setupComplete)
               {
                    fireRegen = true;
                    burnUnit = true;
                    Swordwrath.setItem(_mc,"Lava Sickle","","");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.swordwrathType == "Vampsickle" && !this.setupComplete)
               {
                    ...
                    lifeSteal = true;
                    lifeStealAmount = 10;
                    Swordwrath.setItem(_mc,"Vamp Sickle","","");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    isVampUnit = true;
                    Swordwrath.setItem(_mc,"Gold Spear","Gold Helmet","");
                    maxHealth = 3100;
                    health = 3100;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    if(this.swordwrathType == "Savagesickle" || this.swordwrathType == "Leafsickle")
                    {
                         _maxVelocity = 8.3;
                    }
                    else
               ...
               if(this.swordwrathType == "Savagesickle" || this.swordwrathType == "SickleGeneral" || this.swordwrathType == "SickleLeader" || this.swordwrathType == "Baron")
               {
                    stunTimeLeft = 0;
               }
               ...
               {
                    Swordwrath.setItem(_mc,"Fantasy Sword","","");
               }
          }
