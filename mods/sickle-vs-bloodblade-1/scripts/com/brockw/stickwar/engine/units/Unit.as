package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          private function swordHit(param1:int) : *
          {
               if(this.targetsHit < this.maxTargetsToHit && param1.team != this.team)
               {
                    if(param1.px * this.mc.scaleX > px * this.mc.scaleX)
                    {
                         if(Math.pow(param1.px + param1.dx - this.dx - px,2) + Math.pow(param1.py + param1.dy - this.dy - py,2) < Math.pow(5 * param1.hitBoxWidth * (this.perspectiveScale + param1.perspectiveScale) / 2,2))
                         {
                              ++this.targetsHit;
