package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class TeamChaos extends Team
     {
          ...
          override public function detectedUserInput(param1:UserInterface) : void
          {
               ...
               singlePlayerDebugInputSwitch(param1,Unit.U_ARCHER,56);
          ...
          override public function initTeamButtons(param1:GameScreen) : void
          {
               ...
               buttonInfoMap[Unit.U_ARCHER] = [param1.userInterface.hud.hud.wingidonButton,param1.userInterface.hud.hud.wingidonOverlay,param1.game.xml.xml.Order.Units.archer,0,new cancelButton(),game.xml.xml.Order.Units.archer.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.fletcherBuilding,param1.userInterface.hud.hud.archerUnderlay];
