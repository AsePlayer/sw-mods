package com.brockw.stickwar.engine.maps
{
     ...
     public class GrassHills extends Map
     {
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               createMiningBlock(param1,this.width - this.screenWidth - 570,-1);
               createMiningBlock(param1,this.screenWidth + 1200,1);
               createMiningBlock(param1,this.width - this.screenWidth - 900,-1);
               createMiningBlock(param1,this.screenWidth + 2600,1);
               createMiningBlock(param1,this.screenWidth + 2900,1);
               createMiningBlock(param1,this.width - this.screenWidth - 1200,-1);
               createMiningBlock(param1,this.width - this.screenWidth - 2600,-1);
               createMiningBlock(param1,this.width - this.screenWidth - 2900,-1);
