package com.brockw.stickwar.engine.maps
{
     ...
     public class Desert extends Map
     {
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               createMiningBlock(param1,this.screenWidth + 600,1);
               createMiningBlock(param1,this.screenWidth + 1200,1);
               createMiningBlock(param1,this.width - this.screenWidth - 600,-1);
               ...
               this.divider = "---------------------------------------------------------------------------";
               this.addTower_3(this.width / 3.95,this.height / 2,param1);
               ...
               this.divider = "---------------------------------------------------------------------------";
               this.addTower_5(this.width / 1.34,this.height / 2,param1);
