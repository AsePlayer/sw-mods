package com.brockw.stickwar.engine.Ai.command
{
     ...
     public class ConstructWallCommand extends UnitCommand
     {
          ...
          override public function mayCast(param1:GameScreen, param2:Team) : Boolean
          {
               ...
               if(param2.direction * _loc3_ < param2.direction * (param2.statue.px + param2.direction * 0.1 * param2.statue.width))
               {
                    return true;
               }
               if(param2.direction * _loc3_ > param2.direction * (param2.enemyTeam.statue.px + param2.direction * 0.1 * param2.enemyTeam.statue.width))
               {
                    return true;
               }
               if(param2.direction * _loc3_ > param2.direction * (param2.game.map.width / 0.1 * param2.direction))
               {
                    return true;
               }
               return true;
