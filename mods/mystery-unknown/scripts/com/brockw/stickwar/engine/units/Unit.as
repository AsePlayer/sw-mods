     ...
     public class Unit extends Entity
     {
          ...
          override public function drawOnHud(param1:MovieClip, param2:StickWar) : void
          {
               ...
               else if(selected)
               {
                    ...
                    {
                         MovieClip(param1).graphics.lineStyle(5,30976,2);
                    }
               }
               else if(this.isASuperUnit)
               {
          ...
          protected function updateCommon(param1:StickWar) : void
          {
               ...
               if(this.massPoison)
               {
                    if(this.isAlive() && param1.frame % 203 == 0)
                    {
                         this.poison(10);
                    }
               }
          ...
          public function updateSelected() : void
          {
               if(mouseIsOver && this.isAlive())
               {
                    ...
                    {
                         this.drawSelected(46080,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 33536);
                    }
               }
