package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.EarthElementAi;
     ...
     public class EarthElement extends Unit
     {
          ...
          public var earthElementType:String;
          ...
          {
               var _loc5_:_earthElemental = null;
               if((_loc5_ = _earthElemental(param1)).mc.head && _loc5_.mc.head.hat)
               {
                    if(param3 != "")
                    {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(isUC)
               {
                    _maxVelocity = param1.xml.xml.Elemental.Units.earthElement.maxVelocity * 1.2;
                    _damageToNotArmour = (Number(param1.xml.xml.Elemental.Units.earthElement.damage) + Number(param1.xml.xml.Elemental.Units.earthElement.toNotArmour)) * 2.5;
                    _damageToArmour = (Number(param1.xml.xml.Elemental.Units.earthElement.damage) + Number(param1.xml.xml.Elemental.Units.earthElement.toArmour)) * 3.5;
                    _mass = Number(param1.xml.xml.Elemental.Units.earthElement.mass) / 2;
               }
               else if(!team.isEnemy)
               {
                    _maxVelocity = param1.xml.xml.Elemental.Units.earthElement.maxVelocity;
                    _damageToNotArmour = Number(param1.xml.xml.Elemental.Units.earthElement.damage) + Number(param1.xml.xml.Elemental.Units.earthElement.toNotArmour);
                    _damageToArmour = Number(param1.xml.xml.Elemental.Units.earthElement.damage) + Number(param1.xml.xml.Elemental.Units.earthElement.toArmour);
                    _mass = param1.xml.xml.Elemental.Units.earthElement.mass;
               }
               ...
               if(this.earthElementType == "Earth_1" && !this.setupComplete)
               {
                    maxHealth = 1300;
                    health = 1300;
                    maxHealth = maxHealth;
