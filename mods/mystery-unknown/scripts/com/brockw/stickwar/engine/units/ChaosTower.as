package com.brockw.stickwar.engine.units
{
     ...
     public class ChaosTower extends RangedUnit
     {
          ...
          public var chaosTowerType:String;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.chaosTowerType == "Tower_1" && !this.setupComplete)
               {
                    maxHealth = 2000;
                    health = 2000;
                    maxHealth = maxHealth;
               ...
               if(this.chaosTowerType == "")
               {
                    isCustomUnit = true;
               }
               if(isCustomUnit = true)
               {
                    if(this.chaosTowerType == "Tower_1")
                    {
                         stunTimeLeft = 0;
                         _maximumRange = 600;
                         this.shotRate = 20;
                         this.arrowDamage = 815;
                    }
                    else
                    {
                         this.arrowDamage = param1.xml.xml.Chaos.Units.tower.damage;
