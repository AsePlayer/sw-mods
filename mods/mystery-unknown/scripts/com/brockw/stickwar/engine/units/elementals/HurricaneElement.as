package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.HurricaneElementAi;
     ...
     public class HurricaneElement extends Unit
     {
          ...
          public var hurricaneElementType:String;
          ...
          public static function setItem(param1:MovieClip, param2:String, param3:String, param4:String) : void
          {
               ...
               if(_loc5_.mc.frontHand && _loc5_.mc.backHand)
               {
                    if(param2 != "")
                    {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.hurricaneElementType == "Wing_Rusher" && !this.setupComplete)
               {
                    HurricaneElement.setItem(_mc,"","","");
                    maxHealth = 500;
                    health = 500;
                    maxHealth = maxHealth;
