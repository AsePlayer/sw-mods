     ...
     public class Magikill extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               else if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    health = Number(param1.xml.xml.Order.Units.magikill.health) * 1.1;
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               if(!isDieing)
               {
                    ...
                    else if(this.isNuking == true)
                    {
                         ...
                         {
                              if(this.magikillType == "Default" || this.magikillType == "SW1Mage" || this.magikillType == "SW3Mage" || this.magikillType == "Magikill_1")
                              {
                                   param1.projectileManager.initFireWaterExplosion(this.spellX,this.spellY,this,150,1.65,85,120,3);
                                   hasHit = true;
                              }
                    ...
                    else if(this.isStunning == true)
                    {
                         ...
                         if(MovieClip(_mc.mc).currentFrame == 47 && !hasHit)
                         {
                              if(this.magikillType == "Default")
                              {
                                   ...
                                   param1.projectileManager.initFirestorm(this.spellX,this.spellY,0,team,getDirection(),180,2,200,7);
                                   hasHit = true;
                              }
               ...
               {
                    Magikill.setItem(_mc,"Dragon Staff","Blank","Blank");
               }
          }
