package com.brockw.stickwar.engine.units
{
     ...
     public class Archer extends RangedUnit
     {
          ...
          private var invisArcherGlow:DropShadowFilter;
          ...
          private var RandomRange:int;
          
          internal var Range:Array;
          ...
          public function Archer(param1:StickWar)
          {
               ...
               this.Range = [250,375,490,600,750,925,1140];
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               this.invisArcherGlow = new DropShadowFilter();
               this.invisArcherGlow.knockout = true;
               this.invisArcherGlow.angle = 0;
               this.invisArcherGlow.distance = 0;
               this.invisArcherGlow.color = 0;
          ...
          private function burnInArea(param1:Unit) : *
          {
               if(param1.team != this.team)
               {
                    ...
                    else if(this.archerType == "Voltaic_CA")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               this.RandomLightDamage = int(int(Math.floor(Math.random() * 1500) + 1));
               this.fireArrowRange = 1800;
               if(this.isFire == true)
               {
                    this.alpha = 0.5;
               }
               else if(this.archerType != "Clone_5" && !this.isCastleArcher && this.archerType != "CrystalArcher")
               {
                    this.alpha = 0;
               }
               if(this.isCastleArcher)
               {
                    mc.filters = [this.invisArcherGlow];
                    mc.mc.alpha = 1;
               }
               if(!isUC)
               {
               ...
               if(isUC)
               {
                    _maxVelocity = param1.xml.xml.Order.Units.archer.maxVelocity * 1.5;
                    _damageToNotArmour = (Number(param1.xml.xml.Order.Units.archer.damage) + Number(param1.xml.xml.Order.Units.archer.toNotArmour)) * 3;
                    _damageToArmour = (Number(param1.xml.xml.Order.Units.archer.damage) + Number(param1.xml.xml.Order.Units.archer.toArmour)) * 2.7;
                    _mass = Number(param1.xml.xml.Order.Units.archer.mass) / 2;
               }
               ...
               else if(team.isEnemy && !enemyBuffed && !this.isCastleArcher)
               {
                    ...
                    _damageToArmour *= 1;
                    health = Number(param1.xml.xml.Order.Units.archer.health) * 1;
                    maxHealth = health;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    enemyBuffed = true;
               }
               if(this.archerType == "Ice_CA" || this.archerType == "Voltaic_CA")
               {
               ...
               if(this.archerType == "RandomArcher")
               {
                    _damageToNotArmour = this.RandomLightDamage;
                    _damageToArmour = this.RandomHeavyDamage;
               }
               if(this.archerType == "RandomArcher" && !this.setupComplete)
               {
                    this.RandomSpeed = int(int(Math.floor(Math.random() * 13) + 1));
                    this.RandomHealth = int(int(Math.floor(Math.random() * 400) + 1));
                    com.brockw.stickwar.engine.units.Archer.setItem(_mc,"","","");
               ...
               if(this.archerType == "ChaosArcher" && !this.setupComplete)
               {
                    ...
                    healthBar.totalHealth = maxHealth;
                    _scale = 1;
                    this.archerFireSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(0,400,param1.xml.xml.Order.Units.archer.fire.mana);
                    this.setupComplete = true;
               }
               if(this.archerType == "VoltArcher" && !this.setupComplete)
               {
                    maxHealthIncrease = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","Voltaic Quiver");
                    maxHealth = 60;
                    health = 60;
                    maxHealth = maxHealth;
                    this.areaDamage = 0;
               ...
               if(this.archerType == "Archis" && !this.setupComplete)
               {
                    generalRegen = true;
                    generalRegen2 = true;
                    this.isAGeneral = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","Archis","Archis Quiver");
                    maxHealth = 500;
                    health = 500;
                    maxHealth = maxHealth;
                    this.areaDamage = 0;
                    ...
                    _scale = 0.9;
                    this.shieldwallDamageReduction = 0.62;
                    this.archerFireSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(0,350,param1.xml.xml.Order.Units.archer.fire.mana);
                    this.setupComplete = true;
               }
               if(this.archerType == "Prince_2" && !this.setupComplete)
               {
                    this.isASuperUnit = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","Prince 2","Gold Quiver");
                    maxHealth = 2900;
                    health = 2900;
                    maxHealth = maxHealth;
                    this.areaDamage = 0;
               ...
               if(this.archerType == "WoodlandPrincess" && !this.setupComplete)
               {
                    teleportFromDamage = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","Woodland Princess","Woodland Princess Quiver");
                    maxHealth = 500;
                    health = 500;
                    maxHealth = maxHealth;
                    this.areaDamage = 0;
               ...
               if(this.archerType == "VampArcher" && !this.setupComplete)
               {
                    ...
                    _maxVelocity = 5.2;
                    _scale = 0.9;
                    this.shieldwallDamageReduction = 0.52;
                    this.setupComplete = true;
               }
               ...
               if(this.archerType == "Archer_1" && !this.setupComplete)
               {
                    blueColor = true;
                    unitRegen = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","");
               ...
               if(this.archerType == "Archer_2" && !this.setupComplete)
               {
                    redColor = true;
                    unitRegen = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","");
               ...
               if(this.archerType == "NewCA" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"Default","CA Helmet","CA Quiver");
                    this.healthBar.visible = false;
                    maxHealth = 1500;
                    health = 1500000;
                    maxHealth = maxHealth;
               ...
               if(this.archerType == "StatueArcher" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"Default","Chaos Helmet","Default");
                    this.healthBar.visible = false;
                    isStationary = true;
                    flyingHeight = 490;
                    maxHealth = 8500000;
               ...
               if(this.archerType == "Ice_CA" && !this.setupComplete)
               {
                    slowRegen = true;
                    weakToFire = true;
                    selfFreeze = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","CA Ice","Ice Quiver 2");
                    maxHealth = 600;
                    health = 600;
                    maxHealth = maxHealth;
                    this.areaDamage = 15;
                    this.area = 160;
                    this.radiantRange = 220;
                    healthBar.totalHealth = maxHealth;
                    _scale = 0.9;
                    this.setupComplete = true;
               }
               if(this.archerType == "Voltaic_CA" && !this.setupComplete)
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","CA Voltaic","Voltaic Quiver");
                    maxHealth = 600;
                    health = 600;
                    maxHealth = maxHealth;
                    this.areaDamage = 15;
               ...
               if(this.archerType == "Lava_CA" && !this.setupComplete)
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","CA Lava","Lava Quiver");
                    maxHealth = 600;
                    health = 600;
                    maxHealth = maxHealth;
                    this.areaDamage = 15;
               ...
               {
                    if(this.archerType == "Kytchu" || this.archerType == "Voltaic_CA" || this.archerType == "DarkKytchu" || this.archerType == "Kytchu_2")
                    {
                         stunTimeLeft = 0;
                    }
                    ...
                    else if(this.archerType == "VoltArcher")
                    {
                         this.fireArrowRange = 1800;
                    }
                    else if(this.archerType == "Archis")
                    {
                         this.fireArrowRange = 1800;
                    }
                    ...
                    else if(this.archerType == "WoodlandPrincess")
                    {
                         teleportDistance = -200;
                    }
                    else if(this.archerType == "ChaosArcher")
                    {
                         this.fireArrowRange = 1400;
                    }
                    else if(this.archerType == "RandomArcher")
                    {
               ...
               {
                    if(this.archerType == "Kytchu" || this.archerType == "Archis")
                    {
                         team.gold += 400;
                    }
                    if(this.archerType == "")
                    ...
                    if(this.archerType == "FireArcher_2")
                    {
                         param1.projectileManager.initNuke(px,py,this,15,0.2,400);
                    }
                    if(this.archerType == "VoltArcher" || this.archerType == "Voltaic_CA")
                    {
               ...
               else if(this.archerType == "Archer_1")
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","");
               }
               else if(this.archerType == "Archer_2")
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","");
               }
               ...
               else if(this.archerType == "Ice_CA")
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","CA Ice","Ice Quiver 2");
               }
               else if(this.archerType == "Lava_CA")
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","CA Lava","Lava Quiver");
               }
               else if(this.archerType == "Voltaic_CA")
               ...
               else if(this.archerType == "Prince_2")
               {
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","Prince 2","Gold Quiver");
               }
          ...
          override public function get damageToArmour() : Number
          {
               ...
               if(this.archerType == "Archis")
               {
                    return 135;
               }
               if(this.archerType == "Archer_1")
               {
                    return 1;
               }
               if(this.archerType == "Archer_2")
               {
                    return 60;
               }
               if(this.archerType == "Ice_CA")
               ...
               if(this.archerType == "Lava_CA")
               {
                    return 65;
               }
               if(this.archerType == "Voltaic_CA")
               {
                    return 45;
               }
          ...
          {
               if(this.inBlock || this.archerType == "Archis" || this.archerType == "SavageArcher" || this.archerType == "CrystalArcher" || this.archerType == "SavageArcherPrince" || this.archerType == "Kytchu" || this.archerType == "DarkKytchu" || this.archerType == "Kytchu_2")
               {
