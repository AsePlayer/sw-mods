package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.WaterElementAi;
     ...
     public class WaterElement extends Unit
     {
          ...
          public var waterElementType:String;
          ...
          private var clusterLad:com.brockw.stickwar.engine.units.elementals.AirElement;
          ...
          public function WaterElement(param1:StickWar)
          {
               ...
               this.unitListToHeal = [];
               this.waterElementType = "Default";
          }
          
          public static function setItem(param1:MovieClip, param2:String, param3:String, param4:String) : void
          {
               var _loc5_:_waterElemental = null;
               if((_loc5_ = _waterElemental(param1)).mc.head && _loc5_.mc.head.hat)
               {
                    if(param3 != "")
                    {
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               this.radiantRange = 75;
               this.radiantFrames = 0;
          ...
          {
               if(this._isHealExplosion || this.hasExploded)
               {
                    return false;
               }
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               var _loc8_:StandCommand = null;
               var _loc9_:com.brockw.stickwar.engine.units.elementals.AirElement = null;
               updateCommon(param1);
               ...
               if(this.waterElementType == "" || this.waterElementType == "")
               {
               ...
               if(this.waterElementType == "Test_1" && !this.setupComplete)
               {
                    maxHealth = 1300;
                    health = 1300;
                    maxHealth = maxHealth;
                    ...
                    else if(this._isHealExplosion)
                    {
                         ...
                         if(MovieClip(_mc.mc).currentFrame == 10)
                         {
                              ...
                              if(this.techTeam.tech.isResearched(Tech.WATER_HEAL_UPGRADE))
                              {
                                   ...
                                   _loc2_ = this.healAmountUpgrade;
                                   _loc3_ = this.maxHealAmount;
                              }
                              else
                              {
                                   ...
                                   _loc2_ = this.healAmount;
                                   _loc3_ = this.maxHealAmountUpgrade;
                              }
               ...
               if(_mc.mc && _mc.mc.head && _mc.mc.head.water)
               {
          ...
          override public function mayAttack(param1:Unit) : Boolean
          {
               ...
               if(param1.type == Unit.U_STATUE || param1.type == Unit.U_WALL || param1.type == Unit.U_MAGIKILL)
               {
                    return false;
               }
