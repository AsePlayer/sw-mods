package com.brockw.stickwar.engine.units
{
     ...
     public class Cat extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(isUC)
               {
                    this.normalMaxVelocity = param1.xml.xml.Chaos.Units.cat.slowMaxVelocity * 1.2;
                    this.upgradedMaxVelocity = param1.xml.xml.Chaos.Units.cat.maxVelocity * 1.2;
                    this.packStacks = param1.xml.xml.Chaos.Units.cat.pack.stacks * 2;
                    this.packDamagePerUnit = param1.xml.xml.Chaos.Units.cat.pack.damagePerUnit * 2;
                    _damageToNotArmour = (Number(param1.xml.xml.Chaos.Units.cat.damage) + Number(param1.xml.xml.Chaos.Units.cat.toNotArmour)) * 8;
                    _damageToArmour = (Number(param1.xml.xml.Chaos.Units.cat.damage) + Number(param1.xml.xml.Chaos.Units.cat.toArmour)) * 6;
                    _mass = Number(param1.xml.xml.Chaos.Units.cat.mass) / 2;
               }
               else if(!team.isEnemy)
               {
                    this.packStacks = param1.xml.xml.Chaos.Units.cat.pack.stacks;
                    this.packDamagePerUnit = param1.xml.xml.Chaos.Units.cat.pack.damagePerUnit;
                    _maxVelocity = param1.xml.xml.Chaos.Units.cat.maxVelocity;
                    _damageToNotArmour = Number(param1.xml.xml.Chaos.Units.cat.damage) + Number(param1.xml.xml.Chaos.Units.cat.toNotArmour);
                    _damageToArmour = Number(param1.xml.xml.Chaos.Units.cat.damage) + Number(param1.xml.xml.Chaos.Units.cat.toArmour);
                    _mass = param1.xml.xml.Chaos.Units.cat.mass;
               }
               ...
               if(this.catType == "GiantCat" && !this.setupComplete)
               {
                    Cat.setItem(_mc,"Shard Head","","Default");
                    maxHealth = 3970;
                    health = 3970;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.catType == "GiantCat_2" && !this.setupComplete)
               {
                    Cat.setItem(_mc,"Red Crawler Head","","Default");
                    maxHealth = 6500;
                    health = 6500;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.catType == "Cat_1")
                    {
                         ...
                         this.packDamagePerUnit = 4;
                         this.packStacks = 8;
                    }
                    else if(this.catType == "GiantCat")
                    {
                         this.upgradedMaxVelocity = 4.6;
                         this.normalMaxVelocity = 3.8;
                         this.packDamagePerUnit = 15;
                         this.packStacks = 20;
                    }
                    else if(this.catType == "GiantCat_2")
                    {
                         this.upgradedMaxVelocity = 4.6;
                         this.normalMaxVelocity = 3.8;
                    ...
                    {
                         this.packDamagePerUnit = 200;
                         this.packStacks = 100;
                         this.upgradedMaxVelocity = 25.6;
                         this.normalMaxVelocity = 18.6;
                         stunTimeLeft = 0;
                    }
                    else
                    {
