package com.brockw.stickwar.engine
{
     ...
     public class HealthBar extends Sprite
     {
          ...
          private static const BAR_WIDTH:Number = 35;
          
          private static const BAR_HEIGHT:Number = 11.2;
          
          private static const BOX_SIZE:Number = 80;
          ...
          public function update() : void
          {
               ...
               if(Math.abs(this._health - this._actualHealth) > 1 || this.isFirst)
               {
                    ...
                    this.redBar.graphics.beginFill(20479,1);
                    ...
                    this.redBar.graphics.beginFill(16646275,1);
