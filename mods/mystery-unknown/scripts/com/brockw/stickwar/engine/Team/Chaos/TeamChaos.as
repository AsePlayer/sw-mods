package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class TeamChaos extends Team
     {
          ...
          public function TeamChaos(param1:StickWar, param2:int, param3:Dictionary = null, param4:* = 1, param5:Number = 1)
          {
               ...
               unitInfo[Unit.U_EARTH_ELEMENT] = [param1.xml.xml.Elemental.Units.earthElement.gold * param4,param1.xml.xml.Elemental.Units.earthElement.mana * param4];
               ...
               unitInfo[Unit.U_LAVA_ELEMENT] = [(param1.xml.xml.Elemental.Units.earthElement.gold + param1.xml.xml.Elemental.Units.fireElement.gold) * param4,(param1.xml.xml.Elemental.Units.earthElement.mana + param1.xml.xml.Elemental.Units.fireElement.mana + param1.xml.xml.Elemental.Units.lavaElement.mana) * param4,param1.xml.xml.Elemental.Units.lavaElement.mana * param4,param1.xml.xml.Elemental.Units.lavaElement.population];
               unitInfo[Unit.U_HURRICANE_ELEMENT] = [(param1.xml.xml.Elemental.Units.airElement.gold + param1.xml.xml.Elemental.Units.waterElement.gold) * param4,(param1.xml.xml.Elemental.Units.airElement.mana + param1.xml.xml.Elemental.Units.waterElement.mana + param1.xml.xml.Elemental.Units.hurricaneElement.mana) * param4,param1.xml.xml.Elemental.Units.hurricaneElement.mana * param4,param1.xml.xml.Elemental.Units.hurricaneElement.population];
               unitInfo[Unit.U_TREE_ELEMENT] = [(param1.xml.xml.Elemental.Units.earthElement.gold + param1.xml.xml.Elemental.Units.waterElement.gold) * param4,(param1.xml.xml.Elemental.Units.earthElement.mana + param1.xml.xml.Elemental.Units.waterElement.mana + param1.xml.xml.Elemental.Units.treeElement.mana) * param4,param1.xml.xml.Elemental.Units.treeElement.mana * param4,param1.xml.xml.Elemental.Units.treeElement.population];
               unitInfo[Unit.U_FIRESTORM_ELEMENT] = [(param1.xml.xml.Elemental.Units.airElement.gold + param1.xml.xml.Elemental.Units.fireElement.gold) * param4,(param1.xml.xml.Elemental.Units.airElement.mana + param1.xml.xml.Elemental.Units.fireElement.mana + param1.xml.xml.Elemental.Units.firestormElement.mana) * param4,param1.xml.xml.Elemental.Units.firestormElement.mana * param4,param1.xml.xml.Elemental.Units.firestormElement.population];
               unitInfo[Unit.U_CHROME_ELEMENT] = [(param1.xml.xml.Elemental.Units.earthElement.gold + param1.xml.xml.Elemental.Units.waterElement.gold + param1.xml.xml.Elemental.Units.airElement.gold + param1.xml.xml.Elemental.Units.fireElement.gold) * param4,(param1.xml.xml.Elemental.Units.earthElement.mana + param1.xml.xml.Elemental.Units.waterElement.mana + param1.xml.xml.Elemental.Units.airElement.mana + param1.xml.xml.Elemental.Units.fireElement.mana + param1.xml.xml.Elemental.Units.chrome.mana) * param4,param1.xml.xml.Elemental.Units.chrome.mana * param4,param1.xml.xml.Elemental.Units.chrome.population];
          ...
          {
               this.randomUnit = int(int(Math.floor(Math.random() * 14) + 1));
          ...
          override public function initTeamButtons(param1:GameScreen) : void
          {
               ...
               buttonInfoMap[Unit.U_ARCHER] = [param1.userInterface.hud.hud.deadButton,param1.userInterface.hud.hud.deadOverlay,param1.game.xml.xml.Order.Units.archer,0,new cancelButton(),game.xml.xml.Order.Units.archer.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.archerHighlight,param1.userInterface.hud.hud.archerUnderlay];
               buttonInfoMap[Unit.U_SPEARTON] = [param1.userInterface.hud.hud.bomberButton,param1.userInterface.hud.hud.bomberOverlay,param1.game.xml.xml.Order.Units.spearton,0,new cancelButton(),game.xml.xml.Order.Units.spearton.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
