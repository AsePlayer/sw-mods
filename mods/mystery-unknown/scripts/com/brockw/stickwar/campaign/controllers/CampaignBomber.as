package com.brockw.stickwar.campaign.controllers
{
     ...
     public class CampaignBomber extends CampaignController
     {
          ...
          override public function update(param1:GameScreen) : void
          {
               ...
               {
                    _loc2_ = LavaElement(param1.game.unitFactory.getUnit(Unit.U_LAVA_ELEMENT));
               ...
               if(param1.game.frame % (30 * 40) == 0)
               {
                    ...
                    while(_loc7_ < _loc6_)
                    {
                         ...
                         param1.team.spawn(this.IceSword,param1.game);
               ...
               if(this.twoMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 60) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.Silver = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
                              param1.team.spawn(this.Silver,param1.game);
                              this.Silver.speartonType = "Silver";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.twoMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 100) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.MoltenSpear_2 = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
                              param1.team.spawn(this.MoltenSpear_2,param1.game);
                              this.MoltenSpear_2.speartonType = "MoltenSpear_2";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.twoMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 70) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.MoltenSword = Swordwrath(param1.game.unitFactory.getUnit(Unit.U_SWORDWRATH));
                              param1.team.spawn(this.MoltenSword,param1.game);
                              this.MoltenSword.swordwrathType = "MoltenSword";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.sevenMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 151) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              ...
                              param1.team.spawn(this.SavageSwordPrince,param1.game);
               ...
               if(this.twoMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 70) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.Charrog_2 = LavaElement(param1.game.unitFactory.getUnit(Unit.U_LAVA_ELEMENT));
                              param1.team.enemyTeam.spawn(this.Charrog_2,param1.game);
                              this.Charrog_2.lavaElementType = "Charrog_2";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.sevenMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 50) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              _loc2_ = ChromeElement(param1.game.unitFactory.getUnit(Unit.U_CHROME_ELEMENT));
                              param1.team.enemyTeam.spawn(_loc2_,param1.game);
                              _loc7_++;
                         }
                         ++this.spawnNumber;
