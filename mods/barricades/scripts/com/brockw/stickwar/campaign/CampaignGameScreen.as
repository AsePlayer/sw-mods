package com.brockw.stickwar.campaign
{
     ...
     public class CampaignGameScreen extends GameScreen
     {
          ...
          override public function enter() : void
          {
               ...
               game.initTeams(Team.getIdFromRaceName(_loc1_.player.race),Team.getIdFromRaceName(_loc1_.oponent.race),_loc1_.player.statueHealth,_loc1_.oponent.statueHealth,null,null,1,_loc1_.insaneModifier,1,1,1,1);
               team = game.teamA;
               game.team = team;
               ...
               if(main.campaign.getCurrentLevel().hasInsaneWall && main.campaign.difficultyLevel == Campaign.D_INSANE)
               {
                    ...
                    {
                         (_loc10_ = team.addWall(team.homeX + 2650)).setConstructionAmount(1);
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 1500)).setConstructionAmount(1);
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 2650)).setConstructionAmount(1);
                    }
                    else
                    {
