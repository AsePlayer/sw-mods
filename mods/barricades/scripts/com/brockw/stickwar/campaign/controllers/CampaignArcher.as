package com.brockw.stickwar.campaign.controllers
{
     ...
     public class CampaignArcher extends CampaignController
     {
          ...
          private var StatueMage:Magikill;
          ...
          private var AncientSpear_2:Spearton;
          ...
          private var Super_4:Spearton;
          
          private var Super_5:Spearton;
          
          private var Super_6:Spearton;
          ...
          private var VoltPrince:Spearton;
          ...
          private var playerDefeatTimer:int;
          
          private var playerDefeatConstant:int;
          ...
          override public function update(param1:GameScreen) : void
          {
               ...
               if(this.playerDefeatTimer > 0)
               {
                    if(!param1.isPaused)
                    {
                         ...
                         {
                              --this.playerDefeatTimer;
                         }
                         --this.playerDefeatTimer;
                    }
               }
               else if(this.playerDefeatTimer != -10)
               {
                    this.playerDefeatTimer = -10;
               }
               ...
               if(this.twoMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 160) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.Undead_2 = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
                              param1.team.enemyTeam.spawn(this.Undead_2,param1.game);
