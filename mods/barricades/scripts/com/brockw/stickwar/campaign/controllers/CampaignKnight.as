package com.brockw.stickwar.campaign.controllers
{
     ...
     public class CampaignKnight extends CampaignController
     {
          ...
          private var TinySword:Swordwrath;
          
          private var TinyArcher:Archer;
          
          private var TinyMage:Magikill;
          
          private var TinySpear:Spearton;
          ...
          private var IcePrince:Spearton;
          
          private var LeafPrince_2:Spearton;
          ...
          private var SpeartonSummoner:Magikill;
          ...
          override public function update(param1:GameScreen) : void
          {
               ...
               {
                    this.Super_3 = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
                    param1.team.spawn(this.Super_3,param1.game);
                    this.Super_3.speartonType = "Super_3";
               ...
               {
                    this.SpeartonSummoner = Magikill(param1.game.unitFactory.getUnit(Unit.U_MAGIKILL));
                    param1.team.spawn(this.SpeartonSummoner,param1.game);
                    this.SpeartonSummoner.magikillType = "SpeartonSummoner";
               ...
               if(!this.nah)
               {
                    ...
                    param1.team.spawn(this.LeafSwordPrince,param1.game);
               ...
               if(this.oneMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 85) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.TinyMage = Magikill(param1.game.unitFactory.getUnit(Unit.U_MAGIKILL));
                              param1.team.enemyTeam.spawn(this.TinyMage,param1.game);
                              this.TinyMage.magikillType = "TinyMage";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.oneMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 65) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.TinySpear = Spearton(param1.game.unitFactory.getUnit(Unit.U_SPEARTON));
                              param1.team.enemyTeam.spawn(this.TinySpear,param1.game);
                              this.TinySpear.speartonType = "TinySpear";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.oneMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 29) == 0)
                    {
                         _loc6_ = Math.min(this.spawnNumber / 1,1);
                         _loc7_ = 0;
                         while(_loc7_ < _loc6_)
                         {
                              this.TinySword = Swordwrath(param1.game.unitFactory.getUnit(Unit.U_SWORDWRATH));
                              param1.team.enemyTeam.spawn(this.TinySword,param1.game);
                              this.TinySword.swordwrathType = "TinySword";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(this.oneMinTimer < 0)
               {
                    if(param1.game.frame % (30 * 70) == 0)
                    {
                         ...
                         while(_loc7_ < _loc6_)
                         {
                              this.TinyArcher = Archer(param1.game.unitFactory.getUnit(Unit.U_ARCHER));
                              param1.team.enemyTeam.spawn(this.TinyArcher,param1.game);
                              this.TinyArcher.archerType = "TinyArcher";
                              _loc7_++;
                         }
                         ++this.spawnNumber;
                    }
               ...
               if(param1.team.enemyTeam.statue.health <= 1000 && param1.team.enemyTeam.statue.maxHealth != 29000)
               {
                    param1.team.enemyTeam.statue.health += 28000;
                    param1.team.enemyTeam.statue.maxHealth = 29000;
                    param1.team.enemyTeam.statue.healthBar.totalHealth = param1.team.enemyTeam.statue.maxHealth;
                    param1.team.enemyTeam.gold += 9000;
                    param1.team.enemyTeam.mana += 9000;
