package com.brockw.stickwar.engine.maps
{
     ...
     public class Halloween extends Map
     {
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               this.addHill(this.width / 3.9,this.height / 4.4,param1);
               this.addTower(this.width / 3.4,this.height / 1.15,param1);
               this.addSecondTower(this.width / 2.7,this.height / 2,param1);
               super.init(param1);
          }
          ...
          private function addSecondTower(param1:Number, param2:Number, param3:*) : void
          {
               var _loc4_:Hill = null;
               (_loc4_ = new Hill(param3)).init(param1,param2,param3);
               hills.push(_loc4_);
