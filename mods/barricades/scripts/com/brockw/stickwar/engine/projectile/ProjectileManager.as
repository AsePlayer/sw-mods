package com.brockw.stickwar.engine.projectile
{
     ...
     public class ProjectileManager
     {
          ...
          public function initLightning(param1:Unit, param2:Unit, param3:Number) : void
          {
               ...
               if(param1.MeIsAFuckingAirElemental == true)
               {
               ...
               param1.team.game.soundManager.playSoundRandom("lightningSound",3,param2.px,param2.py);
          }
          ...
          public function initPoisonSpray(param1:Number, param2:Number, param3:Unit, param4:Number) : void
          {
               ...
               _loc5_.py = param3.py;
               _loc5_.inflictor = param3;
               if(_loc5_.inflictor.type == Unit.U_MAGIKILL)
               {
                    _loc5_.whoPoisoned = _loc5_.inflictor.magikillType;
               }
          ...
          public function initArrow(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Unit, param8:Number, param9:Number, param10:Boolean, param11:Number, param12:Number, param13:Unit, param14:Number, param15:int) : void
          {
               ...
               else if(param7.archerType == "FireArcher")
               {
                    _loc16_.burnDamage = 0.2;
                    _loc16_.burnFrames = 150;
               }
               else if(param7.archerType == "Lava_CA")
               {
                    _loc16_.burnDamage = 0.7;
                    _loc16_.burnFrames = 150;
               }
               else
               {
               ...
               if(param7.archerType == "CrystalArcher")
               {
                    _loc16_.poisonDamage = 10;
               }
               else
               {
                    _loc16_.poisonDamage = 0;
               }
               if(param7.archerType == "")
               {
                    if(param10)
                    {
                         this.initThorn(param13.px,param13.py,param7,param13,param7.team,7,140);
                         this.initFlower(param13.px,param13.py,param7.team);
                         param7.team.game.soundManager.playSound("thornSound",param13.px,param13.py);
                    }
               }
               if(param7.archerType == "Archis")
               {
                    if(param10)
                    {
                         this.initThorn(param13.px,param13.py,param7,param13,param7.team,200,250);
                         this.initFlower(param13.px,param13.py,param7.team);
                         param7.team.game.soundManager.playSound("thornSound",param13.px,param13.py);
                    }
               }
               if(param7.archerType == "ChaosArcher")
               {
                    if(param10)
                    {
                         this.initReaper(param7,param13);
                    }
               }
               if(param7.archerType == "VoltArcher")
               {
                    this.initLightning(param7,param13,param14);
                    this.initLightning(param7,param13,param14);
                    param7.team.game.soundManager.playSoundRandom("lightningSound",3,param13.px,param13.py);
               }
               if(param7.archerType == "Voltaic_CA")
               {
                    if(param10)
                    {
                         this.initStun(param13.px,param13.py,param15,param7);
                    }
                    this.initLightning(param7,param13,param14);
                    this.initLightning(param7,param13,param14);
                    this.initLightning(param7,param13,param14);
               ...
               if(param7.archerType == "SavageArcher")
               {
                    _loc16_.stunTime = 30;
               }
               else
               ...
               if(param7.archerType == "Frost_1" || param7.archerType == "Ice_CA")
               {
                    _loc16_.slowFrames = 30 * 1;
               }
               else
               {
          ...
          public function initBoulder(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Unit, param8:Number, param9:Boolean, param10:Unit = null) : void
          {
               ...
               _loc11_.y = -100;
               _loc11_.scale = 1;
               if(param7.enslavedgiantType == "E_LavaGiant")
               {
                    _loc11_.burnDamage = 0.2;
                    _loc11_.burnFrames = 150;
               }
               else
               {
                    _loc11_.burnDamage = 0;
                    _loc11_.burnFrames = 0;
               }
               if(param7.enslavedgiantType == "E_IceGiant")
               {
                    _loc11_.slowFrames = 30 * 1.5;
               }
               else
               {
                    _loc11_.slowFrames = 0;
               }
               _loc11_.stunTime = 0;
          ...
          public function initGuts(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Unit, param9:Unit = null) : void
          {
               ...
               _loc10_.slowFrames = 0;
               _loc10_.burnDamage = 0;
               _loc10_.burnFrames = 0;
               ...
               if(param8.deadType == "VoltDead")
               {
                    this.initLightning(param8,param9,param7);
                    param8.team.game.soundManager.playSoundRandom("lightningSound",3,param9.px,param9.py);
               }
               _loc10_.x = -100;
               _loc10_.y = -100;
          ...
          public function initNuke(param1:Number, param2:Number, param3:Unit, param4:Number, param5:Number, param6:int) : void
          {
               ...
               if(_loc7_.inflictor.type == Unit.U_MAGIKILL)
               {
                    _loc7_.whoNuked = _loc7_.inflictor.magikillType;
               }
               _loc7_.px = param1;
               _loc7_.py = param2;
               _loc7_.team = param3.team;
