package com.brockw.stickwar.engine.projectile
{
     ...
     public class PoisonSpray extends Projectile
     {
          ...
          internal var whoPoisoned:String;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               var _loc8_:Array = this.team.units;
               ...
               while(_loc7_ < _loc3_)
               {
                    if(Unit(_loc2_[_loc7_]).team != this.team && _loc2_[_loc7_] is Unit)
                    {
                         ...
                         {
                              if(this.whoPoisoned == "FireMage")
                              {
                                   Unit(_loc2_[_loc7_]).setFire(300,0.4);
                              }
                              if(this.whoPoisoned == "CrystalMage")
                              {
                                   Unit(_loc2_[_loc7_]).freezeCount = 30 * 16;
                              }
                              if(this.whoPoisoned == "SavageMage")
                              {
                                   Unit(_loc2_[_loc7_]).stun(180);
                              }
                              if(this.whoPoisoned == "IceMage")
                              {
                                   Unit(_loc2_[_loc7_]).slow(30 * 10);
                              }
