package com.brockw.stickwar.engine
{
     public class IncomeDisplay
     {
          ...
          public function addDisplay(param1:StickWar, param2:String, param3:int, param4:int, param5:int) : void
          {
               ...
               _loc6_.mc.text.textColor = param3;
          ...
          public function update(param1:StickWar) : void
          {
               ...
               {
                    DisplayClip(_loc2_[1]).y = Number(DisplayClip(_loc2_[1]).y) - 0.5;
                    _loc2_[0] = _loc2_[0] - 1;
                    DisplayClip(_loc2_[1]).alpha = Number(DisplayClip(_loc2_[1]).alpha) - 0.005;
               }
