package com.brockw.stickwar.engine.units
{
     ...
     public class MinerChaos extends Miner
     {
          ...
          public var chaosminerType:String;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.chaosminerType == "ChaosMiner_1" && !this.setupComplete)
               {
                    setItem(_mc,"Lava Pickaxe","Default","Lava Miner Bag");
                    maxHealth = 300;
                    health = 300;
                    maxHealth = maxHealth;
               ...
               if(this.chaosminerType == "ChaosLavish" && !this.setupComplete)
               {
                    setItem(_mc,"Chaos Lavish Pickaxe","Default","Chaos Lavish Bag");
                    maxHealth = 600;
                    health = 600;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.chaosminerType == "ChaosMiner_1")
               {
                    setItem(_mc,"Lava Pickaxe","Default","Lava Miner Bag");
               }
               else if(this.chaosminerType == "ChaosLavish")
               {
                    setItem(_mc,"Chaos Lavish Pickaxe","Default","Chaos Lavish Bag");
               }
               else
               {
                    setItem(_mc,"Skull Pickaxe","Default","Bone Bag");
               }
          }
