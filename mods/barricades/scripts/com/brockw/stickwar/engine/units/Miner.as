package com.brockw.stickwar.engine.units
{
     ...
     public class Miner extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               fireRegen = true;
               if(this.minerType == "Lavish" && !this.setupComplete)
               {
                    Miner.setItem(_mc,"Lavish Axe","Default","Lavish Bag");
                    maxHealth = 600;
                    health = 600;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.minerType == "IceMiner" && !this.setupComplete)
               {
                    freezeUnit = true;
                    slowRegen = true;
                    weakToFire = true;
                    Miner.setItem(_mc,"Ice Pickaxe","Default","Ice Bag");
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    this.setupComplete = true;
               }
               if(this.minerType == "VoltMiner" && !this.setupComplete)
               {
                    isVoltaic = true;
                    Miner.setItem(_mc,"Volt Pickaxe","Default","Volt Bag");
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    this.setupComplete = true;
               }
               if(this.minerType == "Miner_1" && !this.setupComplete)
               {
                    Miner.setItem(_mc,"Hammer","Default","Stone Bag");
                    maxHealth = 300;
                    health = 300;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.minerType == "Miner_2" && !this.setupComplete)
               {
                    Miner.setItem(_mc,"Brown Pickaxe","Default","Wagon");
                    maxHealth = 200;
                    health = 200;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.minerType == "LeafMiner" && !this.setupComplete)
               {
                    Miner.setItem(_mc,"Leaf Pickaxe","Default","Leaf Bag");
                    maxHealth = 80;
                    health = 80;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               {
                    if(this.minerType == "Lavish")
                    {
                         _mass = 50;
                         this.bagSize = 500;
                         _maxVelocity = 3.5;
                         this.upgradedMaxVelocity = 5;
                         this.upgradedMaxHealth = 1000;
                    }
                    else if(this.minerType == "Miner_1")
                    {
                         _mass = 50;
                         this.bagSize = 200;
                         _maxVelocity = 2.8;
                         this.upgradedMaxVelocity = 3.5;
                         this.upgradedMaxHealth = 400;
                    }
                    else if(this.minerType == "Miner_2")
                    {
                         _mass = 50;
                         this.bagSize = 300;
                         _maxVelocity = 3.3;
                         this.upgradedMaxVelocity = 4;
                         this.upgradedMaxHealth = 600;
                    }
                    else
                    {
                         this.bagSize = param1.xml.xml.Order.Units.miner.bagSize;
               ...
               if(team.isEnemy)
               {
                    Miner.setItem(_mc,"Lava Pickaxe","Default","Lava Bag");
               }
               else if(this.minerType == "Lavish")
               {
                    Miner.setItem(_mc,"Lavish Axe","Default","Lavish Bag");
               }
               else if(this.minerType == "Miner_1")
               ...
               else if(this.minerType == "VoltMiner")
               {
                    Miner.setItem(_mc,"Volt Pickaxe","Default","Volt Bag");
               }
               else if(this.minerType == "LeafMiner")
               {
                    Miner.setItem(_mc,"Leaf Pickaxe","Default","Leaf Bag");
               }
               else if(this.minerType == "IceMiner")
               {
                    Miner.setItem(_mc,"Ice Pickaxe","Default","Ice Bag");
               }
               else
