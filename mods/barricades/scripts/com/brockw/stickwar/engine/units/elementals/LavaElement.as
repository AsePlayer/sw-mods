package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.LavaElementAi;
     ...
     public class LavaElement extends Unit
     {
          ...
          public var lavaElementType:String;
          ...
          {
               if(this.burrowSpell.spellActivate(team) && this.isBurrowed == false)
               {
                    this.hasBurrowed = false;
          ...
          {
               if(this.isBurrowed && this.hasBurrowed)
               {
                    return false;
               }
          ...
          {
               if(this.isBurrowed == false && this.needsToUnBurrow)
               {
                    return false;
               }
               if(this.burrowSpell.inEffect() && !this.hasBurrowed)
               {
                    return false;
               }
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(isUC)
               {
                    this.maxVelocityNormal = param1.xml.xml.Elemental.Units.lavaElement.maxVelocity * 1.2;
                    _damageToNotArmour = (Number(param1.xml.xml.Elemental.Units.lavaElement.damage) + Number(param1.xml.xml.Elemental.Units.lavaElement.toNotArmour)) * 2.5;
                    _damageToArmour = (Number(param1.xml.xml.Elemental.Units.lavaElement.damage) + Number(param1.xml.xml.Elemental.Units.lavaElement.toArmour)) * 2.9;
                    _mass = Number(param1.xml.xml.Elemental.Units.lavaElement.mass) / 2;
               }
               else if(!team.isEnemy)
               {
                    this.maxVelocityNormal = param1.xml.xml.Elemental.Units.lavaElement.maxVelocity;
                    _damageToNotArmour = Number(param1.xml.xml.Elemental.Units.lavaElement.damage) + Number(param1.xml.xml.Elemental.Units.lavaElement.toNotArmour);
                    _damageToArmour = Number(param1.xml.xml.Elemental.Units.lavaElement.damage) + Number(param1.xml.xml.Elemental.Units.lavaElement.toArmour);
                    _mass = param1.xml.xml.Elemental.Units.lavaElement.mass;
               }
               ...
               if(this.radiantSpell.inEffect())
               {
                    ...
                    this.shieldwallDamageReduction = 0.64;
               ...
               else
               {
                    ...
                    this.shieldwallDamageReduction = 0.18;
                    this.mc.filters = [];
               }
               if(this.lavaElementType == "Charrog_1" && !this.setupComplete)
               {
                    maxHealth = 18600;
                    health = 18600;
                    maxHealth = maxHealth;
               ...
               if(this.lavaElementType == "Charrog_2" && !this.setupComplete)
               {
               ...
               if(!isDieing)
               {
                    ...
                    else if(this.needsToUnBurrow && !this.isBurrowed)
                    {
                    ...
                    else if(_state == S_RUN)
                    {
                         ...
                         {
                              _mc.gotoAndStop("run");
                              if(this.radiantSpell.inEffect() && (_mc.mc.currentFrame == 5 || _mc.mc.currentFrame == 15))
                              {
          ...
          {
               if(this.lavaElementType == "Charrog_1")
               {
                    return 225;
               }
          ...
          {
               if(this.inBlock || this.lavaElementType == "Default")
               {
