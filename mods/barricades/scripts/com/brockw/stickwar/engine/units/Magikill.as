package com.brockw.stickwar.engine.units
{
     ...
     public class Magikill extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          private var Mega_2:com.brockw.stickwar.engine.units.Spearton;
          
          private var explosionDamage:Number;
          
          private var poisonSprayRange:Number;
          
          private var pushBack:Number;
          
          private var damageAmount:int;
          
          private var stunAmount:int;
          
          private var fireWaterDamage:Number;
          
          private var fireWaterBurnDamage:Number;
          
          private var fireWaterBurnFrames:int;
          
          private var fireWaterStunFrames:int;
          
          private var fireWaterStunForce:Number;
          ...
          private function burnInArea(param1:com.brockw.stickwar.engine.units.Unit) : *
          {
               if(param1.team != this.team)
               {
                    ...
                    else if(this.magikillType == "CrystalMage")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
                              if(param1.type != com.brockw.stickwar.engine.units.Unit.U_STATUE)
                              {
                                   if(this.isNuking == true)
                                   {
                                        param1.freezeCount = 30 * 4;
                                   }
                                   else if(this.isStunning == true)
                                   {
                                        param1.freezeCount = 30 * 6;
                                   }
                                   else if(this.isPoisonDarting == true)
                                   {
                                        param1.freezeCount = 30 * 9;
                                   }
                              }
                         }
                    }
                    else if(this.magikillType == "Magis")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
                              if(this.isNuking == true)
                    ...
                    else if(this.magikillType == "VoltMage")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
                              if(this.isNuking == true)
                    ...
                    else if(this.magikillType == "LeafMage")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
                              if(this.isNuking == true)
                              {
                                   if(_mc.mc.currentFrame == 12)
                                   {
                                        this.team.game.projectileManager.initThorn(param1.px,param1.py,this,param1,this.team,35,50);
                                        this.team.game.soundManager.playSound("thornSound",param1.px,param1.py);
                                   }
                              }
                              else if(this.isStunning == true)
                              {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.magikillType == "IceMage" || this.magikillType == "LeafMage" || this.magikillType == "VoltMage" || this.magikillType == "Magis" || this.magikillType == "CrystalMage" || this.magikillType == "" || this.magikillType == "SavageMage")
               {
               ...
               if(isUC)
               {
                    this.explosionDamage = param1.xml.xml.Order.Units.magikill.nuke.damage * 5;
                    this.fireDamage = param1.xml.xml.Order.Units.magikill.nuke.fireDamage * 2;
                    this.fireFrames = param1.xml.xml.Order.Units.magikill.nuke.fireFrames * 2;
                    _maxVelocity = param1.xml.xml.Order.Units.magikill.maxVelocity * 1.2;
                    _damageToNotArmour = (Number(param1.xml.xml.Order.Units.magikill.damage) + Number(param1.xml.xml.Order.Units.magikill.toNotArmour)) * 10;
                    _damageToArmour = (Number(param1.xml.xml.Order.Units.magikill.damage) + Number(param1.xml.xml.Order.Units.magikill.toArmour)) * 10;
                    _mass = Number(param1.xml.xml.Order.Units.magikill.mass) / 2;
               }
               ...
               else if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    health = Number(param1.xml.xml.Order.Units.magikill.health) * 1;
                    maxHealth = health;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    enemyBuffed = true;
               }
               if(this.magikillType == "TeleportMage" && !this.setupComplete)
               {
                    noStone = true;
               ...
               if(this.magikillType == "TeleportMage_2" && !this.setupComplete)
               {
                    noStone = true;
                    Magikill.setItem(_mc,"","","");
                    maxHealth = 900;
               ...
               if(this.magikillType == "StatueMage" && !this.setupComplete)
               {
                    noStone = true;
                    flyingHeight = 468;
               ...
               if(this.magikillType == "SpeartonSummoner" && !this.setupComplete)
               {
                    noStone = true;
                    Magikill.setItem(_mc,"","","");
                    maxHealth = 900;
                    ...
                    healthBar.totalHealth = maxHealth;
                    _scale = 1.2;
                    this.stunSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.electricWall.effect,630,param1.xml.xml.Order.Units.magikill.electricWall.mana);
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,710,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.poisonDartSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.poisonSpray.effect,500,param1.xml.xml.Order.Units.magikill.poisonSpray.mana);
                    this.setupComplete = true;
               }
               ...
               if(this.magikillType == "Magis" && !this.setupComplete)
               {
                    noStone = true;
                    MagisShock = true;
                    MagisIsVoltaic = true;
                    generalRegen = true;
                    generalRegen2 = true;
                    MagisRefuseToDie = true;
                    Magikill.setItem(_mc,"Magis Staff","Magis Hat","Magis Beard");
                    maxHealth = 1250;
                    health = 1250;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    _scale = 1.1;
                    this.stunSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.electricWall.effect,920,param1.xml.xml.Order.Units.magikill.electricWall.mana);
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,838,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.poisonDartSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.poisonSpray.effect,745,param1.xml.xml.Order.Units.magikill.poisonSpray.mana);
                    this.shieldwallDamageReduction = 0.75;
                    this.radiantRange = 600;
                    this.setupComplete = true;
               }
               if(this.magikillType == "VoltMage" && !this.setupComplete)
               {
                    noStone = true;
                    isVoltaic = true;
                    maxHealthIncrease = true;
                    Magikill.setItem(_mc,"Voltaic Staff","Voltaic Hat","");
                    maxHealth = 500;
                    health = 500;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.magikillType == "Zarek_2" && !this.setupComplete)
               {
                    ...
                    healthBar.totalHealth = maxHealth;
                    _scale = 1.5;
                    this.stunSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.electricWall.effect,1100,param1.xml.xml.Order.Units.magikill.electricWall.mana);
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,978,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.poisonDartSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.poisonSpray.effect,1245,param1.xml.xml.Order.Units.magikill.poisonSpray.mana);
                    this.setupComplete = true;
               }
               if(this.magikillType == "SW1Mage" && !this.setupComplete)
               {
                    ...
                    _scale = 1.1;
                    _maxVelocity = 4;
                    this.castSpellGlow.color = 16777215;
                    this.castSpellGlow.blurX = 5;
                    this.castSpellGlow.blurY = 5;
                    this.mc.filters = [this.castSpellGlow];
                    this.stunSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.electricWall.effect,230,param1.xml.xml.Order.Units.magikill.electricWall.mana);
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,210,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.poisonDartSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.poisonSpray.effect,300,param1.xml.xml.Order.Units.magikill.poisonSpray.mana);
                    this.setupComplete = true;
               }
               ...
               if(this.magikillType == "TinyMage" && !this.setupComplete)
               {
                    noStone = true;
                    this.healthBar.visible = false;
                    Magikill.setItem(_mc,"","","");
               ...
               if(this.magikillType == "CrystalMage" && !this.setupComplete)
               {
                    ...
                    this.mc.filters = [this.castSpellGlow];
                    this.stunSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.electricWall.effect,630,param1.xml.xml.Order.Units.magikill.electricWall.mana);
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,495,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.poisonDartSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.poisonSpray.effect,700,param1.xml.xml.Order.Units.magikill.poisonSpray.mana);
                    this.shieldwallDamageReduction = 0.85;
                    this.setupComplete = true;
               }
               if(this.magikillType == "Magikill_1" && !this.setupComplete)
               {
                    Magikill.setItem(_mc,"","","");
                    LightVampRegen = true;
                    unitRegen = true;
                    ...
                    this.castSpellGlow.blurY = 5;
                    this.mc.filters = [this.castSpellGlow];
                    this.nukeSpellCooldown = new com.brockw.stickwar.engine.units.SpellCooldown(param1.xml.xml.Order.Units.magikill.nuke.effect,915,param1.xml.xml.Order.Units.magikill.nuke.mana);
                    this.setupComplete = true;
               }
               if(this.magikillType != "")
               {
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.magikillType == "TinyMage")
                    {
                         _maxVelocity = 6.5;
                         this.explosionDamage = 100;
                         this.fireDamage = 4;
                    ...
                    else if(this.magikillType == "Magikill_1")
                    {
               ...
               if(!isDieing)
               {
                    ...
                    else if(this.isNuking == true)
                    {
                         ...
                         {
                              if(this.magikillType == "Default" || this.magikillType == "TinyMage" || this.magikillType == "SW1Mage" || this.magikillType == "SW3Mage" || this.magikillType == "Magikill_1")
                              {
                              ...
                              else if(this.magikillType == "TeleportMage" || this.magikillType == "TeleportMage_2")
                              {
                                   param1.soundManager.playSoundRandom("mediumExplosion",3,this.spellX,this.spellY);
                                   param1.projectileManager.initNuke(this.spellX,this.spellY,this,this.explosionDamage,this.fireDamage,this.fireFrames);
                                   hasHit = true;
                              }
                              else if(this.magikillType == "StatueMage")
                              {
                                   param1.soundManager.playSoundRandom("mediumExplosion",3,this.spellX,this.spellY);
                                   param1.projectileManager.initNuke(this.spellX,this.spellY,this,this.explosionDamage,this.fireDamage,this.fireFrames);
                                   hasHit = true;
                              ...
                              else if(this.magikillType == "SpeartonSummoner")
                              {
                                   param1.soundManager.playSoundRandom("mediumExplosion",3,this.spellX,this.spellY);
                                   param1.projectileManager.initNuke(this.spellX,this.spellY,this,this.explosionDamage,this.fireDamage,this.fireFrames);
                                   param1.projectileManager.initTowerSpawn(this.spellX,this.spellY,param1.team,0.6);
                                   this.Mega_2 = Spearton(team.game.unitFactory.getUnit(com.brockw.stickwar.engine.units.Unit.U_SPEARTON));
                                   team.spawn(this.Mega_2,team.game);
                                   this.Mega_2.px = this.spellX;
                                   this.Mega_2.py = this.spellY;
                                   this.Mega_2.speartonType = "Mega_2";
                                   this.Mega_2.stun(100);
                                   this.Mega_2.ai.setCommand(team.game,new StandCommand(team.game));
                                   hasHit = true;
                              }
                              else if(this.magikillType == "Zarek")
                              {
                                   param1.soundManager.playSoundRandom("mediumExplosion",3,this.spellX,this.spellY);
                                   param1.projectileManager.initFireWaterExplosion(this.spellX,this.spellY,this,100,1.15,75,90,1);
                                   param1.projectileManager.initNuke(this.spellX,this.spellY,this,this.explosionDamage,this.fireDamage,this.fireFrames);
                                   hasHit = true;
                              }
                              else if(this.magikillType == "Zarek_2")
                              {
                                   ...
                                   param1.projectileManager.initFirestorm(this.spellX,this.spellY,0,team,getDirection(),140,2,300,12);
                                   param1.projectileManager.initFireWaterExplosion(this.spellX,this.spellY,this,200,3.15,115,200,1);
                                   this.initFireBreathLine(this.breathNumber++);
                                   this.initFireBreathLine(this.breathNumber++);
                                   this.initFireBreathLine(this.breathNumber++);
                                   this.initFireBreathLine(this.breathNumber++);
                    ...
                    else if(this.isStunning == true)
                    {
                         ...
                         {
                              if(this.magikillType == "Default" || this.magikillType == "TinyMage")
                              {
                                   param1.soundManager.playSound("electricWall",this.spellX,this.spellY);
                                   param1.projectileManager.initStun(this.spellX,this.spellY,param1.xml.xml.Order.Units.magikill.electricWallDamage,this);
                                   hasHit = true;
                              ...
                              else if(this.magikillType == "TeleportMage")
                              {
                                   param1.soundManager.playSound("electricWall",this.spellX,this.spellY);
                                   param1.projectileManager.initStun(this.spellX,this.spellY,param1.xml.xml.Order.Units.magikill.electricWallDamage,this);
                                   this.px -= 700;
                              ...
                              else if(this.magikillType == "TeleportMage_2")
                              {
                                   param1.soundManager.playSound("electricWall",this.spellX,this.spellY);
                                   param1.projectileManager.initStun(this.spellX,this.spellY,param1.xml.xml.Order.Units.magikill.electricWallDamage,this);
                                   this.px += 700;
                              ...
                              else if(this.magikillType == "SW3Mage")
                              {
                                   ...
                                   this.clusterLad.px = this.spellX;
                                   this.clusterLad.py = this.spellY;
                                   this.clusterLad.swordwrathType = "Minion_2";
                                   this.clusterLad.stun(0);
                                   this.clusterLad.ai.setCommand(team.game,new StandCommand(team.game));
                                   hasHit = true;
                              }
               ...
               else if(isDead == false)
               {
                    ...
                    if(this.magikillType == "Magis")
                    {
                         param1.projectileManager.initStun(this.px,py,35,this);
                    }
                    if(this.magikillType == "VoltMage")
                    {
                         param1.projectileManager.initStun(this.px,py,35,this);
                    }
                    isDead = true;
          ...
          override public function setActionInterface(param1:ActionInterface) : void
          {
               ...
               if(this.magikillType != "Magikill_1")
               {
          ...
          {
               if(this.inBlock || this.magikillType == "SW1Mage" || this.magikillType == "CrystalMage" || this.magikillType == "Zarek" || this.magikillType == "Magis")
               {
