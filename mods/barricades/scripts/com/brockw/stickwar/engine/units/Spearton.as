     ...
     public class Spearton extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.speartonType == "Atreyos" && !this.setupComplete)
               {
                    ...
                    this.enableDamageNum = false;
                    this.enableHitNum = false;
                    this.setupComplete = true;
               }
               ...
               if(this.speartonType == "AncientSpear_2" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    unitRegen = true;
               ...
               if(this.speartonType == "Super_4" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    this.isABoss = true;
               ...
               if(this.speartonType == "Super_5" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    this.isABoss = true;
               ...
               if(this.speartonType == "Super_6" && !this.setupComplete)
               {
                    noStone = true;
                    nonTeleportable = true;
                    this.isABoss = true;
               ...
               if(this.speartonType == "VoltPrince" && !this.setupComplete)
               {
                    isVoltaic = true;
                    this.isABoss = true;
               ...
               if(this.speartonType == "IcePrince" && !this.setupComplete)
               {
                    noStone = true;
                    this.isABoss = true;
                    this.isNotPossessable = true;
               ...
               if(this.speartonType == "LeafPrince_2" && !this.setupComplete)
               {
                    reapImmune = true;
                    this.isABoss = true;
                    this.isNotPossessable = true;
               ...
               if(this.speartonType == "Zane" && !this.setupComplete)
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"","Skate Helmet","Skate Shield");
                    maxHealth = 860;
                    health = 860;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.speartonType == "TinySpear" && !this.setupComplete)
               {
                    this.healthBar.visible = false;
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"","","");
                    maxHealth = 1000;
               ...
               if(this.speartonType == "AncientSpear" || this.speartonType == "AncientSpear_2" || this.speartonType == "Silver" || this.speartonType == "GoldenSpear" || this.speartonType == "GoldenSpear_2" || this.speartonType == "GoldenSpear_3" || this.speartonType == "GoldenSpear_4" || this.speartonType == "Super" || this.speartonType == "Super_2" || this.speartonType == "Super_3" || this.speartonType == "Super_4" || this.speartonType == "Super_5" || this.speartonType == "Super_6" || this.speartonType == "Ultra" || this.speartonType == "Ultra_2" || this.speartonType == "s07" || this.speartonType == "s08" || this.speartonType == "s09" || this.speartonType == "Barin" || this.speartonType == "Spearos" || this.speartonType == "Spearos_2" || this.speartonType == "Boss_1" || this.speartonType == "" || this.speartonType == "MillionHP" || this.speartonType == "Atreyos" || this.speartonType == "Atreyos_2" || this.speartonType == "BuffSpear" || this.speartonType == "BuffSpear_2" || this.speartonType == "DarkSpear")
               {
               ...
               else if(this.speartonType == "Ultra" || this.speartonType == "Ultra_2" || this.speartonType == "Super" || this.speartonType == "Super_2" || this.speartonType == "Super_3" || this.speartonType == "Super_4" || this.speartonType == "Super_5" || this.speartonType == "Super_6")
               {
                    _maxVelocity = 4.8;
               }
               ...
               else if(this.speartonType == "SavagePrince" || this.speartonType == "VoltPrince" || this.speartonType == "LeafPrince" || this.speartonType == "IcePrince" || this.speartonType == "LeafPrince_2" || this.speartonType == "LavaPrince")
               {
                    stunTimeLeft = 0;
                    _maxVelocity = 4;
               }
               ...
               else if(isDead == false)
               {
                    ...
                    {
                         param1.projectileManager.initNuke(px,py,this,50,0.5,200);
                    }
               ...
               else if(this.speartonType == "Zane")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"","Skate Helmet","Skate Shield");
               }
               ...
               else if(this.speartonType == "AncientSpear_2")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Ancient Gold Spear","Ancient Gold Helmet","Ancient Gold Shield");
               }
               ...
               else if(this.speartonType == "IcePrince")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Ice Spear 2","Ice Helmet","Ice Shield");
               }
               ...
               else if(this.speartonType == "LeafPrince_2")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Leaf Spear","Leaf Helmet","Leaf Shield");
               }
               else if(this.speartonType == "VoltPrince")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Voltaic Spear","Voltaic Helmet","Voltaic Shield");
               }
               ...
               else if(this.speartonType == "Super_4")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Trident","HedgeHog Helmet","Scorpion Shield");
               }
               else if(this.speartonType == "Super_5")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Trident","HedgeHog Helmet","Scorpion Shield");
               }
               else if(this.speartonType == "Super_6")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Trident","HedgeHog Helmet","Scorpion Shield");
               }
               else if(this.speartonType == "Mega_2")
               ...
               else if(this.speartonType == "TinySpear")
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"","","");
               }
          ...
          override public function get damageToArmour() : Number
          {
               ...
               if(this.speartonType == "AncientSpear_2")
               {
                    return 630;
               }
               ...
               if(this.speartonType == "TinySpear")
               {
                    return 100;
               }
               ...
               if(this.speartonType == "VoltPrince")
               {
                    return 220;
               }
               ...
               if(this.speartonType == "LeafPrince_2")
               {
                    return 220;
               }
               ...
               if(this.speartonType == "IcePrince")
               {
                    return 220;
               }
               if(this.speartonType == "Spearos")
               ...
               if(this.speartonType == "Super_4")
               {
                    return 210;
               }
               if(this.speartonType == "Super_5")
               {
                    return 210;
               }
               if(this.speartonType == "Super_6")
               {
                    return 210;
               }
          ...
          {
               if(this.inBlock || this.speartonType == "s07" || this.speartonType == "BuffSpear" || this.speartonType == "Zane" || this.speartonType == "s07_Crippled" || this.speartonType == "SWLAtreyos" || this.speartonType == "SW3Atreyos" || this.speartonType == "CrystalSpear" || this.speartonType == "Barin" || this.speartonType == "s07" || this.speartonType == "Spearos_2" || this.speartonType == "Spearos" || this.speartonType == "Atreyos" || this.speartonType == "Atreyos_2")
               {
