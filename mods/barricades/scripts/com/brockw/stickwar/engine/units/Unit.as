package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          public var isRGB:Boolean = false;
          
          public var down:Boolean = false;
          
          public var up:Boolean = false;
          
          public var enableDamageNum:Boolean = false;
          
          public var enableHitNum:Boolean = false;
          
          public var enableHealNum:Boolean = false;
          
          public var MeIsAFuckingAirElemental:Boolean = false;
          ...
          private var protectedFrames:int;
          ...
          public var noStone:Boolean;
          
          public var randomNumber:int;
          
          public var poisonUnit:Boolean;
          
          public var isVampUnit:Boolean;
          
          public var isReflective:Boolean = false;
          
          public var freezeUnit:Boolean;
          
          public var burnUnit:Boolean;
          
          public var meltUnit:Boolean;
          
          public var poisonRegen:Boolean;
          
          public var fireRegen:Boolean;
          
          public var stunUnit:Boolean;
          
          public var slowRegen:Boolean;
          
          public var frozenUnit:Boolean;
          
          public var lifeSteal:Boolean;
          
          public var lifeStealAmount:int = 10000;
          
          private var swordHit:int;
          
          public var damageUnit:Boolean;
          
          public var blueColor:Boolean;
          
          public var enemyColor3:Boolean;
          
          public var enemyColor4:Boolean;
          
          public var redColor:Boolean;
          
          public var greenColor:Boolean;
          
          public var goldenColor:Boolean;
          
          public var enemyBuffed:Boolean;
          
          public var teamBuffed:Boolean;
          
          public var teleportDistance:int;
          
          public var teleportFromDamage:Boolean = false;
          
          public var teleportEnemy:Boolean = false;
          
          public var nonTeleportable:Boolean = false;
          
          public var removeIce:Boolean;
          
          public var removeFire:Boolean = false;
          
          public var generalRegen:Boolean;
          
          public var generalRegen2:Boolean;
          
          public var giantRegen:Boolean;
          
          public var LeGoldRegen:Boolean;
          
          public var unitRegen:Boolean;
          
          public var FullHealthRegen:Boolean;
          
          public var PackRegen:Boolean;
          
          public var BlockChance:Boolean;
          
          public var HeavyVampRegen:Boolean;
          
          public var LightVampRegen:Boolean;
          
          public var LightVampCure:Boolean;
          
          public var HeavyVampCure:Boolean;
          
          public var GiantVamp:Boolean;
          
          public var GiantRegen:Boolean;
          
          public var criticalDamage:Boolean;
          
          public var massStun:Boolean;
          
          public var massSlow:Boolean;
          
          public var massBurn:Boolean;
          
          public var massPoison:Boolean;
          
          public var massFreeze:Boolean;
          
          public var selfFreeze:Boolean;
          
          private var deadRespawn:com.brockw.stickwar.engine.units.Dead;
          
          public var VoltaicShock:Boolean;
          
          public var MagisShock:Boolean;
          
          public var maxHealthIncrease:Boolean;
          
          public var maxHealthIncreaseAmount:int = 10;
          
          public var MagisIsVoltaic:Boolean;
          
          public var GeneralIsVoltaic:Boolean;
          
          public var isVoltaic:Boolean;
          
          public var reapUnit:Boolean;
          
          public var swordwrath:com.brockw.stickwar.engine.units.Swordwrath;
          
          public var thingy:StickWar;
          
          public var slowAttack:Boolean;
          
          public var reapImmune:Boolean;
          
          public var ResistFire:Boolean;
          
          public var weakToFire:Boolean;
          
          public var weakToIce:Boolean;
          
          public var hitNuke:Boolean;
          
          public var RefuseToDie:Boolean;
          
          public var KingRefuseToDie:Boolean;
          
          public var MagisRefuseToDie:Boolean;
          ...
          public var isSavage:Boolean;
          
          public var isLava:Boolean;
          
          public var isVamp:Boolean;
          
          public var isASuperUnit:Boolean;
          
          public var isABoss:Boolean;
          
          public var isVulnerable:Boolean;
          
          public var isAGoldenUnit:Boolean;
          
          public var isAGeneral:Boolean;
          
          public var s07:Boolean;
          
          public var isLegend:Boolean;
          
          public var isBuffSpear:Boolean;
          
          public var isNotPossessable:Boolean;
          
          public function Unit(param1:StickWar)
          {
               this.thingy = param1;
               this.maxHealthIncreaseAmount = 10;
               this.lifeStealAmount = 10000;
               this.lifeStealAmount = 10000;
               this.lifeStealAmount = 10000;
               this.lifeStealAmount = 10000;
               this.lifeStealAmount = 10000;
               ...
               this.UCglow = new GlowFilter(_loc2_,1,36,18,2.64,_loc7_,false,false);
          ...
          override public function drawOnHud(param1:MovieClip, param2:StickWar) : void
          {
               ...
               if(this.team.isEnemy)
               {
                    if(this.isABoss)
                    {
                         MovieClip(param1).graphics.lineStyle(6,13172991,3);
                    }
                    else if(this.s07)
                    {
                         MovieClip(param1).graphics.lineStyle(9,16711680,6);
                    }
                    else if(this.isLegend)
                    {
                         MovieClip(param1).graphics.lineStyle(5,16733184,3);
                    }
                    else if(this.isAGoldenUnit)
                    {
                         MovieClip(param1).graphics.lineStyle(5,16752896,2);
                    }
                    else if(this.isAGeneral)
                    {
                         MovieClip(param1).graphics.lineStyle(3,365655,1);
                    }
                    else if(this.isASuperUnit)
                    {
                         MovieClip(param1).graphics.lineStyle(3,6029481,2);
                    }
                    else if(this.isIce)
                    {
                         MovieClip(param1).graphics.lineStyle(2,7602381,1);
                    }
                    else if(this.isSavage)
                    {
                         MovieClip(param1).graphics.lineStyle(2,16755456,1);
                    }
                    else if(this.isLeaf)
                    {
                         MovieClip(param1).graphics.lineStyle(2,30208,1);
                    }
                    else if(this.isLava)
                    {
                         MovieClip(param1).graphics.lineStyle(2,12058624,1);
                    }
                    else
                    {
                         MovieClip(param1).graphics.lineStyle(2,13303808,1);
                    }
               }
               else if(selected)
               {
                    if(this.isABoss)
                    {
                         MovieClip(param1).graphics.lineStyle(6,16711935,3);
                    }
                    else if(this.s07)
                    {
                         MovieClip(param1).graphics.lineStyle(9,12058624,6);
                    }
                    else if(this.isLegend)
                    {
                         MovieClip(param1).graphics.lineStyle(6,16748800,4);
                    }
                    else if(this.isAGoldenUnit)
                    {
                         MovieClip(param1).graphics.lineStyle(8,15372544,3);
                    }
                    else if(this.isASuperUnit)
                    {
                         MovieClip(param1).graphics.lineStyle(4,200,3);
                    }
                    else if(this.isAGeneral)
                    {
                         MovieClip(param1).graphics.lineStyle(4,634689,2);
                    }
                    else if(this.isIce)
                    {
                         MovieClip(param1).graphics.lineStyle(4,255,2);
                    }
                    else if(this.isSavage)
                    {
                         MovieClip(param1).graphics.lineStyle(4,16776704,2);
                    }
                    else if(this.isLeaf)
                    {
                         MovieClip(param1).graphics.lineStyle(4,65316,2);
                    }
                    else if(this.isLava)
                    {
                         MovieClip(param1).graphics.lineStyle(4,16711680,2);
                    }
                    else
                    {
                         MovieClip(param1).graphics.lineStyle(4,31071,2);
                    }
               }
               else if(this.isASuperUnit)
               {
                    MovieClip(param1).graphics.lineStyle(3,178,2);
               }
               else if(this.s07)
               {
                    MovieClip(param1).graphics.lineStyle(9,12058624,6);
               ...
               {
                    MovieClip(param1).graphics.lineStyle(5,16734976,3);
               }
               else if(this.isABoss)
               {
                    MovieClip(param1).graphics.lineStyle(6,7012607,3);
               }
               else if(this.isAGoldenUnit)
               {
                    MovieClip(param1).graphics.lineStyle(5,15381248,2);
               }
               else if(this.isAGeneral)
               {
                    MovieClip(param1).graphics.lineStyle(3,620588,1);
               }
               else if(this.isIce)
               {
                    MovieClip(param1).graphics.lineStyle(2,150,1);
               }
               else if(this.isSavage)
               {
                    MovieClip(param1).graphics.lineStyle(2,16756736,1);
               }
               else if(this.isLeaf)
               {
                    MovieClip(param1).graphics.lineStyle(2,25088,1);
               }
               else if(this.isLava)
               {
                    MovieClip(param1).graphics.lineStyle(2,10551296,1);
               }
               else
               {
          ...
          public function heal(param1:Number, param2:int) : void
          {
               ...
               if(this.health != this.maxHealth && this.team.game.frame - this.lastHealthAnimation > 30)
               {
                    ...
                    if(this.enableDamageNum == true && this.enableHealNum == true)
                    {
                         this.thingy.incomeDisplay.addDisplay(this.thingy,"+" + param1,49919,this.x,this.y - this.height - 10);
                    }
                    this.lastHealthAnimation = this.team.game.frame;
                    if(this.isGarrisoned == true && this.team.game.frame - this.lastHealthAnimation > 30 * 5)
                    {
                         if(this.enableDamageNum == true && this.enableHealNum == true)
                         {
                              this.thingy.incomeDisplay.addDisplay(this.thingy,"+" + param1 * 150,49919,this.x,this.y - this.height - 10);
                         }
                         this.lastHealthAnimation = this.team.game.frame;
                    }
               }
          ...
          public function updateStatus() : void
          {
               ...
               if(this.fireDamageFrames > 0)
               {
                    ...
                    if(this.fireRegen)
                    {
                         this.heal(this.fireDamagePerFrame,1);
                    }
                    else
                    {
               ...
               if(this.generalRegen2)
               {
                    if(this._health + this.chaosHealRate * 3 <= this.maxHealth)
                    {
                         this._health += this.chaosHealRate * 3;
                    }
               }
               if(this.unitRegen)
               {
               ...
               if(this.PackRegen)
               {
                    if(this._health + this.chaosHealRate * 1.5 <= this.maxHealth)
                    {
               ...
               if(this.slowFramesRemaining)
               {
                    if(this.slowRegen)
                    {
                         this.heal(1.2,this.slowFramesRemaining);
                    }
          ...
          {
               this.updateStatus();
               this.randomNumber = int(int(Math.floor(Math.random() * 4) + 1));
               var _loc2_:ColorTransform = this.mc.transform.colorTransform;
               if(this.isTowerSpawned)
               {
                    _loc2_.greenOffset = 79;
                    _loc2_.blueOffset = 200;
               ...
               else if(this.isRGB == true)
               {
                    if(this.down == false && this.up == false)
                    {
                         _loc2_.redOffset += 3;
                         if(_loc2_.blueOffset >= 0 && _loc2_.blueOffset <= 200)
                         {
                              _loc2_.blueOffset -= 4;
                         }
                    }
                    if(_loc2_.redOffset == 150)
                    {
                         this.down = true;
                         this.up = false;
                    }
                    ...
                    {
                         if(_loc2_.redOffset >= 0 && _loc2_.redOffset <= 150)
                         {
                              _loc2_.redOffset -= 3;
                         }
                         _loc2_.greenOffset += 3;
                    }
                    if(_loc2_.greenOffset == 150)
                    {
                         this.down = false;
                         this.up = true;
                    }
                    if(this.down == false && this.up == true)
                    {
                         if(_loc2_.greenOffset >= 0 && _loc2_.greenOffset <= 150)
                         {
                              _loc2_.greenOffset -= 3;
                         }
                         _loc2_.blueOffset += 4;
                    }
                    if(_loc2_.blueOffset == 200)
                    {
                         this.down = false;
                         this.up = false;
                    }
               ...
               else
               {
                    ...
                    if(this.blueColor)
                    {
                         _loc2_.blueOffset = 300;
                         _loc2_.greenOffset = 165;
                    }
                    else if(this.redColor)
                    {
                         _loc2_.redOffset = 115;
                    }
                    else if(this.greenColor)
                    {
                         _loc2_.greenOffset = 145;
                    }
                    else if(this.goldenColor)
                    {
                         _loc2_.blueOffset = 0;
                         _loc2_.redOffset = 237;
                         _loc2_.greenOffset = 201;
                    }
                    else if(this.enemyColor3)
                    {
                         _loc2_.redMultiplier = 0;
                         _loc2_.blueMultiplier = 255;
                         _loc2_.greenMultiplier = 155;
                         _loc2_.blueOffset = 255;
                         _loc2_.redOffset = 0;
                         _loc2_.greenOffset = 155;
                    }
                    else if(this.enemyColor4)
                    {
                         _loc2_.redMultiplier = 0;
                    ...
                    else if(this.team == param1.team.enemyTeam)
                    {
                         _loc2_.redOffset = 75;
                    }
                    else
               ...
               if(this.maxHealthIncrease)
               {
                    if(this.isAlive() && param1.frame % 400 == 0)
                    {
                         this.maxHealth += this.maxHealthIncreaseAmount;
                         this.health += this.maxHealthIncreaseAmount;
                         this.maxHealth = this.maxHealth;
                         this.healthBar.totalHealth = this.maxHealth;
                    }
               }
               if(this.team.type == Team.T_CHAOS)
               {
                    if(this.isAlive() && param1.frame % 180 == 0)
                    {
                    }
               }
               if(this.weakToFire)
               {
                    if(this.fireDamageFrames > 0)
                    {
                         this.fireDamagePerFrame = 3;
                    }
               }
               if(this.VoltaicShock)
               {
                    if(this.isAlive() && param1.frame % 615 == 0)
                    {
                         this.team.game.projectileManager.initTowerSpawn(px,py,param1.team,0.6);
                         this.team.game.projectileManager.initStun(this.px,py,35,this);
                    }
               }
               if(this.MagisShock)
               {
                    if(this.isAlive() && param1.frame % 283 == 0)
                    {
                         this.team.game.projectileManager.initTowerSpawn(px + 100,py,param1.team,0.6);
                         this.team.game.projectileManager.initStun(this.px + 100,py,35,this);
                         this.team.game.projectileManager.initTowerSpawn(px,py,param1.team,0.6);
                         this.team.game.projectileManager.initStun(this.px,py,35,this);
                         this.team.game.projectileManager.initTowerSpawn(px - 100,py,param1.team,0.6);
                         this.team.game.projectileManager.initStun(this.px - 100,py,35,this);
               ...
               if(this.massStun)
               {
                    if(this.isAlive() && param1.frame % 113 == 0)
                    {
                         this.stun(60);
                    }
               }
               if(this.massSlow)
               {
                    if(this.isAlive() && param1.frame % 250 == 0)
                    {
                         this.slow(30 * 5);
                    }
               }
               if(this.massBurn)
               {
                    if(this.isAlive() && param1.frame % 267 == 0)
                    {
                         this.setFire(90,0.4);
                    }
               }
               if(this.massFreeze)
               {
                    if(this.isAlive() && param1.frame % 200 == 0)
                    {
                         this.freezeCount = 30 * 2.5;
                    }
               }
               if(this.massPoison)
               {
                    if(this.isAlive() && param1.frame % 1203 == 0)
                    {
                         this.poison(6);
                    }
               }
               if(this.HeavyVampRegen)
               {
                    if(this.isAlive() && param1.frame % 130 == 0)
                    {
                         this.heal(25,1.4);
                    }
               }
               if(this.HeavyVampCure)
               {
                    if(this.isAlive() && param1.frame % 330 == 0)
                    {
                         this.cure();
                    }
               }
               if(this.LightVampRegen)
               {
                    if(this.isAlive() && param1.frame % 100 == 0)
                    {
                         this.heal(13,1);
                    }
               }
               if(this.LightVampCure)
               {
                    if(this.isAlive() && param1.frame % 210 == 0)
                    {
                         this.cure();
                    }
               }
               if(this.generalRegen)
               {
                    if(this.isAlive() && param1.frame % 550 == 0)
                    {
                         this.heal(35,1);
                         this.cure();
                    }
               }
               if(this.FullHealthRegen)
               {
                    if(this.isAlive() && param1.frame % 2450 == 0)
                    {
                         this.heal(50000,100);
                         this.cure();
                    }
               ...
               if(this.giantRegen)
               {
                    if(this.isAlive() && param1.frame % 1250 == 0)
                    {
                         this.heal(220,1);
                         this.cure();
                    }
               ...
               if(this.LeGoldRegen)
               {
                    if(this.isAlive() && param1.frame % 274 == 0)
                    {
                         this.heal(75,1);
                         this.cure();
                    }
               ...
               if(this.GiantRegen)
               {
                    if(this.isAlive() && param1.frame % 500 == 0)
                    {
                         this.heal(300,2);
                         this.cure();
                    }
               ...
               if(this.isAlive() && param1.frame % 90 == 0 && this._poisonDamage > 0)
               {
                    if(this.poisonRegen)
                    {
                         this.heal(1,this._poisonDamage);
                    }
                    else
                    {
                         if(this.enableDamageNum == true)
                         {
                              this.thingy.incomeDisplay.addDisplay(this.thingy,"" + this._poisonDamage * -1,10486015,this.x,this.y - this.height - 10);
                         }
                         this.damage(D_NO_SOUND,this._poisonDamage,null);
                    }
                    _loc2_.greenOffset = 205;
               }
               else if(this.isSwitched)
               {
               }
          ...
          public function updateSelected() : void
          {
               ...
               {
                    if(this.isASuperUnit)
                    {
                         this.drawSelected(178,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 255);
                    }
                    else if(this.s07)
                    {
                         this.drawSelected(12058624,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16711680);
                    }
                    else if(this.isLegend)
                    {
                         this.drawSelected(16727552,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16746240);
                    }
                    else if(this.isAGoldenUnit)
                    {
                         this.drawSelected(16755456,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16769536);
                    }
                    else if(this.isABoss)
                    {
                         this.drawSelected(9961668,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 12648703);
                    }
                    else if(this.isAGeneral)
                    {
                         this.drawSelected(2735482,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 2745746);
                    }
                    else if(this.isIce)
                    {
                         this.drawSelected(21373,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 29377);
                    }
                    else if(this.isSavage)
                    {
                         this.drawSelected(13149696,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 15188224);
                    }
                    else if(this.isLeaf)
                    {
                         this.drawSelected(37376,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 48384);
                    }
                    else if(this.isLava)
                    {
                         this.drawSelected(8716288,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 12517376);
                    }
                    else
                    {
                         this.drawSelected(23871,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 31071);
                    }
               }
               else if(selected && this.isInteractable && this.isAlive())
               {
                    if(this.isASuperUnit)
                    {
                         this.drawSelected(178,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 255);
                    }
                    else if(this.s07)
                    {
                         this.drawSelected(12058624,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16711680);
                    ...
                    {
                         this.drawSelected(16754688,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16771328);
                    }
                    else if(this.isAGoldenUnit)
                    {
                         this.drawSelected(16769280,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16776960);
                    }
                    else if(this.isABoss)
                    {
                         this.drawSelected(14549234,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 16711935);
                    }
                    else if(this.isAGeneral)
                    {
                         this.drawSelected(2735482,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 2745746);
                    ...
                    {
                         this.drawSelected(31928,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 35554);
                    }
                    else if(this.isSavage)
                    {
                         this.drawSelected(16764160,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 16776960);
                    }
                    else if(this.isLeaf)
                    {
                         this.drawSelected(51200,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 63488);
                    }
                    else if(this.isLava)
                    {
                         this.drawSelected(14352384,this.isBusy() ? Number(4) : Number(2),this.isBusy() ? 255 : 16711680);
                    }
                    else
                    {
          ...
          protected function checkForHit() : Boolean
          {
               ...
               var _loc2_:* = this.mc.transform.colorTransform;
               if(_loc1_ == null)
               {
                    return false;
               }
               _loc2_ = int(Util.sgn(_loc1_.px - px));
               ...
               if(_loc1_.checkForHitPoint(_loc3_,_loc1_))
               {
                    ...
                    if(_loc1_.isReflective == true)
                    {
                         this.damage(0,this.damageToDeal / 4,this);
                    }
                    if(this.criticalDamage)
                    {
                         if(this.randomNumber == 2)
                         {
                              _loc1_.damage(0,this.damageToDeal * 19,this);
                              if(_loc1_.isReflective == true)
                              {
                                   this.damage(0,this.damageToDeal * 19 / 4,this);
                              }
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",7,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",6,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",5,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",4,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",3,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",2,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",1,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",7,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",6,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",5,px,py);
                              this.team.game.soundManager.playSoundRandom("hitOnArmour",4,px,py);
                    ...
                    if(this.reapUnit)
                    {
                         if(this.isAlive() && this.health < 2000)
                         {
                              this.team.game.projectileManager.initReaper(this,_loc1_);
                         }
                    }
                    if(this.hitNuke)
                    {
                         this.team.game.projectileManager.initNuke(px,py,_loc1_,10,0.2,200);
                    }
                    if(this.isVoltaic)
                    {
                         _loc1_.setFire(3500,0.0218);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                    }
                    if(this.GeneralIsVoltaic)
                    {
                         _loc1_.setFire(5500,0.0493);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                    }
                    if(this.MagisIsVoltaic)
                    {
                         _loc1_.setFire(8500,0.5);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                         this.team.game.projectileManager.initLightning(this,_loc1_,this);
                    ...
                    if(this.lifeSteal)
                    {
                         _loc1_.maxHealth -= this.lifeStealAmount;
                         this.maxHealth += this.lifeStealAmount;
                         this.health += this.lifeStealAmount;
                         this.maxHealth = this.maxHealth;
                         this.healthBar.totalHealth = this.maxHealth;
                    }
                    if(this.teleportEnemy == true && _loc1_.nonTeleportable == false)
                    {
                         _loc1_.px += this.teleportDistance * this.team.direction;
                    }
                    return true;
               }
               return false;
          ...
          override public function damage(param1:int, param2:Number, param3:Entity, param4:Number = 1) : void
          {
               ...
               if(this.isTargetable() && !this.isDualing)
               {
                    ...
                    this._health -= _loc5_;
                    if(_loc5_ != null && _loc5_ >= 1)
                    {
                         if(this.teleportFromDamage == true && this.nonTeleportable == false)
                         {
                              this.team.game.projectileManager.initTeleportEffectIn(px,py,0,this.team,this.team.direction);
                              this.px += this.teleportDistance * this.team.direction;
                         }
                         if(this.enableDamageNum == true && this.enableHitNum == true)
                         {
                              this.thingy.incomeDisplay.addDisplay(this.thingy,"" + _loc5_ * -1,16777215,this.x,this.y - this.height - 10);
                         }
                    }
                    if(this._health <= 0)
                    {
          ...
          public function stoneAttack(param1:int) : void
          {
               ...
               if(this.isStoneable && !this.noStone)
               {
