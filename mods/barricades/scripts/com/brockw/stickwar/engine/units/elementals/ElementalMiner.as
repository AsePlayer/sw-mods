package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.ElementalMinerAi;
     ...
     public class ElementalMiner extends Miner
     {
          ...
          {
               var _loc5_:_minerElementMc = null;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(!isDieing)
               {
                    ...
                    else if(_state == S_MINE)
                    {
                         ...
                         {
                              _loc6_ = MovieClip(_mc).currentFrameLabel;
               ...
               if(_mc.mc.crabgold)
               {
                    ...
                    _loc8_ = MovieClip(_mc.mc.crabgold).totalFrames;
