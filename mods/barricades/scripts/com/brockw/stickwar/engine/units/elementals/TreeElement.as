package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.MudElementAi;
     ...
     public class TreeElement extends Unit
     {
          ...
          public static function setItem(param1:MovieClip, param2:String, param3:String, param4:String) : void
          {
               ...
               if((_loc5_ = _tree(param1)).mc.tree)
               {
                    ...
                    else if(_loc5_.mc.tree.top && _loc5_.mc.tree.top.hat)
                    {
               ...
               else if(_loc5_.mc.top && _loc5_.mc.top.hat)
               {
          ...
          public function flowerSpell(param1:Unit) : void
          {
               ...
               if(this.flowerSpellCooldown.spellActivate(team) && !this._isFlowerSpell)
               {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(!isDieing)
               {
                    ...
                    else if(this._isFlowerSpell && !isDead)
                    {
               ...
               if(this.isRooting && this.shouldRoot)
               {
                    if(_mc.mc.treedirt)
                    {
                         ++this.rootFrame;
          ...
          {
               return this.shouldRoot && !this.isRooting || !this.shouldRoot && this.isRooting;
          }
