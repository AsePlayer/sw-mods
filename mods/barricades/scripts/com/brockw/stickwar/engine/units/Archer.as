     ...
     public class Archer extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               else if(team.isEnemy && !enemyBuffed && !this.isCastleArcher)
               {
                    ...
                    _maxVelocity = Number(param1.xml.xml.Order.Units.archer.maxVelocity) * 2;
                    enemyBuffed = true;
               }
               ...
               if(this.archerType == "TinyArcher" && !this.setupComplete)
               {
                    this.healthBar.visible = false;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","","");
                    maxHealth = 1000;
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.archerType == "FireArcher" || this.archerType == "Frost_1")
                    {
                         _maxVelocity = 4.8;
                    }
                    else if(this.archerType == "TinyArcher")
                    {
                         stunTimeLeft = 0;
                         _maxVelocity = 6;
                    }
          ...
          {
               if(this.inBlock || this.archerType == "Archis" || this.archerType == "SavageArcherPrince" || this.archerType == "Kytchu" || this.archerType == "DarkKytchu" || this.archerType == "Kytchu_2")
               {
