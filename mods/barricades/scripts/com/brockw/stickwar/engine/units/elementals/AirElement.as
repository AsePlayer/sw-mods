package com.brockw.stickwar.engine.units.elementals
{
     ...
     import com.brockw.stickwar.engine.Ai.AirElementAi;
     ...
     public class AirElement extends RangedUnit
     {
          ...
          public var MeIsAFuckingAirElemental:Boolean = true;
          
          public var airElementType:String;
          ...
          {
               var _loc5_:_airElemental = null;
               if((_loc5_ = _airElemental(param1)).mc.head && _loc5_.mc.head.head && _loc5_.mc.head.head.hat)
               {
                    if(param3 != "")
                    {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(isUC)
               {
                    _maxVelocity = param1.xml.xml.Elemental.Units.airElement.maxVelocity * 1.2;
                    _damageToNotArmour = (Number(param1.xml.xml.Elemental.Units.airElement.damage) + Number(param1.xml.xml.Elemental.Units.airElement.toNotArmour)) * 5;
                    _damageToArmour = (Number(param1.xml.xml.Elemental.Units.airElement.damage) + Number(param1.xml.xml.Elemental.Units.airElement.toArmour)) * 6;
                    _mass = Number(param1.xml.xml.Elemental.Units.airElement.mass) / 2;
               }
               else if(!team.isEnemy)
               {
                    _maxVelocity = param1.xml.xml.Elemental.Units.airElement.maxVelocity;
                    _damageToNotArmour = Number(param1.xml.xml.Elemental.Units.airElement.damage) + Number(param1.xml.xml.Elemental.Units.airElement.toNotArmour);
                    _damageToArmour = Number(param1.xml.xml.Elemental.Units.airElement.damage) + Number(param1.xml.xml.Elemental.Units.airElement.toArmour);
                    _mass = param1.xml.xml.Elemental.Units.airElement.mass;
               }
               ...
               if(this.airElementType == "Air_1" && !this.setupComplete)
               {
                    maxHealth = 1300;
                    health = 1300;
                    maxHealth = maxHealth;
