package com.brockw.stickwar.engine.units
{
     ...
     public class Swordwrath extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.swordwrathType == "Wrathnar" || this.swordwrathType == "Just_K" || this.swordwrathType == "Sicklebear" || this.swordwrathType == "SickleLeader" || this.swordwrathType == "Voltsickle" || this.swordwrathType == "Wrathnar_2" || this.swordwrathType == "Crystalsickle" || this.swordwrathType == "Sicklewrath" || this.swordwrathType == "Leafsickle" || this.swordwrathType == "Savagesickle" || this.swordwrathType == "Lavasickle" || this.swordwrathType == "Icesickle")
               {
               ...
               if(this.swordwrathType == "TinySword" && !this.setupComplete)
               {
               ...
               if(this.swordwrathType == "Xiphos_2" && !this.setupComplete)
               {
                    ...
                    _maxVelocity = 6.1;
                    this.isReflective = true;
                    this.shieldwallDamageReduction = 0.68;
                    this.setupComplete = true;
               }
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.swordwrathType == "TinySword")
                    {
                         this.normalMaxVelocity = 15.1;
                    }
                    ...
                    {
                         this.damageIncrease = 100;
                    }
                    else if(this.swordwrathType == "CorruptBloodBlade")
                    {
                         this.damageIncrease = 150;
                    }
               ...
               else if(isDead == false)
               {
                    ...
                    if(this.swordwrathType == "Wrathnar")
                    {
                         param1.projectileManager.initNuke(px,py,this,150,2,100);
                         team.gold += 50;
                    }
                    ...
                    if(this.swordwrathType == "MinionBomber")
                    {
                         ...
                         param1.projectileManager.initNuke(px,py,this,20,0.1,250);
                    }
                    isDead = true;
                    if(_isDualing)
                    {
          ...
          override public function get damageToArmour() : Number
          {
               ...
               if(this.swordwrathType == "TinySword")
               {
                    return 5000;
               }
               ...
               if(this.swordwrathType == "Leafsickle")
               {
                    return 8;
               }
               ...
               if(this.swordwrathType == "Savagesickle")
               {
                    return 8;
               }
               if(this.swordwrathType == "Lavasickle")
               {
                    return 8;
               }
               if(this.swordwrathType == "Xiphos")
               ...
               if(this.swordwrathType == "CorruptBloodBlade")
               {
                    return 85;
               }
