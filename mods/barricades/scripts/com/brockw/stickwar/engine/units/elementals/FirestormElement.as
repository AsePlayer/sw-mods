package com.brockw.stickwar.engine.units.elementals
{
     ...
     public class FirestormElement extends Unit
     {
          ...
          {
               var _loc5_:_firestormElement = null;
               if((_loc5_ = _firestormElement(param1)).mc.head && _loc5_.mc.head.head)
               {
                    if(param3 != "")
                    {
          ...
          {
               if(this.notInSpell() && this.firestormSpellCooldown.spellActivate(this.team))
               {
                    this.spellX = param1;
                    forceFaceDirection(this.spellX - this.px);
                    this.spellY = param2;
          ...
          {
               if(this.notInSpell() && this.firebreathSpellCooldown.spellActivate(this.team))
               {
                    this.spellX = param1;
                    forceFaceDirection(this.spellX - this.px);
                    this.spellY = param2;
