package com.brockw.stickwar.engine
{
     ...
     public class UserInterface extends Screen
     {
          ...
          internal var UCunit:Unit;
          
          internal var UCmoveX:int;
          
          internal var UCmoveY:int;
          
          internal var goingLeft:Boolean;
          
          internal var goingRight:Boolean;
          
          internal var goingUp:Boolean;
          
          public var goingDown:Boolean;
          
          internal var attacking:Boolean;
          
          private var arrow:tutorialArrow;
          
          internal var leaveUCTimer:int;
          
          internal var UCCameraTimer:int;
          
          internal var attackTimer:int;
          
          internal var UCcamera:Boolean;
          
          internal var inRange:Unit;
          ...
          public function init(param1:Team) : void
          {
               ...
               else if(param1.type == Team.T_ELEMENTAL)
               {
          ...
          private function checkInputForSelect(param1:int) : void
          {
               ...
               for(_loc2_ in this.team.units)
               {
                    ...
                    if((Unit(this.team.units[_loc2_]).type == param1 || Unit(this.team.units[_loc2_]).selected && this.keyBoardState.isShift) && !Unit(this.team.units[_loc2_]).isGarrisoned)
                    {
          ...
          public function update(param1:Event, param2:Number) : void
          {
               ...
               if(this.UCunit)
               {
                    ...
                    if(this.UCcamera && (this.UCunit.type == Unit.U_ARCHER || this.UCunit.type == Unit.U_FLYING_CROSSBOWMAN || this.UCunit.type == Unit.U_DEAD || this.UCunit.type == Unit.U_WINGIDON || this.UCunit.type == Unit.U_FIRE_ELEMENT || this.UCunit.type == Unit.U_AIR_ELEMENT))
                    {
                         this.gameScreen.game.targetScreenX = this.UCunit.px - 250;
                    }
               ...
               if(!this.UCunit && this.keyBoardState.isPressed(32))
               {
                    this.selectedUnits.clear();
                    for each(_loc5_ in this.team.units)
                    {
                         if(_loc5_.isInteractable && !_loc5_.isMiner() && !_loc5_.isDead && _loc5_.isGarrisoned == false && _loc5_.type != Unit.U_CHAOS_TOWER)
                         {
