package com.brockw.stickwar.engine.Team
{
     ...
     public class Team
     {
          ...
          private var baseTowerGoldAmount:Number;
          ...
          private var passiveIncomeAmount2:Number;
          
          public var techAllowed:Dictionary;
          
          private var baseTowerManaAmount:Number;
          ...
          private var passiveMana2:Number;
          ...
          private var spawnedUnit1:Unit;
          
          private var spawnedUnit2:Unit;
          
          private var spawnedUnit3:Unit;
          
          private var spawnedUnit4:Unit;
          
          private var spawnedUnit5:Unit;
          
          private var timeSinceSpawnedUnit:int;
          
          private var timeSinceSpawnedUnit1:int;
          
          private var timeSinceSpawnedUnit2:int;
          
          private var timeSinceSpawnedUnit3:int;
          
          private var timeSinceSpawnedUnit4:int;
          
          private var timeSinceSpawnedUnit5:int;
          
          private var towerSpawnDelay:int;
          
          private var towerSpawnDelay1:int;
          
          private var towerSpawnDelay2:int;
          
          private var towerSpawnDelay3:int;
          
          private var towerSpawnDelay4:int;
          
          private var towerSpawnDelay5:int;
          ...
          public function Team(param1:StickWar)
          {
               ...
               this.timeSinceSpawnedUnit1 = 0;
               this.timeSinceSpawnedUnit2 = 0;
               this.timeSinceSpawnedUnit3 = 0;
               this.timeSinceSpawnedUnit4 = 0;
               this.timeSinceSpawnedUnit5 = 0;
               ...
               this.baseTowerGoldAmount = param1.xml.xml.baseTowerGoldAmount;
               this.baseTowerManaAmount = param1.xml.xml.baseTowerManaAmount;
               this.passiveIncomeAmount = param1.xml.xml.passiveIncome;
               this.passiveIncomeAmount2 = param1.xml.xml.passiveIncome2;
               ...
               this.passiveMana2 = param1.xml.xml.passiveMana2;
               ...
               this.towerSpawnDelay1 = param1.xml.xml.towerSpawnDelay1;
               this.towerSpawnDelay2 = param1.xml.xml.towerSpawnDelay2;
               this.towerSpawnDelay3 = param1.xml.xml.towerSpawnDelay3;
               this.towerSpawnDelay4 = param1.xml.xml.towerSpawnDelay4;
               this.towerSpawnDelay5 = param1.xml.xml.towerSpawnDelay5;
          ...
          private function spawnMiddleUnit(param1:StickWar) : Unit
          {
               ...
               _loc3_.y = _loc3_.py = param1.map.height / 3;
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[0].px,param1.map.height / 3,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_0].px,param1.map.height / Tower_0.py,this,_loc5_)";
               return _loc3_;
          }
          
          private function spawnMiddleUnit1(param1:StickWar) : Unit
          {
               var _loc4_:AttackMoveCommand = null;
               if(param1.map.hills.length == 0)
               {
               ...
               var _loc3_:Unit = param1.unitFactory.getUnit(_loc2_);
               this.spawn(_loc3_,param1);
               _loc3_.x = _loc3_.px = param1.map.hills[1].px;
               _loc3_.y = _loc3_.py = param1.map.height / 1;
               _loc3_.isTowerSpawned = true;
               _loc3_.isInteractable = false;
               param1.soundManager.playSoundFullVolumeRandom("GhostTower",2);
               (_loc4_ = new AttackMoveCommand(param1)).type = UnitCommand.ATTACK_MOVE;
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[1].px,param1.map.height / 1,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_1].px,param1.map.height / Tower_1.py,this,_loc5_)";
               return _loc3_;
          }
          
          private function spawnMiddleUnit2(param1:StickWar) : Unit
          {
               var _loc4_:AttackMoveCommand = null;
               if(param1.map.hills.length == 0)
               {
               ...
               var _loc3_:Unit = param1.unitFactory.getUnit(_loc2_);
               this.spawn(_loc3_,param1);
               _loc3_.x = _loc3_.px = param1.map.hills[2].px;
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[2].px,param1.map.height / 2,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_2].px,param1.map.height / Tower_2.py,this,_loc5_)";
               return _loc3_;
          }
          
          private function spawnMiddleUnit3(param1:StickWar) : Unit
          {
               var _loc4_:AttackMoveCommand = null;
               if(param1.map.hills.length == 0)
               {
               ...
               var _loc3_:Unit = param1.unitFactory.getUnit(_loc2_);
               this.spawn(_loc3_,param1);
               _loc3_.x = _loc3_.px = param1.map.hills[3].px;
               _loc3_.y = _loc3_.py = param1.map.height / 2;
               _loc3_.isTowerSpawned = true;
               _loc3_.isInteractable = false;
               param1.soundManager.playSoundFullVolumeRandom("GhostTower",2);
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[3].px,param1.map.height / 2,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_3].px,param1.map.height / Tower_3.py,this,_loc5_)";
               return _loc3_;
          }
          
          private function spawnMiddleUnit4(param1:StickWar) : Unit
          {
               var _loc4_:AttackMoveCommand = null;
               if(param1.map.hills.length == 0)
               {
               ...
               var _loc3_:Unit = param1.unitFactory.getUnit(_loc2_);
               this.spawn(_loc3_,param1);
               _loc3_.x = _loc3_.px = param1.map.hills[4].px;
               _loc3_.y = _loc3_.py = param1.map.height / 2;
               _loc3_.isTowerSpawned = true;
               _loc3_.isInteractable = false;
               param1.soundManager.playSoundFullVolumeRandom("GhostTower",2);
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[4].px,param1.map.height / 2,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_4].px,param1.map.height / Tower_4.py,this,_loc5_)";
               return _loc3_;
          }
          
          private function spawnMiddleUnit5(param1:StickWar) : Unit
          {
               var _loc4_:AttackMoveCommand = null;
               if(param1.map.hills.length == 0)
               {
               ...
               var _loc3_:Unit = param1.unitFactory.getUnit(_loc2_);
               this.spawn(_loc3_,param1);
               _loc3_.x = _loc3_.px = param1.map.hills[5].px;
               _loc3_.y = _loc3_.py = param1.map.height / 2;
               _loc3_.isTowerSpawned = true;
               _loc3_.isInteractable = false;
               param1.soundManager.playSoundFullVolumeRandom("GhostTower",2);
               ...
               param1.projectileManager.initTowerSpawn(param1.map.hills[5].px,param1.map.height / 2,this,_loc5_);
               this.comment = "param1.projectileManager.initTowerSpawn(param1.map.hills[Tower_5].px,param1.map.height / Tower_5.py,this,_loc5_)";
               return _loc3_;
          }
          ...
          public function vaultGold(param1:StickWar, param2:int, param3:int, param4:int) : void
          {
               param1.incomeDisplay.addDisplay(param1,"+ " + param2,16768000,param3,param4 - 10);
          }
          ...
          public function update(param1:StickWar) : void
          {
               ...
               if(param1.map.hills.length != 0)
               {
                    ...
                    {
                         this.comment = "param1.map.hills[Tower_0]";
               ...
               if(this.spawnedUnit1 != null)
               {
                    if(!this.spawnedUnit1.isAlive())
                    {
                         this.spawnedUnit1 = null;
                    }
                    this.timeSinceSpawnedUnit1 = param1.frame;
               }
               if(param1.map.hills.length != 0)
               {
                    if((_loc11_ = param1.map.hills[1].getControllingTeam(param1)) == this)
                    {
                         this.comment = "param1.map.hills[Tower_1]";
                         if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                         {
                              if(param1.frame - this.timeSinceSpawnedUnit1 > this.towerSpawnDelay1)
                              {
                                   this.spawnedUnit1 = this.spawnMiddleUnit1(param1);
                              }
                         }
                    }
               }
               if(param1.map.hills.length != 0)
               {
                    if((_loc11_ = param1.map.hills[2].getControllingTeam(param1)) == this)
                    {
                         this.comment = "param1.map.hills[Tower_2]";
                         if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                         {
                              if(param1.frame % (30 * 60) == 0)
                              {
                                   param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmount2,827392,param1.map.hills[2].x - 40,param1.map.hills[2].y - param1.map.height - 10);
                                   param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveMana2,65535,param1.map.hills[2].x + 40,param1.map.hills[2].y - param1.map.height - 10);
                                   this.gold += this.passiveIncomeAmount2;
                                   this.mana += this.passiveMana2;
                              }
                         }
                    }
               }
               if(this.spawnedUnit3 != null)
               {
                    if(!this.spawnedUnit3.isAlive())
                    {
                         this.spawnedUnit3 = null;
                    }
                    this.timeSinceSpawnedUnit3 = param1.frame;
               }
               if(param1.map.hills.length != 0)
               {
                    if((_loc11_ = param1.map.hills[3].getControllingTeam(param1)) == this)
                    {
                         this.comment = "param1.map.hills[Tower_3]";
                         if(param1.frame % (30 * 40) == 0)
                         {
                              param1.incomeDisplay.addDisplay(param1,"+ " + this.baseTowerGoldAmount,827392,param1.map.hills[3].x - 40,param1.map.hills[3].y - param1.map.height - 10);
                              param1.incomeDisplay.addDisplay(param1,"+ " + this.baseTowerManaAmount,65535,param1.map.hills[3].x + 40,param1.map.hills[3].y - param1.map.height - 10);
                              this.gold += this.baseTowerGoldAmount;
                              this.mana += this.baseTowerManaAmount;
                         }
                         if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                         {
                              if(param1.frame - this.timeSinceSpawnedUnit3 > this.towerSpawnDelay3)
                              {
                                   this.spawnedUnit3 = this.spawnMiddleUnit3(param1);
                              }
                         }
                    }
               }
               if(this.spawnedUnit4 != null)
               {
                    if(!this.spawnedUnit4.isAlive())
                    {
                         this.spawnedUnit4 = null;
                    }
                    this.timeSinceSpawnedUnit4 = param1.frame;
               }
               if(param1.map.hills.length != 0)
               {
                    if((_loc11_ = param1.map.hills[4].getControllingTeam(param1)) == this)
                    {
                         this.comment = "param1.map.hills[Tower_4]";
                         if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                         {
                              if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                              {
                                   if(param1.frame % (30 * 60) == 0)
                                   {
                                        param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmount2,827392,param1.map.hills[4].x - 40,param1.map.hills[4].y - param1.map.height - 10);
                                        param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveMana2,65535,param1.map.hills[4].x + 40,param1.map.hills[4].y - param1.map.height - 10);
                                        this.gold += this.passiveIncomeAmount2;
                                        this.mana += this.passiveMana2;
                                   }
                              }
               ...
               if(this.spawnedUnit5 != null)
               {
                    if(!this.spawnedUnit5.isAlive())
                    {
                         this.spawnedUnit5 = null;
                    }
                    this.timeSinceSpawnedUnit5 = param1.frame;
               }
               if(param1.map.hills.length != 0)
               {
                    if((_loc11_ = param1.map.hills[5].getControllingTeam(param1)) == this)
                    {
                         this.comment = "param1.map.hills[Tower_5]";
                         if(this.tech.isResearched(com.brockw.stickwar.engine.Team.Tech.TOWER_SPAWN_I))
                         {
                         }
                    }
               ...
               if(param1.frame % (30 * 5) == 0)
               {
                    ...
                    {
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveManaUpgraded3,15871,this.statue.x - 50,this.statue.y - param1.map.height - 50);
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmountUpgraded3,25098,this.statue.x + 50,this.statue.y - param1.map.height - 50);
                    ...
                    {
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveManaUpgraded2,15871,this.statue.x - 50,this.statue.y - param1.map.height - 50);
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmountUpgraded2,25098,this.statue.x + 50,this.statue.y - param1.map.height - 50);
                    ...
                    {
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveManaUpgraded1,15871,this.statue.x - 50,this.statue.y - param1.map.height - 50);
                         param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmountUpgraded1,25098,this.statue.x + 50,this.statue.y - param1.map.height - 50);
                         this.gold += this.passiveIncomeAmountUpgraded1;
                         this.mana += this.passiveManaUpgraded1;
                    }
               }
               if(param1.frame % (30 * 6) == 0)
               {
                    param1.incomeDisplay.addDisplay(param1,"+ " + this.passiveIncomeAmount,16745472,this.statue.x,this.statue.y - param1.map.height - 50);
                    this.gold += this.passiveIncomeAmount;
                    this.mana += this.passiveMana;
               }
               if(param1.frame % (30 * 835) == 0)
               {
                    this.vaultGold(param1,this._gold / 5,this.statue.x,this.statue.y);
                    this.gold += this._gold / 5;
                    this.mana += this._mana / 5;
               }
