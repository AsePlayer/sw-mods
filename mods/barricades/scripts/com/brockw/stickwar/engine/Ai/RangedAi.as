package com.brockw.stickwar.engine.Ai
{
     ...
     public class RangedAi extends UnitAi
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               else if(mayMoveToAttack && currentTarget != null && unit.sqrDistanceTo(currentTarget) < 250000 && !unit.isGarrisoned)
               {
                    ...
                    else if(RangedUnit(unit).inRange(currentTarget) || Util.sgn(_loc2_) != Util.sgn(currentTarget.px - unit.px))
                    {
                         _loc2_ = 0;
                         unit.faceDirection(Util.sgn(currentTarget.px - unit.px));
                    }
