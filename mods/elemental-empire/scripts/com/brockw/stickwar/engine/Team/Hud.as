package com.brockw.stickwar.engine.Team
{
     ...
     public class Hud extends MovieClip
     {
          ...
          public function update(param1:StickWar, param2:Team) : void
          {
               ...
               var _loc3_:* = Math.floor(param1.frame / 30);
               ...
               if(param1.isReplay == false)
               {
                    ...
                    this.hud.turnSize.text = "By SW2 Custom Mods VN Team";
                    this.hud.fps.visible = true;
                    this.hud.ping.visible = false;
                    this.hud.turnSize.visible = true;
                    this.hud.economicDisplay2.visible = true;
                    this.hud.economicDisplay2.population.text = "" + Math.floor(param1.teamA.population);
                    this.hud.economicDisplay2.gold.text = "" + Math.floor(param1.teamA.gold);
                    this.hud.economicDisplay2.mana.text = "" + Math.floor(param1.teamA.mana);
                    this.hud.economicDisplay.visible = true;
                    this.hud.economicDisplay.population.text = "" + Math.floor(param1.teamB.population);
                    this.hud.economicDisplay.gold.text = "" + Math.floor(param1.teamB.gold);
                    this.hud.economicDisplay.mana.text = "" + Math.floor(param1.teamB.mana);
               }
               else
               {
