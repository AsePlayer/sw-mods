package com.brockw.stickwar.engine.Team.Elementals
{
     ...
     public class ElementalTech extends Tech
     {
          ...
          public function initUpgrades(param1:StickWar, param2:TeamElemental) : void
          {
               ...
               this.addNewUpgrade(POSSESS,param1.xml.xml.Elemental.Tech.possess,new Bitmap(new possessBitmap()),87);
               this.addNewUpgrade(V_GROWTH,param1.xml.xml.Elemental.Tech.vGrowth,new Bitmap(new giantLevel1Bitmap()),87);
