package com.brockw.stickwar.engine.Team
{
     ...
     public class Team
     {
          ...
          public function surrender(param1:Unit) : void
          {
               ...
               param1.isSurrender = !param1.isSurrender;
          ...
          public function coopSpawn(param1:Unit, param2:StickWar, param3:Boolean = true) : void
          {
               param1.isTowerSpawned = false;
               param1.isInteractable = false;
               param1.isCustomUnit = true;
               param1.alwaysAttack = false;
               param1.aidArmy = true;
               param1.isDead = false;
               ...
               if(param1.aidArmy == true)
               {
                    _loc4_.blueOffset = 255;
                    _loc4_.greenOffset = 51;
               }
               else
               {
                    _loc4_.redOffset = 0;
          ...
          public function spawn(param1:Unit, param2:StickWar, param3:Boolean = true) : void
          {
               ...
               param1.isCustomUnit = false;
               param1.alwaysAttack = false;
               param1.aidArmy = false;
               param1.isDead = false;
               param1.isDieing = false;
               param1.team = this;
               param1.setBuilding();
          ...
          public function removeUnit(param1:Unit, param2:StickWar) : void
          {
               ...
               else if(param1.isSurrender)
               {
                    this.surrender(param1);
                    param1.team.removeUnit(param1,param2);
               }
               else
               {
          ...
          public function removeUnitCompletely(param1:Unit, param2:StickWar) : void
          {
               ...
               else
               {
                    param1.isDead = true;
                    this._units.splice(this._units.indexOf(param1),1);
                    if(param2.units[param1.id] is Unit && param2.units[param1.id].isCustomUnit)
                    {
                         isNormalUnit = false;
                    }
                    else
