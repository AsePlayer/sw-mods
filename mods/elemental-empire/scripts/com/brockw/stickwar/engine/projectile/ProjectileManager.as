package com.brockw.stickwar.engine.projectile
{
     ...
     public class ProjectileManager
     {
          ...
          public function ProjectileManager(param1:StickWar)
          {
               ...
               this._projectileMap[Projectile.FREEZING] = new Pool(10,Freezing,param1);
               ...
               this._projectileMap[Projectile.SUMMON_DEAD] = new Pool(10,SummonDead,param1);
               this._projectileMap[Projectile.SUMMON_MINION] = new Pool(10,SummonMinion,param1);
          ...
          public function initLightning(param1:Unit, param2:Unit, param3:Number) : void
          {
               ...
               {
                    _loc4_.burnDamage = 35;
                    _loc4_.burnFrames = 30 * 5;
               }
          ...
          public function initFistAttack(param1:Number, param2:Number, param3:Unit, param4:int) : void
          {
               ...
               var _loc9_:* = (_loc5_.endX - _loc5_.startX) / _loc8_;
               var _loc10_:* = (_loc5_.endY - _loc5_.startY) / _loc8_;
               var _loc11_:* = param4 + 1.5;
          ...
          public function initSummonDead(param1:Number, param2:Number, param3:Unit, param4:int) : void
          {
               var _loc5_:SummonDead = null;
               if((_loc5_ = SummonDead(this._projectileMap[Projectile.SUMMON_DEAD].getItem())) == null)
               {
                    return;
               }
               _loc5_.visible = false;
          ...
          public function initPoisonSpray(param1:Number, param2:Number, param3:Unit, param4:Number) : void
          {
               ...
               var _loc7_:* = (param1 - param3.px) / _loc6_;
               var _loc8_:* = (param2 - param3.py) / _loc6_;
          ...
          public function initFreezing(param1:Number, param2:Number, param3:Unit, param4:Number) : void
          {
               var _loc5_:Freezing = null;
               if((_loc5_ = Freezing(this._projectileMap[Projectile.FREEZING].getItem())) == null)
               {
                    return;
               }
               _loc5_.visible = false;
          ...
          public function initArrow(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Unit, param8:Number, param9:Number, param10:Boolean, param11:Number, param12:Number, param13:Unit, param14:Number, param15:int) : void
          {
               ...
               var _loc17_:* = param7.team.game.backScale + param7.py / param7.team.game.map.height * (param7.team.game.frontScale - param7.team.game.backScale);
               if(param10)
               {
          ...
          public function initBoulder(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Unit, param8:Number, param9:Boolean, param10:Unit = null) : void
          {
               ...
               var _loc12_:* = param7.team.game.backScale + param7.py / param7.team.game.map.height * (param7.team.game.frontScale - param7.team.game.backScale);
          ...
          public function initBolt(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Unit, param8:Number, param9:int, param10:Boolean, param11:Unit, param12:Number, param13:int) : void
          {
               ...
               var _loc15_:* = param7.team.game.backScale + param7.py / param7.team.game.map.height * (param7.team.game.frontScale - param7.team.game.backScale);
               _loc14_.px = param1;
          ...
          public function initStun(param1:Number, param2:Number, param3:int, param4:Unit) : void
          {
               ...
               {
                    param1 = -Number(param4.team.game.xml.xml.Order.Units.magikill.electricWall.area) / 2 + param4.x + Util.sgn(param1 - param4.x) * Number(param4.team.game.xml.xml.Order.Units.magikill.electricWall.range);
               }
          ...
          public function initHurricane(param1:Number, param2:Number, param3:Unit, param4:Number) : void
          {
               ...
               var _loc7_:* = (param1 - param3.px) / _loc6_;
               var _loc8_:* = (param2 - param3.py) / _loc6_;
               param1 = param3.px + _loc7_ * Number(param3.team.game.xml.xml.Elemental.Units.hurricaneElement.hurricane.range);
               param2 = param3.py + _loc8_ * Number(param3.team.game.xml.xml.Elemental.Units.hurricaneElement.hurricane.range);
               _loc5_.inflictor = param3;
               _loc5_.endX = param1;
               _loc5_.endY = param2;
               _loc5_.px = param3.px;
          ...
          public function initNuke(param1:Number, param2:Number, param3:Unit, param4:Number, param5:Number, param6:int) : void
          {
               ...
               {
                    param1 = param3.px + Util.sgn(param1 - param3.px) * Number(param3.team.game.xml.xml.Order.Units.magikill.nuke.range);
               }
               _loc7_.burnDamage = param5;
               _loc7_.burnFrames = param6;
               _loc7_.inflictor = param3;
          ...
          public function initMinion(param1:Number, param2:Number, param3:Unit) : void
          {
               var _loc7_:SummonMinion = null;
               var _loc8_:Number = NaN;
               var _loc10_:* = NaN;
               if((_loc7_ = SummonMinion(this._projectileMap[Projectile.SUMMON_MINION].getItem())) == null)
               {
                    return;
               }
               _loc7_.visible = true;
          ...
          public function initPoisonPool(param1:Number, param2:Number, param3:Unit, param4:Number) : void
          {
               ...
               {
                    param1 = param3.x + Util.sgn(param1 - param3.px) * Number(param3.team.game.xml.xml.Chaos.Units.medusa.poison.range);
               }
               _loc5_.inflictor = param3;
               _loc5_.px = param1;
               _loc5_.py = param2;
