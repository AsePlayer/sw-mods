package com.brockw.stickwar.engine.projectile
{
     ...
     public class Projectile extends Entity
     {
          ...
          public static const FREEZING:int = 45;
          
          public static const SUMMON_DEAD:int = 46;
          
          public static const SUMMON_MINION:int = 47;
          
          public static const FIRE_SPRAY:int = 48;
          ...
          public function update(param1:StickWar) : void
          {
               ...
               var _loc8_:* = 0;
               this.visible = true;
               this.scaleX = Number(this._scale) * (param1.backScale + py / param1.map.height * (param1.frontScale - param1.backScale));
               this.scaleY = Number(this._scale) * (param1.backScale + py / param1.map.height * (param1.frontScale - param1.backScale));
               this.x = px;
               this.y = pz + py;
               if(py < 0)
               {
               ...
               {
                    if(Math.abs(Number(_loc3_[0]) - px) < 100)
                    {
               ...
               else if(this.unitNotToHit != null)
               {
                    ...
                    if(!Unit(this.unitNotToHit).checkForHitPoint(this.p3,Unit(this.unitNotToHit)) || _loc6_ > this.lastDistanceToCentre)
                    {
                         ...
                         if(this is Boulder)
                         {
                              Unit(this.unitNotToHit).applyVelocity(2 * Number(Util.sgn(_loc7_)));
                         }
                         _loc8_ = (_loc8_ = (_loc8_ = 0) | Number(Unit.D_ARROW) * (this.hasArrowDeath ? 1 : 0)) | Number(Unit.D_FIRE) * (this.isFire ? 1 : 0);
