     ...
     public class PoisonSpray extends Projectile
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               while(_loc7_ < _loc3_)
               {
                    ...
                    {
                         if(Math.pow(Number(Unit(_loc2_[_loc7_]).px) - _loc5_,2) + Math.pow(Number(Unit(_loc2_[_loc7_]).py) - _loc6_,2) < Math.pow(param1.xml.xml.Order.Units.magikill.poisonSpray.area,2))
                         {
