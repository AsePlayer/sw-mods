package com.brockw.stickwar.engine
{
     ...
     public class Hill extends Entity
     {
          ...
          private var goldCollectionRate:int;
          
          private var manaCollectionRate:int;
          ...
          public function Hill(param1:StickWar)
          {
               ...
               this.goldCollectionRate = param1.xml.xml.hill.goldCollectionRate;
               this.manaCollectionRate = param1.xml.xml.hill.manaCollectionRate;
          ...
          public function update(param1:StickWar) : void
          {
               ...
               if(param1.frame % this.collectionFrequency == 0)
               {
                    if(this.teamBar == 0)
                    {
                         param1.teamA.gold += this.goldCollectionRate;
                         param1.teamA.mana += this.manaCollectionRate;
                         if(param1.team == param1.teamA)
                         {
                              param1.incomeDisplay.addDisplay(param1,"+ " + this.goldCollectionRate,16776960,this.x - 20,this.y - this.height - 10);
                              param1.incomeDisplay.addDisplay(param1,"+ " + this.manaCollectionRate,47602,this.x + 30,this.y - this.height - 10);
                         }
                    }
                    else if(this.teamBar == 100)
                    {
                         param1.teamB.gold += this.goldCollectionRate;
                         param1.teamB.mana += this.manaCollectionRate;
               ...
               this.hillControlBar.update((this.teamBar - 50) / 100,47602);
