package com.brockw.stickwar.engine
{
     ...
     public class StickWar extends Simulation
     {
          ...
          private var _snow:com.brockw.stickwar.engine.Snow;
          ...
          public function initGame(param1:BaseMain, param2:GameScreen, param3:int = -1) : void
          {
               ...
               ++param1.loadingFraction;
               if(param2.main.campaign.currentLevel == 0)
               {
                    if(!this._rain)
                    {
                         this._rain = new com.brockw.stickwar.engine.Rain(this,20);
                    }
               }
               else if(param2.main.campaign.currentLevel != 0)
               {
                    if(!this._rain)
                    {
               ...
               if(param2.main.campaign.currentLevel == 1)
               {
                    if(!this._snow)
                    {
                         this._snow = new com.brockw.stickwar.engine.Snow(this,50);
                    }
               }
               else if(param2.main.campaign.currentLevel != 1)
               {
                    if(!this._snow)
                    {
                         this._snow = new com.brockw.stickwar.engine.Snow(this,0);
                    }
               }
               ++param1.loadingFraction;
               ...
               this._snow.mouseChildren = false;
               ++param1.loadingFraction;
          ...
          private function sortZ(param1:DisplayObjectContainer, param2:int = 20) : void
          {
               ...
               while(_loc4_ > 0)
               {
                    ...
                    while(_loc6_ < _loc4_)
                    {
                         if(param1.getChildAt(_loc6_) is com.brockw.stickwar.engine.Entity && param1.getChildAt(_loc6_ + 1) is com.brockw.stickwar.engine.Entity)
                         {
