package com.brockw.stickwar.engine
{
     ...
     public class RainDrop extends Entity
     {
          ...
          public static const RAIN_FALL_HEIGHT:Number = 10 * 60;
          
          public static const RAIN_FALL_VELOCITY:Number = 2 * 60;
          ...
          public function RainDrop(param1:StickWar)
          {
               ...
               this.rainDrop.scaleX *= 0.25;
               this.rainDrop.scaleY *= -0.25;
          ...
          {
               px = 10 + param1.screenX + param1.map.screenWidth * param1.random.nextNumber();
