package com.brockw.stickwar.engine.maps
{
     ...
     public class Map
     {
          ...
          public static const M_GOLD_RUSH:int = 9;
          
          public static const M_SUNSHINE_DESERT:int = 10;
          
          public static const M_NIGHT_GRASS_HILLS:int = 11;
          
          public static const maps:Array = [M_SWAMP_LANDS,M_GATES,M_CASTLE,M_HALLOWEEN,M_ICE_WORLD,M_DESERT,M_FOREST,M_GRASS_HILLS,M_GOLD_RUSH,M_SUNSHINE_DESERT,M_NIGHT_GRASS_HILLS];
          ...
          public static function getMapNameFromId(param1:int) : String
          {
               ...
               if(param1 == M_GOLD_RUSH)
               {
                    return "Gold Rush";
               }
               if(param1 == M_SUNSHINE_DESERT)
               {
                    return "Sunshine Desert";
               }
               if(param1 == M_NIGHT_GRASS_HILLS)
               {
                    return "Night Grass Hills";
               }
               return "Bad ID";
          }
          ...
          public static function getMapFromId(param1:int, param2:StickWar) : Map
          {
               ...
               if(param1 == M_NIGHT_GRASS_HILLS)
               {
                    return new NightGrassHills(param2);
               }
               if(param1 == M_SWAMP_LANDS)
               {
               ...
               if(param1 == M_SUNSHINE_DESERT)
               {
                    return new SunshineDesert(param2);
               }
               if(param1 == M_FOREST)
               {
