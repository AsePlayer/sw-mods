package com.brockw.stickwar.engine.maps
{
     ...
     public class GoldRush extends Map
     {
          ...
          public function GoldRush(param1:StickWar)
          {
               super();
               this.init(param1);
          }
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               createMiningBlock(param1,this.width / 2 + 800,1);
               createMiningBlock(param1,this.width / 2 + 450,1);
               createMiningBlock(param1,this.width / 2 + 100,1);
               createMiningBlock(param1,this.width / 2 - 800,-1);
               createMiningBlock(param1,this.width / 2 - 450,-1);
               createMiningBlock(param1,this.width / 2 - 100,-1);
