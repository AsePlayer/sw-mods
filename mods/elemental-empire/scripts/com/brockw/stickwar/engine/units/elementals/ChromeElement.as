package com.brockw.stickwar.engine.units.elementals
{
     ...
     public class ChromeElement extends Unit
     {
          ...
          override public function init(param1:StickWar) : void
          {
               ...
               this.scaleI = param1.xml.xml.Elemental.Units.chrome.growthIScale;
               ...
               this.outlineGlow.strength = 20;
               this.outlineGlow.color = 3407871;
          ...
          {
               if(this._convertSpellTimer.spellActivate(team) && param1.type != Unit.U_STATUE && param1.type != Unit.U_WALL && !param1.noConvert)
               {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(team.tech.isResearched(Tech.V_GROWTH) && !this.isCopy)
               {
                    if(_scale != this.scaleI)
                    {
                         health = param1.xml.xml.Elemental.Units.chrome.healthI - (maxHealth - health);
                         maxHealth = param1.xml.xml.Elemental.Units.chrome.healthI;
               ...
               if(this.vType == "v" && !this.setup)
               {
                    ...
                    this.population = 10;
                    _damageToArmour = 50;
                    _damageToNotArmour = 50;
                    this.outlineGlow.color = 65280;
                    this.setup = true;
               }
               if(this.vType == "v" && health > maxHealth / 4)
               {
                    this.outlineGlow.color = 65280;
               }
               else if(this.vType == "v" && health < maxHealth / 4)
               {
                    this.outlineGlow.color = 16711680;
               }
               ...
               ChromeElement.setItem(mc,"","White Shell ChromeHead","");
          }
          ...
          override public function setActionInterface(param1:ActionInterface) : void
          {
               ...
               if(!this.isCopy)
               {
                    ...
                    if(techTeam.tech.isResearched(Tech.POSSESS))
                    {
