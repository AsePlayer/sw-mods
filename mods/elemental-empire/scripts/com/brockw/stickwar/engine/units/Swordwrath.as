package com.brockw.stickwar.engine.units
{
     ...
     public class Swordwrath extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.sType == "s")
               {
                    com.brockw.stickwar.engine.units.Swordwrath.setItem(_swordwrath(mc),"Elvish Sword","","");
               }
               ...
               {
                    com.brockw.stickwar.engine.units.Swordwrath.setItem(_swordwrath(mc),"Elvish Sword","Stone","");
               }
               else if(!hasDefaultLoadout)
               {
                    com.brockw.stickwar.engine.units.Swordwrath.setItem(_swordwrath(mc),"","","");
               }
          }
