package com.brockw.stickwar.engine.units
{
     ...
     public class Archer extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               if(this.fType == "f" && !this.setupComplete)
               {
               ...
               else if(isDead == false)
               {
                    ...
                    if(this.fType == "f")
                    {
                         param1.projectileManager.initNuke(px,py,this,67,0.62,75);
                         this.team.removeUnitCompletely(this,param1);
                    }
                    if(_isDualing)
                    {
               ...
               if(this.isCastleArcher)
               {
                    Archer.setItem(mc,"Default","Basic Helmet","");
               }
