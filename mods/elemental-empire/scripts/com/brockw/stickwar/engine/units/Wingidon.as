package com.brockw.stickwar.engine.units
{
     ...
     public class Wingidon extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(team.isEnemy)
               {
                    if(team.game.main.campaign.difficultyLevel == 3 && !enemyBuff)
                    {
                         maxHealth = 105;
                         health = 105;
                         maxHealth = maxHealth;
                         ...
                         _damageToArmour = 7;
                         _damageToNotArmour = 16;
                         enemyBuff = true;
                    }
                    else if(team.game.main.campaign.difficultyLevel == 2 && !enemyBuff)
                    {
                         _damageToArmour = 6;
                         _damageToNotArmour = 14;
                         enemyBuff = true;
                    }
                    else if(team.game.main.campaign.difficultyLevel == 1 && !enemyBuff)
                    {
                         maxHealth = 75;
                         health = 75;
                         maxHealth = maxHealth;
