package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          public var isSurrender:Boolean;
          ...
          private var royalGlow:GlowFilter;
          ...
          public var enemyBuff:Boolean;
          
          public var noConvert:Boolean;
          
          public var royal:Boolean;
          
          public var deadWake:Boolean;
          
          protected var _aidArmy:Boolean;
          
          protected var _alwaysAttack:Boolean;
          
          protected var _isStupidAir:Boolean;
          
          public var justMinion:Boolean;
          ...
          public function Unit(param1:StickWar)
          {
               ...
               var _loc2_:Number = 16711935;
               var _loc7_:Number = BitmapFilterQuality.LOW;
               this.royalGlow = new GlowFilter(16751001,1,36,18,2.64,_loc7_,false,false);
          ...
          override public function drawOnHud(param1:MovieClip, param2:StickWar) : void
          {
               ...
               else if(selected && !this.aidArmy)
               {
                    MovieClip(param1).graphics.lineStyle(2,65280,1);
               }
               else if(this.aidArmy)
               {
                    MovieClip(param1).graphics.lineStyle(2,13311,1);
               }
               else
               {
          ...
          protected function updateCommon(param1:StickWar) : void
          {
               ...
               else if(this.deadWake)
               {
                    _loc2_.greenOffset = 75;
               }
               else if(this.alwaysAttack)
               {
                    _loc4_ = new AttackMoveCommand(team.game);
                    _loc4_.type = UnitCommand.ATTACK_MOVE;
                    _loc4_.goalX = team.enemyTeam.statue.px;
                    _loc4_.goalY = py;
                    _loc4_.realX = team.enemyTeam.statue.px;
                    _loc4_.realY = _loc4_.goalY;
                    ai.setCommand(team.game,_loc4_);
               ...
               else if(this.aidArmy)
               {
                    ...
                    _loc2_.greenOffset = 51;
               }
               else if(this.justMinion)
               {
                    this.population = 0;
                    this.alwaysAttack = true;
                    this.isInteractable = false;
                    WEAPON_REACH = param1.xml.xml.Order.Units.swordwrath.weaponReach / 2;
                    this._maxHealth /= 3;
                    this._health = this._maxHealth;
                    this.healthBar.totalHealth = this._maxHealth;
                    _scale = param1.xml.xml.Chaos.Units.bomber.scale / 1.25;
                    _maxForce /= 1.25;
                    population = 0;
               }
               else
               {
                    ...
                    {
                         _loc2_.greenOffset = 510;
                         _loc2_.blueOffset = 510;
                    }
                    else
                    {
                         _loc2_.greenOffset = 0;
                    ...
                    if(this.team == param1.team.enemyTeam)
                    {
                         _loc2_.redOffset = 75;
                    }
                    else
               ...
               {
                    this.mc.mc.filters = [this.royalGlow];
               }
          ...
          public function updateSelected() : void
          {
               ...
               {
                    this.drawSelected(13311,this.isBusy() ? Number(3) : Number(1),this.isBusy() ? 255 : 13311);
               }
               else
               {
                    this.removedSelected();
          ...
          protected function updateMotion(param1:StickWar) : void
          {
               ...
               px += this._dx;
               py += this._dy;
               for each(_loc3_ in this.team.enemyTeam.walls)
               {
                    if(px < _loc3_.px + 7.5 && px > _loc3_.px - 7.5)
                    {
                         px = _loc3_.px - 7.5 * this.team.direction;
                    }
               }
               if(px < 0 + 7.5)
               {
          ...
          protected function checkForHit() : Boolean
          {
               ...
               if(_loc1_.checkForHitPoint(_loc3_,_loc1_))
               {
                    ...
                    if(this.isVampUnit)
                    {
                         this.heal(1,this.damageToDeal / 1.69);
                         this.cure();
                    }
                    if(this.poisonUnit)
                    {
          ...
          override public function damage(param1:int, param2:Number, param3:Entity, param4:Number = 1) : void
          {
               ...
               if(this.isTargetable() && !this.isDualing)
               {
                    ...
                    if(this.isProtected())
                    {
                         ...
                         _loc5_ *= TeamElemental.protectionAmount;
                    }
                    if(this.reaperCurseFrames > 0)
                    {
          ...
          public function get alwaysAttack() : Boolean
          {
               return this._alwaysAttack;
          }
          
          public function set alwaysAttack(param1:Boolean) : void
          {
               this._alwaysAttack = param1;
          }
          
          public function get isStupidAir() : Boolean
          {
               return this._isStupidAir;
          }
          
          public function set isStupidAir(param1:Boolean) : void
          {
               this._isStupidAir = param1;
          }
          
          public function get aidArmy() : Boolean
          {
               return this._aidArmy;
          }
          
          public function set aidArmy(param1:Boolean) : void
          {
               this._aidArmy = param1;
          }
