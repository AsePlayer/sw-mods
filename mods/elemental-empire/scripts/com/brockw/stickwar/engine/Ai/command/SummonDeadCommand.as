package com.brockw.stickwar.engine.Ai.command
{
     ...
     public class SummonDeadCommand extends UnitCommand
     {
          ...
          public function SummonDeadCommand(param1:StickWar)
          {
               super();
               type = UnitCommand.SUMMON_DEAD;
               hotKey = 69;
               _hasCoolDown = true;
               ...
               {
                    this.game = param1;
                    this.loadXML(param1.xml.xml.Chaos.Units.skelator.summon);
                    this.range = param1.xml.xml.Chaos.Units.skelator.summon.range;
                    this.area = param1.xml.xml.Chaos.Units.skelator.summon.area;
               }
          }
          ...
          {
               return Skelator(param1).summonDeadCooldown();
          }
          
          override public function isFinished(param1:Unit) : Boolean
          {
               return Skelator(param1).summonDeadCooldown() != 0;
          }
