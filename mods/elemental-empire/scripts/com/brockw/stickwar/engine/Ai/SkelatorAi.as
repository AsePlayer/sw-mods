package com.brockw.stickwar.engine.Ai
{
     ...
     public class SkelatorAi extends UnitAi
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               else if(currentCommand.type == UnitCommand.SUMMON_DEAD)
               {
                    if(!this.currentCommand.inRange(unit))
                    {
                         unit.mayWalkThrough = true;
                    ...
                    {
                         Skelator(unit).fistAttack(SummonDeadCommand(currentCommand).realX,SummonDeadCommand(currentCommand).realY);
                         nextMove(param1);
                    }
               }
