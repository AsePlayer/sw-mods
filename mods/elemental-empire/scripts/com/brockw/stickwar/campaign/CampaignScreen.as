package com.brockw.stickwar.campaign
{
     ...
     public class CampaignScreen extends Screen
     {
          ...
          {
               this.main.soundManager.playSoundInBackground("elementalInGame");
          ...
          {
               var _loc2_:URLRequest = new URLRequest("https://www.aseplayer.com/flash-games");
               navigateToURL(_loc2_,"_blank");
               if(this.main.tracker)
               {
                    this.main.tracker.trackEvent("link","https://www.aseplayer.com/flash-games");
               }
