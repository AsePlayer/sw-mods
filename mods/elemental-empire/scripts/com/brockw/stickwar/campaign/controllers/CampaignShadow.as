package com.brockw.stickwar.campaign.controllers
{
     ...
     public class CampaignShadow extends CampaignController
     {
          ...
          private function skipTutorialClick(param1:Event) : void
          {
               ...
               _loc2_.team.spawnUnitGroup([Unit.U_MINER_ELEMENT,Unit.U_MINER_ELEMENT,Unit.U_MINER_ELEMENT,Unit.U_EARTH_ELEMENT,Unit.U_EARTH_ELEMENT,Unit.U_EARTH_ELEMENT]);
          ...
          override public function update(param1:GameScreen) : void
          {
               ...
               if(this.state == S_SET_UP)
               {
                    ...
                    _loc3_ = param1.game;
                    _loc4_ = WaterElement(_loc3_.unitFactory.getUnit(Unit.U_WATER_ELEMENT));
                    param1.team.spawn(_loc4_,_loc3_);
                    _loc4_.px = param1.team.homeX + 2000 * param1.team.direction;
                    _loc4_.py = _loc3_.map.height / 1;
               ...
               else if(this.state == S_BUILD_UNIT)
               {
                    ...
                    {
                         this.message.setMessage("Earth is a basic infantry unit. Once finished training, he will appear from the castle gates.","",0,"voiceTutorial12");
                         this.arrow.visible = false;
                    }
                    else if(!this.hasShownBuildSwordwrath)
                    {
                         this.message.setMessage("Click the icon below to build a Earth unit.","Step #9",0,"voiceTutorial11",true);
                         this.arrow.x = 50;
               ...
               else if(this.state == S_SHOW_ENEMY)
               {
                    ...
                    this.message.setMessage("A Knight is attacking!","",0,"voiceTutorial13");
                    this.arrow.visible = false;
               }
               ...
               else if(this.state == S_CLICK_ON_ARCHERY_RANGE)
               {
                    ...
                    this.message.setMessage("Click on the Air Range building.","Step #11",250,"voiceTutorial16");
               ...
               else if(this.state == S_UPGRADE_CASTLE_ARCHER)
               {
                    ...
                    this.message.setMessage("Click the icon below to build a Castle Air.","Step #12",0,"voiceTutorial17",true);
                    param1.game.targetScreenX = 0;
               ...
               else if(this.state == S_SEND_IN_SPEARTON)
               {
                    ...
                    this.message.setMessage("Hit the defend button below to send out your units, then press Backspace and right click on this enemy unit to kill him or you will be trapped in this tutorial","Step #13",0,"voiceTutorial19",true);
               ...
               {
                    param1.userInterface.isGlobalsEnabled = false;
                    this.message.setMessage("Use your forces to defend against the invading Knight.","Step #14",0,"voiceTutorial20");
                    this.message.visible = true;
                    this.arrow.visible = true;
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && this.s1.selected == true)
                    {
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && this.s1.px < 2500)
                    {
               ...
               {
                    if(Boolean(this.message.hasFinishedPlayingSound()) && param1.team.currentAttackState == Team.G_DEFEND)
                    {
