package com.brockw.stickwar.campaign
{
     ...
     public class EndOfGameSummary extends Screen
     {
          ...
          override public function enter() : void
          {
               ...
               var _loc1_:int = 0;
               var _loc2_:int = 0;
               this.summaryMc.endOfGameText.text += "Congratulations, you have finish Stick War II: Elemental Empire Campaign in ";
               if(this.main.campaign.difficultyLevel == Campaign.D_NORMAL)
               {
                    this.summaryMc.endOfGameText.text += "NEWBIE mode!\n";
                    this.main.kongregateReportStatistic("you have finish Stick War II: Elemental Empire Campaign in Normal",1);
               }
               else if(this.main.campaign.difficultyLevel == Campaign.D_HARD)
               {
                    this.summaryMc.endOfGameText.text += "GAMER mode!\n";
                    this.main.kongregateReportStatistic("you have finish Stick War II: Elemental Empire Campaign in Hard",1);
               }
               else if(this.main.campaign.difficultyLevel == Campaign.D_INSANE)
               {
                    this.summaryMc.endOfGameText.text += "EXPERT mode!\n";
                    this.main.kongregateReportStatistic("you have finish Stick War II: Elemental Empire Campaign in Insane",1);
               }
               var _loc3_:int = 0;
               var _loc4_:int = 0;
               _loc5_ = 0;
               ...
               this.summaryMc.endOfGameText.text += "\n" + "You need wait for new update ";
               if(this.main.campaign.difficultyLevel == Campaign.D_NORMAL)
               {
                    this.summaryMc.endOfGameText.text += "or try GAMER mode!";
               }
               else if(this.main.campaign.difficultyLevel == Campaign.D_HARD)
               {
                    this.summaryMc.endOfGameText.text += "or try EXPERT mode!";
               }
               else if(this.main.campaign.difficultyLevel == Campaign.D_INSANE)
               {
                    this.summaryMc.endOfGameText.text += "";
