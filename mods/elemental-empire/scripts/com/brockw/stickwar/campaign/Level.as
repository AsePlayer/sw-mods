package com.brockw.stickwar.campaign
{
     ...
     public class Level
     {
          ...
          private var _tipHard:String;
          
          private var _tipInsane:String;
          ...
          public function Level(param1:XML)
          {
               ...
               else if(_loc2_ == "CampaignMarrowkai")
               {
                    this.controller = CampaignMarrowkai;
               }
               else if(_loc2_ == "CampaignOne")
               {
                    this.controller = CampaignOne;
               }
               else if(_loc2_ == "CampaignRebels")
               {
                    this.controller = CampaignRebels;
               }
               this.unlocks = [];
               ...
               this.tip = param1.tip;
               this.tipHard = param1.tipHard;
               this.tipInsane = param1.tipInsane;
               this.totalTime = 0;
               this.bestTime = -1;
               this.retries = 0;
          ...
          public function get tipHard() : String
          {
               return this._tipHard;
          }
          
          public function set tipHard(param1:String) : void
          {
               this._tipHard = param1;
          }
          
          public function get tipInsane() : String
          {
               return this._tipInsane;
          }
          
          public function set tipInsane(param1:String) : void
          {
               this._tipInsane = param1;
          }
