     ...
     public class CampaignMenuScreen extends Screen
     {
          ...
          public function handleComplete(param1:Event) : void
          {
               ...
               if(_loc2_ != "")
               {
                    ...
                    this.youtubeLoader = new com.brockw.stickwar.campaign.YoutubeLoader(_loc2_);
                    addChild(this.youtubeLoader);
               }
          }
          ...
          {
               var _loc2_:URLRequest = new URLRequest("https://www.aseplayer.com/sw2-mods");
               navigateToURL(_loc2_,"_blank");
               if(this.main.tracker != null)
               {
                    this.main.tracker.trackEvent("link","https://www.aseplayer.com/sw2-mods");
               }
          }
          
          private function stickWarButton(param1:Event) : void
          {
               var _loc2_:URLRequest = new URLRequest("https://discord.gg/6sMasJk68z");
               navigateToURL(_loc2_,"_blank");
               if(this.main.tracker != null)
               {
                    this.main.tracker.trackEvent("link","https://discord.gg/6sMasJk68z");
               }
          }
          ...
          private function creditsButton(param1:Event) : void
          {
               ...
               this.mc.creditsScreen.credits.text = this.main.xml.xml.update;
          }
