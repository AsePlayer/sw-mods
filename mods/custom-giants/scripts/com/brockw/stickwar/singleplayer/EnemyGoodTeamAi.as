package com.brockw.stickwar.singleplayer
{
     ...
     public class EnemyGoodTeamAi extends EnemyTeamAi
     {
          ...
          private var rageSpell:SwordwrathRageCommand;
          ...
          public function EnemyGoodTeamAi(param1:Team, param2:BaseMain, param3:StickWar, param4:* = true)
          {
               ...
               var _loc6_:* = [Unit.U_ENSLAVED_GIANT,Unit.U_MAGIKILL,Unit.U_FLYING_CROSSBOWMAN,Unit.U_SPEARTON,Unit.U_SWORDWRATH,Unit.U_ARCHER,Unit.U_MONK,Unit.U_NINJA];
               this.buildOrder = [];
               for each(_loc5_ in _loc6_)
               {
                    if(param1.unitsAvailable == null || _loc5_ in param1.unitsAvailable)
                    {
                         this.buildOrder.push(_loc5_);
                    }
               }
               ...
               this.rageSpell = new SwordwrathRageCommand(param3);
