package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class ChaosFletchersBuilding extends Building
     {
          ...
          override public function setActionInterface(param1:ActionInterface) : void
          {
               ...
               {
                    param1.setAction(1,1,Tech.GIANT_GROWTH_I);
               }
               else if(!tech.isResearched(Tech.GIANT_GROWTH_II))
               {
                    param1.setAction(1,1,Tech.GIANT_GROWTH_II);
               }
               if(!tech.isResearched(Tech.DEAD_POISON))
               {
                    param1.setAction(0,1,Tech.DEAD_POISON);
               }
               if(!tech.isResearched(Tech.ARCHIDON_FIRE))
               {
                    param1.setAction(1,0,Tech.ARCHIDON_FIRE);
               }
