package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class ChaosTech extends Tech
     {
          ...
          public function initUpgrades(param1:StickWar, param2:TeamChaos) : void
          {
               ...
               this.addNewUpgrade(SWORDWRATH_RAGE,this.game.xml.xml.Order.Tech.rage,new Bitmap(new SwordwrathSacrifice()),69);
               this.addNewUpgrade(CLOAK,this.game.xml.xml.Order.Tech.cloak,new Bitmap(new NinjaCloak1()),90);
               this.addNewUpgrade(CLOAK_II,this.game.xml.xml.Order.Tech.cloak2,new Bitmap(new NinjaCloak2()),90);
               this.addNewUpgrade(GIANT_GROWTH_I,this.game.xml.xml.Order.Tech.giantSize1,new Bitmap(new GiantGrowth1Bitmap()),81);
               this.addNewUpgrade(GIANT_GROWTH_II,this.game.xml.xml.Order.Tech.giantSize2,new Bitmap(new GiantGrowth2Bitmap()),87);
               this.addNewUpgrade(MINER_WALL,this.game.xml.xml.Order.Tech.minerWall,new Bitmap(new OrderTowerBitmap()),87);
               ...
               this.addNewUpgrade(MONK_CURE,this.game.xml.xml.Order.Tech.cure,new Bitmap(new CureBitmap()),81);
