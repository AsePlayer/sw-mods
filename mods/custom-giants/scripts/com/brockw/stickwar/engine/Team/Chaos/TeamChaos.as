package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class TeamChaos extends Team
     {
          ...
          public function TeamChaos(param1:StickWar, param2:int, param3:Dictionary = null, param4:* = 1, param5:Number = 1)
          {
               ...
               _loc6_.addChild(new chaosCastle());
               castleFront = _loc6_;
               _loc6_ = new Entity();
               _loc6_.addChild(new chaosCastleBack());
               castleBack = _loc6_;
          ...
          override public function spawnMiners() : void
          {
               ...
               _loc2_ = game.unitFactory.getUnit(Unit.U_CHAOS_MINER);
               spawn(_loc1_,game);
               spawn(_loc2_,game);
          ...
          override public function initTeamButtons(param1:GameScreen) : void
          {
               ...
               buttonInfoMap[Unit.U_MONK] = [param1.userInterface.hud.hud.bomberButton,param1.userInterface.hud.hud.bomberOverlay,param1.game.xml.xml.Order.Units.monk,0,new cancelButton(),game.xml.xml.Order.Units.monk.gold,new MovieClip(),param1.userInterface.hud.hud.skeletalHighlight,null];
