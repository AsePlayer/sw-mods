class AiSquad
{
     ...
     function AiSquad(castle, statue, statueHitArea, friends, oponents, baseX, baseY, name, game, technology)
     {
          ...
          else if(this.teamName == "black")
          {
               _loc12_ = undefined;
               _loc12_ = new Color(castle);
               _loc12_.setTint(0,0,100,60);
          }
          else if(this.teamName == "yellow")
          {
               _loc12_ = undefined;
               _loc12_ = new Color(castle);
               _loc12_.setTint(100,100,0,60);
          }
     ...
     function addMan(man)
     {
          ...
          {
               man.walk(4,0);
               _loc3_.setTint(0,0,100,60);
          }
          else if(this.teamName == "yellow")
          {
               man.walk(-4,0);
               _loc3_.setTint(100,100,0,60);
          }
          else
          {
               man.walk(-4,0);
     ...
     function canAddMan()
     {
          if(this.getNumberLiving() + this.queue.size() < 30)
          {
               return true;
          }
          if(this.teamName == "blue")
