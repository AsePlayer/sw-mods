class Spartan extends Man
{
     ...
     function Spartan(x, y, squad, simUnits, game)
     {
          ...
          this.isGoldenSpearton = false;
          this.isGlacialSpearton = false;
          this.isGiantNative = false;
          this.isWartornAtreyos = false;
          this.isGlacialSpearos = false;
          this.isFisherAtreyos = false;
          this.isWartornSpearos = false;
          this.isWoodlandSpearton = false;
     ...
     function update()
     {
          ...
          else if(this.isGlacialSpearton)
          {
               if(this.hasThrown)
               {
                    this.clip.weapon = 2;
          ...
          else if(this.isWoodlandSpearton)
          {
               if(this.hasThrown)
               {
                    this.clip.weapon = 2;
          ...
          if(!this.isAlive)
          {
               if(this.isFisherAtreyos)
               {
                    if(this.canRespawn)
                    {
                         _loc4_ = this.squad.addSpartan();
                         _loc4_.setX(this.x + 10 * this.squad.getTeamDirection());
                         _loc4_.setY(this.y);
                         this.minions.push(_loc4_);
                         _loc4_.setAsWartornAtreyos();
     ...
     function setAsGoldenSpearton()
     {
          this.baseScale *= 0.93;
          this.MAX_HEALTH *= 5;
          this.health *= 5;
          this.isGoldenSpearton = true;
     }
     function setAsGlacialSpearton()
     {
          this.MAX_HEALTH *= 2.75;
          this.health *= 2.75;
          this.isGlacialSpearton = true;
          this.WALK_MODIFIER = 2.5;
     }
     function setAsGiantNative()
     {
          this.baseScale *= 0.7;
          this.MAX_HEALTH *= 6;
          this.health *= 6;
          this.isGiantNative = true;
     }
     function setAsWartornAtreyos()
     {
          this.baseScale *= 0.9;
          this.MAX_HEALTH *= 8;
          this.health *= 8;
          this.isWartornAtreyos = true;
     }
     function setAsGlacialSpearos()
     {
          this.baseScale *= 0.9;
          this.MAX_HEALTH *= 7;
          this.health *= 7;
          this.isGlacialSpearos = true;
     }
     function setAsFisherAtreyos()
     {
          this.baseScale *= 0.9;
          this.MAX_HEALTH *= 6;
          this.health *= 6;
          this.isFisherAtreyos = true;
     }
     function setAsWartornSpearos()
     {
          this.baseScale *= 0.9;
          this.MAX_HEALTH *= 6;
          this.health *= 6;
          this.isWartornSpearos = true;
     }
     function setAsWoodlandSpearton()
     {
          this.WALK_MODIFIER = 1.75;
          this.MAX_HEALTH *= 1.5;
          this.health *= 1.5;
          this.MAX_VELOCITY *= 1.5;
          this.MAX_ACCELERATION *= 1.5;
          this.isWoodlandSpearton = true;
     }
