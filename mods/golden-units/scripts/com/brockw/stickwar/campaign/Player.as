package com.brockw.stickwar.campaign
{
     ...
     public class Player
     {
          ...
          public function Player(param1:XMLList)
          {
               ...
               if(this.race == "Elemental")
               {
                    this.unitsAvailable[Unit.U_MINER_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_EARTH_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_WATER_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_AIR_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_FIRE_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_LAVA_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_CHROME_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_HURRICANE_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_TREE_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_FIRESTORM_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_SCORPION_ELEMENT] = 1;
                    this.unitsAvailable[Unit.U_SANDSTORM] = 1;
                    this.unitsAvailable[Unit.U_STEAM_EXPLOSION] = 1;
               }
               this.statue = "default";
