     ...
     public class CampaignGameScreen extends GameScreen
     {
          ...
          override public function enter() : void
          {
               ...
               if(main.campaign.getCurrentLevel().hasInsaneWall && main.campaign.difficultyLevel == Campaign.D_INSANE)
               {
                    ...
                    {
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 1600)).setConstructionAmount(1);
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 1100)).setConstructionAmount(1);
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 1500)).setConstructionAmount(1);
                         (_loc10_ = team.enemyTeam.addWall(team.enemyTeam.homeX - 340)).setConstructionAmount(1);
                    }
                    else
                    {
                         ...
                         _loc11_.px = team.enemyTeam.homeX - 1500;
                         ...
                         team.enemyTeam.spawn(_loc11_,game);
                         _loc11_.scaleX *= team.enemyTeam.direction * -1;
                         _loc11_.px = team.enemyTeam.homeX - 1800;
                         _loc11_.py = game.map.height / 2;
                         _loc11_.setConstructionAmount(1);
                         _loc11_ = ChaosTower(game.unitFactory.getUnit(int(Unit.U_CHAOS_TOWER)));
                         team.enemyTeam.spawn(_loc11_,game);
