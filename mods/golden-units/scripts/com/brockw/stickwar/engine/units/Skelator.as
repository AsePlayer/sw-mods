package com.brockw.stickwar.engine.units
{
     ...
     public class Skelator extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          private var SpeedDead:com.brockw.stickwar.engine.units.Dead;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    this._fistDamage = this._fistDamage / 3 * team.game.main.campaign.difficultyLevel + 1;
                    health = health / 4.5 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
