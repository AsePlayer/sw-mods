package com.brockw.stickwar.engine.units
{
     ...
     public class Archer extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               {
                    _damageToNotArmour = _damageToNotArmour / 3.3 * team.game.main.campaign.difficultyLevel + 1;
                    _damageToArmour = _damageToArmour / 4.1 * team.game.main.campaign.difficultyLevel + 1;
                    health = Number(param1.xml.xml.Order.Units.archer.health) / 2.9 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               {
                    noStone = true;
                    com.brockw.stickwar.engine.units.Archer.setItem(mc,"","Withered Helmet","");
                    maxHealth = 10000;
                    health = 10000;
                    maxHealth = maxHealth;
                    this.areaDamage = 0;
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.archerType == "SW3CA" || this.archerType == "SW3CA_2" || this.archerType == "SW3CA_3" || this.archerType == "SW3CA_4" || this.archerType == "SplashKytchu_2" || this.archerType == "SplashKytchu" || this.archerType == "Clone_4" || this.archerType == "Clone_5" || this.archerType == "Clone_6")
                    {
                         stunTimeLeft = 0;
                    }
               ...
               else if(isDead == false)
               {
                    ...
                    {
                         param1.projectileManager.initNuke(px,py,this,25,0.3,400);
                    }
                    isDead = true;
                    if(_isDualing)
                    {
          ...
          {
               if(this.inBlock || this.archerType == "StoneArcher" || this.archerType == "Kytchu" || this.archerType == "DarkKytchu" || this.archerType == "Kytchu_2")
               {
