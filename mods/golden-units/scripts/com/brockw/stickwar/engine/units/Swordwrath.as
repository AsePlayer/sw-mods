package com.brockw.stickwar.engine.units
{
     ...
     public class Swordwrath extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               {
                    _damageToNotArmour = _damageToNotArmour / 3 * team.game.main.campaign.difficultyLevel;
                    _damageToArmour = _damageToArmour / 3 * team.game.main.campaign.difficultyLevel;
                    maxHealth = health;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
                    enemyBuffed = true;
               }
               if(this.swordwrathType == "Wrathnar" || this.swordwrathType == "Wrathnar_2")
               {
               ...
               if(isCustomUnit == true)
               {
                    ...
                    else if(this.swordwrathType == "Savagesickle" || this.swordwrathType == "Leafsickle")
                    {
               ...
               if(this.swordwrathType == "Savagesickle" || this.swordwrathType == "NativeXeno" || this.swordwrathType == "GoldSword" || this.swordwrathType == "Xiphos_2" || this.swordwrathType == "Wrathnar_2" || this.swordwrathType == "Xenophon" || this.swordwrathType == "Xiphos" || this.swordwrathType == "Wrathnar" || this.swordwrathType == "SickleGeneral" || this.swordwrathType == "SickleLeader" || this.swordwrathType == "Baron")
               {
               ...
               if(this.swordwrathType == "Icesickle")
               {
                    this.normalMaxVelocity = 6.8;
               }
               if(this.rageSpell.inEffect())
               {
               ...
               if(!isDieing)
               {
                    ...
                    else if(_state == S_ATTACK)
                    {
                         ...
                         if(this.swordwrathType == "Sicklewrath" || this.swordwrathType == "SickleGeneral" || this.swordwrathType == "SickleLeader" || this.swordwrathType == "Leafsickle" || this.swordwrathType == "Icesickle" || this.swordwrathType == "Savagesickle" || this.swordwrathType == "Lavasickle" || this.swordwrathType == "Vampsickle")
                         {
                         ...
                         if(this.swordwrathType == "Savagesickle" || this.swordwrathType == "SickleLeader")
                         {
                              MovieClip(_mc.mc).nextFrame();
                         }
                    }
          ...
          {
               if(this.inBlock || this.swordwrathType == "GoldSword")
               {
