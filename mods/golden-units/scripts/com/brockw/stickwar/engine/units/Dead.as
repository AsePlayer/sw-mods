     ...
     public class Dead extends RangedUnit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(team.isEnemy && !enemyBuffed && !this.isCastleArcher)
               {
                    ...
                    _damageToArmour = _damageToArmour / 3.5 * team.game.main.campaign.difficultyLevel + 1;
                    health = health / 1.6 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
