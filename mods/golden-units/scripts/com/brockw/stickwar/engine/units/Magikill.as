package com.brockw.stickwar.engine.units
{
     ...
     public class Magikill extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               updateCommon(param1);
               noStone = true;
               if(this.magikillType == "IceMage" || this.magikillType == "SW1Mage")
               {
               ...
               {
                    _damageToNotArmour = _damageToNotArmour / 2.8 * team.game.main.campaign.difficultyLevel + 1;
                    _damageToArmour = _damageToArmour / 2.8 * team.game.main.campaign.difficultyLevel + 1;
                    this.explosionDamage = this.explosionDamage / 1.8 * team.game.main.campaign.difficultyLevel + 1;
                    health = Number(param1.xml.xml.Order.Units.magikill.health) / 3.3 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               if(!isDieing)
               {
                    ...
                    else if(this.isNuking == true)
                    {
                         ...
                         {
                              if(this.magikillType == "Default" || this.magikillType == "LeafMage" || this.magikillType == "SW1Mage" || this.magikillType == "SW3Mage")
                              {
                              ...
                              else if(this.magikillType == "LeafMage")
                              {
                                   ...
                                   this.castSpellGlow.color = 52480;
                                   this.mc.filters = [this.castSpellGlow];
                                   this.radiantRange = 420;
                              }
                         }
                    ...
                    else if(this.isStunning == true)
                    {
                         ...
                         {
                              if(this.magikillType == "Default" || this.magikillType == "LeafMage")
                              {
               ...
               else if(isDead == false)
               {
                    ...
                    {
                         param1.projectileManager.initNuke(px,py,this,80,0.8,1000);
                    }
                    isDead = true;
                    if(_isDualing)
                    {
