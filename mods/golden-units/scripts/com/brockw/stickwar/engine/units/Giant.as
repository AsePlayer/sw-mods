package com.brockw.stickwar.engine.units
{
     ...
     public class Giant extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               {
                    _damageToNotArmour = _damageToNotArmour / 3.1 * team.game.main.campaign.difficultyLevel + 1;
                    _damageToArmour = _damageToArmour / 3.4 * team.game.main.campaign.difficultyLevel + 1;
                    health = health / 3.5 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
          ...
          {
               if(this.inBlock || this.giantType == "Griffin" || this.giantType == "Default")
               {
