package com.brockw.stickwar.engine.units
{
     ...
     public class Medusa extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          private var electricBomber:com.brockw.stickwar.engine.units.Bomber;
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               {
                    _damageToNotArmour = _damageToNotArmour / 2.1 * team.game.main.campaign.difficultyLevel + 1;
                    _damageToArmour = _damageToArmour / 2.1 * team.game.main.campaign.difficultyLevel + 1;
                    health = health / 2.1 * (team.game.main.campaign.difficultyLevel + 1);
                    maxHealth = health;
                    maxHealth = maxHealth;
