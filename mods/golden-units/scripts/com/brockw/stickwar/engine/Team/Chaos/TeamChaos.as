package com.brockw.stickwar.engine.Team.Chaos
{
     ...
     public class TeamChaos extends Team
     {
          ...
          override public function detectedUserInput(param1:UserInterface) : void
          {
               ...
               singlePlayerDebugInputSwitch(param1,Unit.U_SPEARTON,52);
               singlePlayerDebugInputSwitch(param1,Unit.U_NINJA,53);
               singlePlayerDebugInputSwitch(param1,Unit.U_ARCHER,54);
          ...
          override public function initTeamButtons(param1:GameScreen) : void
          {
               ...
               buttonInfoMap[Unit.U_CHAOS_MINER] = [param1.userInterface.hud.hud.minerButton,param1.userInterface.hud.hud.minerOverlay,param1.game.xml.xml.Chaos.Units.miner,0,new cancelButton(),game.xml.xml.Chaos.Units.miner.cost * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
               buttonInfoMap[Unit.U_SWORDWRATH] = [param1.userInterface.hud.hud.catButton,param1.userInterface.hud.hud.catOverlay,param1.game.xml.xml.Order.Units.swordwrath,0,new cancelButton(),game.xml.xml.Order.Units.swordwrath.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
               ...
               buttonInfoMap[Unit.U_ARCHER] = [param1.userInterface.hud.hud.bomberButton,param1.userInterface.hud.hud.bomberOverlay,param1.game.xml.xml.Order.Units.archer,0,new cancelButton(),game.xml.xml.Order.Units.archer.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.archerHighlight,param1.userInterface.hud.hud.archerUnderlay];
               buttonInfoMap[Unit.U_NINJA] = [param1.userInterface.hud.hud.medusaButton,param1.userInterface.hud.hud.medusaOverlay,param1.game.xml.xml.Order.Units.ninja,0,new cancelButton(),game.xml.xml.Order.Units.ninja.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
               buttonInfoMap[Unit.U_SPEARTON] = [param1.userInterface.hud.hud.skeletalButton,param1.userInterface.hud.hud.skeletonOverlay,param1.game.xml.xml.Order.Units.spearton,0,new cancelButton(),game.xml.xml.Order.Units.spearton.gold * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
               ...
               buttonInfoMap[Unit.U_GIANT] = [param1.userInterface.hud.hud.giantButton,param1.userInterface.hud.hud.giantOverlay,param1.game.xml.xml.Chaos.Units.giant,0,new cancelButton(),game.xml.xml.Chaos.Units.giant.cost * handicap,new MovieClip(),param1.userInterface.hud.hud.barracksHighlight,param1.userInterface.hud.hud.barracksUnderlay];
