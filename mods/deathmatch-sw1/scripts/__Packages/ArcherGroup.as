     ...
     function attack(forwardPos)
     {
          ...
          for(_loc2_ in this.men)
          {
               ...
               if(this.men[_loc2_].instance != this.game.getCurrentCharacter())
               {
                    ...
                    {
                         if(!this.men[_loc2_].target.getIsAlive() || this.men[_loc2_].target == undefined || !Math.abs(this.men[_loc2_].target.x - this.men[_loc2_].instance.x) < this.men[_loc2_].instance.getARCHER() || !Math.abs(this.men[_loc2_].target.y - this.men[_loc2_].instance.y) < 50)
                         {
                    ...
                    if(this.squad.getMode() == this.DEFEND && this.squad.getTeamDirection() * this.men[_loc2_].instance.getX() > this.squad.getTeamDirection() * forwardPos)
                    {
                         this.men[_loc2_].target = undefined;
                    }
                    if(this.squad.getMode() == this.ATTACK && this.men[_loc2_].target == undefined && Math.abs(this.squad.getEnemyTeam().getCastleHitArea()._x - this.men[_loc2_].instance.x) < this.men[_loc2_].instance.getARCHER_RANGE())
                    {
                         this.men[_loc2_].state = 2;
                         this.men[_loc2_].instance.faceDirection((this.squad.getEnemyTeam().getCastleHitArea()._x - this.men[_loc2_].instance.x) / Math.abs(this.squad.getEnemyTeam().getCastleHitArea()._x - this.men[_loc2_].instance.x));
                         if(this.men[_loc2_].instance.shootAtTarget(this.squad.getEnemyTeam().getCastleHitArea(),true,0))
                         {
                              this.men[_loc2_].state = 0;
                              this.men[_loc2_].target = undefined;
                    ...
                    else if(this.men[_loc2_].instance.isAttacking() || Math.abs(this.men[_loc2_].target.x - this.men[_loc2_].instance.x) < this.men[_loc2_].instance.getARCHER_RANGE() && Math.abs(this.men[_loc2_].target.y - this.men[_loc2_].instance.y) < 100)
                    {
                         this.men[_loc2_].state = 2;
                         ...
                         if(this.men[_loc2_].instance.shootAtTarget(this.men[_loc2_].target.getClip(),false,this.men[_loc2_].target.getDx()))
                         {
                              this.men[_loc2_].state = 0;
                              this.men[_loc2_].target = undefined;
                              this.men[_loc2_].instance.clearStatus();
                    ...
                    else
                    {
                         ...
                         {
                              var _loc6_ = this.squad.getForwardMan(1).getX();
                              if(_loc6_ == undefined && this.stance == this.ATTACK)
                              {
                                   _loc5_ = Infinity;
                                   ...
                                   if(_loc5_ != Infinity)
                                   {
                                        _loc6_ = this.squad.getOponents()[_loc9_].getX() - (this.men[_loc2_].instance.getARCHER_RANGE() - 190) * this.squad.getTeamDirection();
                                   }
                              }
                              else
                              {
                              ...
                              var _loc13_ = _loc6_ - this.squad.getTeamDirection() * 180;
                              ...
                              _loc7_ = int(_loc11_ - this.men[_loc2_].instance.y);
                         }
                         else
                         {
                         ...
                         if(this.squad.getTeamDirection() * this.men[_loc2_].instance.getX() + _loc4_ > this.squad.getTeamDirection() * forwardPos)
                         {
                              _loc4_ = forwardPos - this.men[_loc2_].instance.getX();
                         }
                         if(_loc4_ == 0)
                         {
                              _loc4_ = 1;
                         }
                         var _loc10_ = _loc7_ / Math.abs(_loc7_) * this.men[_loc2_].instance.getMAX_ACCELERATION();
                         if(_loc7_ == 0)
                         {
                              _loc10_ = 0;
                         }
                         ...
                         if(_loc4_ * _loc4_ + _loc7_ * _loc7_ >= 100)
                         {
