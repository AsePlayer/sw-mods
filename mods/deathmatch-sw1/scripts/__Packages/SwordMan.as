class SwordMan extends Man
{
     ...
     function SwordMan(x, y, squad, simUnits, game)
     {
          ...
          this.isMinion = false;
          this.isToxophilite = false;
          this.isGigantor = false;
     }
     function update()
     {
          super.update();
          ...
          else if(this.isToxophilite)
          {
               this.clip.weapon = 6;
          }
          else if(this.isGigantor)
          {
               this.clip.weapon = 5;
          }
          else
     ...
     function setAsToxophilite()
     {
          this.MAX_HEALTH *= 1.25;
          this.health *= 1.25;
          this.isToxophilite = true;
     }
     function setAsGigantor()
     {
          this.MAX_HEALTH *= 1.25;
          this.health *= 1.25;
          this.isGigantor = true;
     }
}
