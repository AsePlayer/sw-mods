class Giant extends Man
{
          ...
          else if(this.isSwinging)
          {
               ...
               if(this.isHitPeriod())
               {
                    ...
                    if(this.clip.hitTest(this.squad.getEnemyTeam().getCastleHitArea()))
                    {
                         if(this.isXXLGiant)
                         {
                              this.squad.getEnemyTeam().damageCastle(this.squad.getTechnology().getGiantAttack() * 25);
                         }
                         else
                         {
     ...
     function setAsXXLGiant()
     {
          this.isXXLGiant = true;
          this.health *= 7;
          this.MAX_HEALTH *= 7;
          this.GIANT_RANGE *= 2.9;
          this.baseScale /= 2.9;
     }
}
