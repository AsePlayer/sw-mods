package com.brockw.stickwar.engine.units
{
     ...
     public class Knight extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               if(this.knightType == "Leader" || this.knightType == "Leader_2" || this.knightType == "MegaKnight" || this.knightType == "MegaKnight_2" || this.knightType == "MegaKnight_3" || this.knightType == "DemonKnight" || this.knightType == "DemonKnight_2" || this.knightType == "GoldKnight" || this.knightType == "SecondCommand" || this.knightType == "SecondCommand_2")
               {
               ...
               if(isCustomUnit = true)
               {
                    ...
                    if(this.knightType == "DemonClone" || this.knightType == "DemonClone_2")
                    {
               ...
               {
                    com.brockw.stickwar.engine.units.Knight.setItem(_mc,"New Default Axe","New Default Helmet","New Default Shield");
               }
          }
