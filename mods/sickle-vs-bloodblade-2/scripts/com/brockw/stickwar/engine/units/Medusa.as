package com.brockw.stickwar.engine.units
{
     ...
     public class Medusa extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
                         ...
                         if(MovieClip(_mc.mc).currentFrame == 20)
                         {
                              if(this.targetUnit)
                              {
                                   if(this.targetUnit.type == com.brockw.stickwar.engine.units.Unit.U_MEDUSA)
                                   {
                                        ...
                                        {
                                             this.knight = Knight(param1.unitFactory.getUnit(com.brockw.stickwar.engine.units.Unit.U_KNIGHT));
                                             team.spawn(this.knight,param1);
                                             this.knight.px = this.targetUnit.px;
                                             this.knight.py = this.targetUnit.py;
                                             this.knight.knightType = "Default";
                                             this.knight.ai.setCommand(team.game,new StandCommand(team.game));
                                        }
                                   }
               ...
               {
                    com.brockw.stickwar.engine.units.Medusa.setItem(_medusaMc(mc),team.loadout.getItem(this.type,MarketItem.T_WEAPON),team.loadout.getItem(this.type,MarketItem.T_ARMOR),team.loadout.getItem(this.type,MarketItem.T_MISC));
               }
          }
