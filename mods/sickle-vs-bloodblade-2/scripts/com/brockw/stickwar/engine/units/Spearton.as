     ...
     public class Spearton extends com.brockw.stickwar.engine.units.Unit
     {
          ...
          private function burnInArea(param1:com.brockw.stickwar.engine.units.Unit) : *
          {
               if(param1.team != this.team)
               {
                    ...
                    else if(this.speartonType == "Spear_4")
                    {
                         if(Math.pow(param1.px - px,2) + Math.pow(param1.py - py,2) < this.radiantRange * this.radiantRange)
                         {
                              if(param1.type != com.brockw.stickwar.engine.units.Unit.U_STATUE)
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               else if(team.isEnemy && !enemyBuffed)
               {
                    ...
                    _damageToArmour *= 1;
                    health *= 1.3;
                    _maxVelocity += Number(team.game.main.campaign.difficultyLevel) * 5;
                    maxHealth = health;
                    maxHealth = maxHealth;
               ...
               if(this.speartonType == "Barin" || this.speartonType == "Spear_4" || this.speartonType == "s08" || this.speartonType == "BuffSpear" || this.speartonType == "Spearos_2" || this.speartonType == "Spearos")
               {
               ...
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"British Spear","Marine Helmet","Captian America Shield");
                    maxHealth = 1300;
                    health = 1300;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.speartonType == "Spear_4" && !this.setupComplete)
               {
                    com.brockw.stickwar.engine.units.Spearton.setItem(_mc,"Adicai Spear","Spearos","Skate Shield");
                    maxHealth = 1000;
                    health = 1000;
                    maxHealth = maxHealth;
                    healthBar.totalHealth = maxHealth;
               ...
               if(this.speartonType == "GoldenSpear" || this.speartonType == "GoldenSpear_2" || this.speartonType == "GoldenSpear_3" || this.speartonType == "Super" || this.speartonType == "Super_2" || this.speartonType == "Super_3" || this.speartonType == "Ultra" || this.speartonType == "Ultra_2" || this.speartonType == "s07" || this.speartonType == "s08" || this.speartonType == "s09" || this.speartonType == "Barin" || this.speartonType == "Spearos" || this.speartonType == "Spearos_2" || this.speartonType == "Boss_1" || this.speartonType == "Boss_2" || this.speartonType == "MillionHP" || this.speartonType == "Atreyos" || this.speartonType == "Atreyos_2" || this.speartonType == "BuffSpear" || this.speartonType == "Giga" || this.speartonType == "BuffSpear_2" || this.speartonType == "DarkSpear")
               {
               ...
               if(this.speartonType == "Spear_4")
               {
                    this.radiantRange = 150;
               }
               if(isCustomUnit = true)
               {
                    ...
                    else if(this.speartonType == "Mega" || this.speartonType == "Mega_2")
                    {
                         _maxVelocity = 15.5;
                         _mass = 50;
                    }
               ...
               else if(isDead == false)
               {
                    ...
                    {
                         param1.projectileManager.initNuke(px,py,this,150,0.8,600);
                         param1.projectileManager.initStun(this.px,py,35,this);
                         param1.projectileManager.initPoisonPool(this.px,this.py,this,0);
                    }
                    ...
                    if(this.speartonType == "s09")
                    {
                         ...
                         this.clusterLad.px = px;
                         this.clusterLad.py = py;
                         this.clusterLad.speartonType = "DarkSpear";
                         param1.projectileManager.initTowerSpawn(px,py,param1.team,0.6);
                         this.clusterLad = team.game.unitFactory.getUnit(com.brockw.stickwar.engine.units.Unit.U_SPEARTON);
                         team.spawn(this.clusterLad,team.game);
                         this.clusterLad.px = px;
          ...
          override public function damage(param1:int, param2:Number, param3:Entity, param4:Number = 1) : void
          {
               ...
               if(this.inBlock || this.speartonType == "BuffSpear" || this.speartonType == "LavaPrince" || this.speartonType == "LeafPrince" || this.speartonType == "SavagePrince" || this.speartonType == "s08" || this.speartonType == "s07" || this.speartonType == "GoldenSpear_3" || this.speartonType == "SWLAtreyos" || this.speartonType == "s07" || this.speartonType == "Adicai" || this.speartonType == "GoldenSpear_2" || this.speartonType == "Atreyos" || this.speartonType == "Atreyos_2")
               {
