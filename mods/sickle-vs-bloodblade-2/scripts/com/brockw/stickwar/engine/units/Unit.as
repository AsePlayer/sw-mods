package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          public var isReflective:Boolean;
          ...
          public var enemyColor:Boolean;
          
          public var enemyColor2:Boolean;
          
          public var enemyColor3:Boolean;
          
          public var enemyColor4:Boolean;
          
          public var enemyColor5:Boolean;
          
          public var enemyColor6:Boolean;
          
          public var enemyColor7:Boolean;
          ...
          public function Unit(param1:StickWar)
          {
               ...
               this.towerSpawnGlow = new GlowFilter(_loc2_,_loc3_,_loc4_,_loc5_,_loc6_,_loc7_,_loc8_,_loc9_);
               _loc2_ = 46335;
               this.protectFilter = new GlowFilter(_loc2_,_loc3_,_loc4_,_loc5_,_loc6_,_loc7_,_loc8_,_loc9_);
          ...
          private function updateStatusPositions() : void
          {
               ...
               if(this.poisonMc)
               {
                    this.poisonMc.x = -_loc2_ / 2 * (_loc1_ - 1);
               }
               if(this.fireEffectMc)
               {
                    this.fireEffectMc.x = _loc2_ / 2 * (_loc1_ - 1);
               }
          }
          ...
          public function updateStatus() : void
          {
               ...
               {
                    if(this._health + this.chaosHealRate * 2 <= this.maxHealth)
                    {
                         this._health += this.chaosHealRate * 2;
                    }
               }
               if(this.unitRegen)
               {
               ...
               if(this.slowFramesRemaining)
               {
                    if(this.slowRegen)
                    {
                         this.heal(0.5,this.slowFramesRemaining);
                    }
          ...
          protected function updateCommon(param1:StickWar) : void
          {
               ...
               else
               {
                    ...
                    if(this.enemyColor3)
                    {
                         _loc2_.redMultiplier = 255;
                         _loc2_.blueMultiplier = 255;
                         _loc2_.greenMultiplier = 255;
                         _loc2_.blueOffset = 255;
                         _loc2_.redOffset = 0;
                         _loc2_.greenOffset = 255;
                    }
               ...
               {
                    if(this.isAlive() && param1.frame % 350 == 0)
                    {
                         this.heal(45,1);
                         this.cure();
                    }
               }
               if(this.isAlive() && param1.frame % 32 == 0 && this._poisonDamage > 0)
               {
                    if(this.poisonRegen)
                    {
          ...
          protected function updateMotion(param1:StickWar) : void
          {
               ...
               {
                    if(px < _loc4_.px + _loc3_ && px > _loc4_.px - _loc3_)
                    {
                         px = _loc4_.px - _loc3_ * this.team.direction;
                    }
               }
               if(px < 0 + _loc3_)
               {
               ...
               else if(px > param1.map.width - _loc3_)
               {
                    px = param1.map.width - _loc3_;
               }
          ...
          protected function checkForHit() : Boolean
          {
               ...
               if(_loc1_.checkForHitPoint(_loc3_,_loc1_))
               {
                    ...
                    if(this.isReflective == true)
                    {
                         this.damage(0,10000,this);
                    }
