package com.brockw.stickwar.engine.multiplayer
{
     ...
     public class CustomMatchScreen extends Screen
     {
          ...
          private static const COMPUTER_SURVIVAL_CHAOS:String = "Survival Chaos Ai";
          ...
          private static const COMPUTER_SURVIVAL_ORDER:String = "Survival Order Ai";
          ...
          private function inviteToGame(param1:Event) : void
          {
               ...
               if(_loc2_ == COMPUTER_SURVIVAL_CHAOS || _loc2_ == COMPUTER_SURVIVAL_ORDER || _loc2_ == COMPUTER_EASY_CHAOS || _loc2_ == COMPUTER_HARD_CHAOS || _loc2_ == COMPUTER_INSANE_CHAOS || _loc2_ == COMPUTER_EASY_ORDER || _loc2_ == COMPUTER_HARD_ORDER || _loc2_ == COMPUTER_INSANE_ORDER)
               {
                    ...
                    else if(_loc2_ == COMPUTER_SURVIVAL_ORDER)
                    {
                         if(_loc3_ == TYPE_CLASSIC ? int(StickWar.TYPE_CLASSIC) : int(StickWar.TYPE_DEATHMATCH))
                         {
                              _loc6_ = 0.5;
                         }
                         else
                    ...
                    else if(_loc2_ == COMPUTER_SURVIVAL_CHAOS)
                    {
                         if(_loc3_ == TYPE_CLASSIC ? int(StickWar.TYPE_CLASSIC) : int(StickWar.TYPE_DEATHMATCH))
                         {
                              _loc6_ = 0.5;
