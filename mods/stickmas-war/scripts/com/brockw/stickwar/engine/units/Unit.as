package com.brockw.stickwar.engine.units
{
     ...
     public class Unit extends Entity
     {
          ...
          protected function checkCollision(param1:com.brockw.stickwar.engine.units.Unit) : void
          {
               ...
               {
                    param1 = Unit(param1);
                    if((!param1.mayWalkThrough || param1.type == Unit.U_TREE_ELEMENT && type == Unit.U_TREE_ELEMENT) && param1.stunTimeLeft == 0 && Boolean(param1.isCollision(this,this.dx,this.dy)))
                    {
                         _loc2_ = 0.15;
