package com.brockw.stickwar.engine.units
{
     ...
     public class Magikill extends Unit
     {
          ...
          override public function update(param1:StickWar) : void
          {
               ...
               Magikill.setItem(_magikill(mc),team.loadout.getItem(this.type,MarketItem.T_WEAPON),team.loadout.getItem(this.type,MarketItem.T_ARMOR),"Santa Beard");
          }
