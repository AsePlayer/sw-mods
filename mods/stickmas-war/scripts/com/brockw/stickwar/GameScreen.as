package com.brockw.stickwar
{
     ...
     public class GameScreen extends Screen
     {
          ...
          public function updateGameLoop(param1:TimerEvent) : void
          {
               ...
               else if(Boolean(this.isDoingDouble) && getTimer() - this.lastDoubleChange > this.timeToStayDouble && this.simulation.getQuickFPS() >= 29.8)
               {
                    this.isDoingDouble = false;
                    this.lastDoubleChange = getTimer();
               }
          ...
          public function update(param1:Event, param2:Number) : void
          {
               ...
               if(this.simulation)
               {
                    ...
                    if(Boolean(this.showingTimeout) || Boolean(this.showingSyncError))
                    {
          ...
          public function initClassic() : void
          {
               ...
               if(this.game.teamB.handicap <= 0.5)
               {
                    this.game.teamA.mana += 100;
                    this.game.teamA.gold *= 2;
                    this.game.teamA.mana *= 2;
               }
          }
