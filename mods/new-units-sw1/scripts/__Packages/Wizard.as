class Wizard extends Man
{
     ...
     function Wizard(x, y, squad, simUnits, game)
     {
          ...
          this.isWoodMage = false;
          this.isEliteMage = false;
     }
     function update()
     {
          super.update();
     ...
     function setAsWoodMage()
     {
          ...
          this.WIZARD_RANGE *= 2;
          this.MAX_MINION = 3;
          this.isWoodMage = true;
     }
     function setAsEliteMage()
     {
          this.baseScale *= 0.85;
          this.health *= 6;
          this.MAX_HEALTH *= 6;
