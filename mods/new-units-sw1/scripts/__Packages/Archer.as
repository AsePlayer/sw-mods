class Archer extends Man
{
     ...
     function Archer(x, y, squad, simUnits, game)
     {
          ...
          this.isWoodlandArcher = false;
     }
     function update()
     {
          super.update();
          if(this.isWoodlandArcher)
          {
               this.clip.arrows = 3;
               this.clip.quiver = 3;
          }
          else
          {
               ...
               this.clip.quiver = this.squad.getTechnology().getArcherAccuracy();
          }
          if(this.hasShot)
          {
     ...
     function setAsWoodlandArcher()
     {
          this.baseScale *= 0.9;
          this.health *= 3;
          this.MAX_HEALTH *= 3;
          this.isWoodlandArcher = true;
     }
}
