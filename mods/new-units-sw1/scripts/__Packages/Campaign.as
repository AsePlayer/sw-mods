class Campaign
{
     ...
     function loadLevel0()
     {
          ...
          var _loc5_ = new Game(2,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,2,9,3);
          _root.game = _loc5_;
     ...
     function loadLevel1()
     {
          ...
          var _loc3_ = new TechnologyManager(true,500,this.difficultyLevel);
          _loc3_.setCastleArcherNumber(3);
          _loc3_.setMinerPickaxe(1);
          _loc3_.setSpartanShield(4);
          _loc3_.setSpartanHelmet(3);
          _loc3_.setSpartanSpear(1);
          _loc3_.statue = 10;
          if(this.difficultyLevel == 3)
          {
               _loc3_.setArcherDamage(4);
     ...
     function loadLevel2()
     {
          ...
          var _loc5_ = new Game(2,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,4,6,5);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          this.archer = Archer(_loc5_.getSquad1().addArcher());
          this.archer.setAsSuperArcher();
          _root.gotoAndPlay("game");
     }
     function loadLevel3()
     {
          ...
          var _loc5_ = new Game(3,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,6,8,3);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          _root.gotoAndPlay("game");
     }
     function loadLevel4()
     {
          ...
          var _loc5_ = new Game(4,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,3,5,2);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          this.swordman = SwordMan(_loc5_.getSquad1().addSwordMan());
     ...
     function loadLevel5()
     {
          ...
          var _loc5_ = new Game(5,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,3,8,7);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          this.giant = Giant(_loc5_.getSquad1().addGiant());
          this.giant.setAsWoodlandPumler();
          this.swordman = SwordMan(_loc5_.getSquad1().addSwordMan());
          this.swordman.setAsRebelSickle();
          this.swordman = SwordMan(_loc5_.getSquad1().addSwordMan());
     ...
     function loadLevel6()
     {
          ...
          var _loc5_ = new Game(5,_root.canvas,600,400,1,0,_loc3_,this.technology,_loc4_,3,9,3);
          _root.game = _loc5_;
          _loc5_.getSquad1().addMiner();
          _root.gotoAndPlay("game");
     }
     function loadLevel7()
     {
          ...
          _loc3_.setWizardAttack(2);
          if(this.difficultyLevel == 3)
          {
               _loc3_.setSpartanHelmet(4);
               _loc3_.setSpartanShield(4);
               _loc3_.setArcherDamage(4);
               _loc3_.setSwordmanSpeed(2);
               _loc3_.setCastleArcherNumber(4);
          }
