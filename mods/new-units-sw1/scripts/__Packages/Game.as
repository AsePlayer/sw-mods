class Game
{
     ...
     function update()
     {
          ...
          this.HUD.goldBox.populationDisplay.text = this.squad1.getNumberLiving() + this.squad1.getQueueSize() + "/20";
          ...
          if(getTimer() - this.lastManAdd > 100)
          {
               if(Key.isDown(55))
               {
                    ...
                    this.swordman.setAsSplitter();
                    this.lastManAdd = getTimer();
               }
               if(Key.isDown(56))
               {
                    this.archer = Archer(this.squad2.addArcher());
                    this.archer.setAsWoodlandArcher();
                    this.lastManAdd = getTimer();
               }
               if(Key.isDown(57))
               {
                    this.wizard = Wizard(this.squad1.addWizard());
