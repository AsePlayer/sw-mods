class SwordMan extends Man
{
     ...
     function SwordMan(x, y, squad, simUnits, game)
     {
          ...
          this.isGrowzMinion = false;
          this.isWrathnar = false;
          this.isEmberSword = false;
          this.isAmbushBossSword = false;
          this.isXiphos = false;
          this.isLavaSword = false;
          this.isVampricSword = false;
          this.isRebelSickle = false;
          this.isSickleWrath = false;
          this.isBloodBlade = false;
          this.isSickleBear = false;
          this.isBloodBaron = false;
     ...
     function update()
     {
          ...
          else if(this.isMegaSword)
          {
               this.clip.weapon = 6;
               this.MAX_VELOCITY = 6;
          }
          else if(this.isGrowzMinion)
          {
               this.clip.weapon = 7;
               this.MAX_VELOCITY = 4;
          }
          else if(this.isWrathnar)
          {
               this.clip.weapon = 8;
               this.MAX_VELOCITY = 5;
          }
          else if(this.isEmberSword)
          {
               this.clip.weapon = 9;
               this.MAX_VELOCITY = 4;
          }
          else if(this.isAmbushBossSword)
          {
               this.clip.weapon = 10;
               this.MAX_VELOCITY = 6;
          }
          else if(this.isXiphos)
          {
               this.clip.weapon = 11;
          }
          else if(this.isLavaSword)
          {
               this.clip.weapon = 12;
          }
          else if(this.isVampiricSword)
          {
               this.clip.weapon = 13;
          }
          else if(this.isRebelSickle)
          {
               this.clip.weapon = 14;
          }
          else if(this.isSickleWrath)
          {
               this.clip.weapon = 15;
          }
          else if(this.isBloodBlade)
          {
               this.clip.weapon = 16;
          }
          else if(this.isSickleBear)
          {
               this.clip.weapon = 18;
          }
          else if(this.isBloodBaron)
          {
               this.clip.weapon = 17;
          }
          else
                    ...
                    for(_loc5_ in _loc4_)
                    {
                         if(Math.abs(_loc4_[_loc5_].getClip()._y - this.y) < this.HIT_WIDTH)
                         {
                              if(_loc4_[_loc5_].getSquad() != this.getSquad() && this.swordHasHit(_loc4_[_loc5_]))
                              {
                                   ...
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 2,this.currentDirection,"sword");
                                   }
                                   else if(this.isAmbushBossSword)
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 2,this.currentDirection,"sword");
                                   ...
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 1.25,this.currentDirection,"sword");
                                   }
                                   else if(this.isSickleWrath)
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 1.35,this.currentDirection,"sword");
                                   }
                                   else if(this.isBloodBlade)
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 1.35,this.currentDirection,"sword");
                                   ...
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 1.75,this.currentDirection,"sword");
                                   }
                                   else if(this.isBloodBaron)
                                   {
                                        _loc4_[_loc5_].damage(this.controlMultiply() * this.squad.getTechnology().getSwordmanAttack() * 1.75,this.currentDirection,"sword");
     ...
     function setAsMegaSword()
     {
          this.baseScale *= 0.5;
          this.health *= 11;
          this.MAX_HEALTH *= 11;
          this.SWORD_MAN_RANGE *= 2;
          this.isMegaSword = true;
     }
     function setAsGrowzMinion()
     {
          this.baseScale *= 0.85;
          this.health *= 1.5;
          this.MAX_HEALTH *= 1.5;
          this.isGrowzMinion = true;
     }
     function setAsWrathnar()
     {
          this.baseScale *= 0.8;
          this.health *= 12;
          this.MAX_HEALTH *= 12;
          this.SWORD_MAN_RANGE *= 1.2;
          this.isWrathnar = true;
     }
     function setAsEmberSword()
     {
          this.health *= 1.25;
          this.MAX_HEALTH *= 1.25;
          this.isEmberSword = true;
     }
     function setAsAmbushBossSword()
     {
          this.baseScale *= 0.6;
          this.health *= 7;
          this.MAX_HEALTH *= 7;
          this.isAmbushBossSword = true;
     }
     ...
     function setAsLavaSword()
     {
          this.health *= 1.25;
          this.MAX_HEALTH *= 1.25;
          this.isLavaSword = true;
     }
     function setAsVampiricSword()
     {
          this.baseScale *= 0.93;
          this.health *= 1.25;
          this.MAX_HEALTH *= 1.25;
          this.isVampiricSword = true;
     }
     function setAsRebelSickle()
     {
          this.baseScale *= 0.93;
          this.health *= 1.45;
          this.MAX_HEALTH *= 1.45;
          this.isRebelSickle = true;
     }
     function setAsSickleWrath()
     {
          this.baseScale *= 0.93;
          this.health *= 1.6;
          this.MAX_HEALTH *= 1.6;
          this.isSickleWrath = true;
     }
     function setAsBloodBlade()
     {
          this.baseScale *= 0.93;
          this.health *= 2;
          this.MAX_HEALTH *= 2;
          this.isBloodBlade = true;
     }
     function setAsSickleBear()
     {
          this.baseScale *= 0.8;
          this.health *= 6;
          this.MAX_HEALTH *= 6;
          this.SWORD_MAN_RANGE *= 1.2;
          this.isSickleBear = true;
     }
     function setAsBloodBaron()
     {
          this.baseScale *= 0.8;
          this.health *= 7;
          this.MAX_HEALTH *= 7;
          this.SWORD_MAN_RANGE *= 1.4;
          this.isBloodBaron = true;
     }
